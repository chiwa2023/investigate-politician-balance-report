...
| 一日追跡調査同一識別コード   | traceEventCode  | Long                   | 変更履歴にかかわらず一日追跡調査を同一識別すコード                                |
| 調査実施日                   | traceEventDate  | LocalDate              | 調査対象日                                                                        |
| 調査実施ユーザId             | userId          | Long                   | 調査実施ユーザId                                                                  |
| 調査実施ユーザ同一識別コード | userCode        | Long                   | 変更履歴にかかわらずユーザを同一識別するコード                                    |
| 調査実施ユーザ名称           | userName        | Long                   | 調査実施ユーザ氏名                                                                |
| 追跡対象政治家Id             | politicianId    | Long                   | 政治家Id                                                                          |
| 追跡対象政治家同一識別コード | politicianCode  | Long                   | 政治家コード                                                                      |
