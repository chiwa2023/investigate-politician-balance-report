...
※このインターフェイスは使途報告書でも使用する予定
 ...
 | 最新非公式データページタイトル             | newestNotOfficialPageTitle | String                                                        | 収支報告書が非公式サイトに保存された場合、掲載されたページタイトル                                                                                                                                      |
 | 最新非公式データリンク                     | newestNotOfficialUrl       | String                                                        | 収支報告書が非公式サイトに保存された場合、資料への直接リンク                                                                                                                                            |
