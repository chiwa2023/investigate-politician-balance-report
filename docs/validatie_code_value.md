...
基本的な検証対象はJavaとMysqlのInteger最大値 2,147,483,647…2億

|              |              Java              |                  Mysql                  |
| :----------- | -----------------------------: | --------------------------------------: |
| Integer(Int) |             (2億)2,147,483,647 |                      (2億)2,147,483,647 |
...
![借入金コード化をマイナンバーで行う](./images/shakunyuukinn_mynumber.png)
...
想定提出政治団体数80,000×平均記載収入項目100～300= 8,000,000～24,000,000
現時点ではIntegerで十分。
近い将来、1円単位記載が法律化される可能性が高いが、その場合数年Long値のまま様子見を行い、間違いなくInteger(2億)の範囲におさまるのを確認したうえでIntegerに移行。現時点ではギリギリ収まらない規模感(10億程度)を想定。
...
想定提出政治団体数80,000×平均記載収入項目50～100= 4,000,000～8,000,000
Integerで十分すぎるほど大きい。
