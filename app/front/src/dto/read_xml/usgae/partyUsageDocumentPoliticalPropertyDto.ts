export default interface PartyUsageDocumentPoliticalPropertyInterface {

}

export default class PartyUsageDocumentPoliticalPropertyDto implements PartyUsageDocumentPoliticalPropertyInterface {
