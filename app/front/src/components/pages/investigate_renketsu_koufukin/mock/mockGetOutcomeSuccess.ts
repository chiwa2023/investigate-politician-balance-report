...
export default function mockGetOutcomeSuccess(houkokuNen:number):RenketsuKoufukinWkTblInterface{
    ...
    dto.listSuccess.push(createRenlketuRow(133,houkokuNen));
    dto.listSuccess.push(createRenlketuRow(216,houkokuNen));
    dto.listSuccess.push(createRenlketuRow(388,houkokuNen));
    dto.listSuccess.push(createRenlketuRow(191,houkokuNen));
