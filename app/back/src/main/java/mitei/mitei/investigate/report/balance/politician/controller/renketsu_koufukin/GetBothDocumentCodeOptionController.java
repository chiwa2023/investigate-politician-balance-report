...
import mitei.mitei.investigate.report.balance.politician.service.renketsu_koufukin.GetBothDocumentCodeOptionService;

/**
 * 収支報告書・支出報告書文書コード選択肢取得Controller
 */
@Controller
@RequestMapping("/renketsu-koufukin")
public class GetBothDocumentCodeOptionController extends AbstractTemplateCheckController {
    ...
    @PostMapping("/get-document-code")
    public ResponseEntity<RenketsuKofukinDocumentCodeOptionResultDto> practice(
            @RequestBody final SearchDocumentCodeByOfferingCapsuleDto capsuleDto) {
        ...
        try {
            ...
            return ResponseEntity.ok(
                    getBothDocumentCodeOptionService.practice(capsuleDto));
