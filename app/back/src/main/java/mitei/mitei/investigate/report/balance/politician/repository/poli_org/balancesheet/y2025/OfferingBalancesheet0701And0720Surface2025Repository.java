...
/**
 * offering_balancesheet_0701_and_0720_surface_2025接続用Repository
 */
public interface OfferingBalancesheet0701And0720Surface2025Repository  extends JpaRepository<OfferingBalancesheet0701And0720Surface2025Entity, Integer>{
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM offering_balancesheet_0701_and_0720_surface_2025 WHERE saishin_kbn= 1 AND MATCH(offering_balancesheet_0701_and_0720_surface_2025_name) AGAINST (?1 IN NATURAL LANGUAGE MODE)", nativeQuery = true)
    List<OfferingBalancesheet0701And0720Surface2025Entity> findFullText(String searchWords);
    ...
    Optional<OfferingBalancesheet0701And0720Surface2025Entity> findFirstByOrderByOfferingBalancesheet0701And0720SurfaceCodeDesc();
     ...
     * @return 表紙データ
     */
    Optional<OfferingBalancesheet0701And0720Surface2025Entity> findFirstByPoliticalOrganizationCodeAndSaishinKbnOrderByOfferingDateDesc(Integer politicalOrgCode,Integer saishinKbn);
