...
/**
 * 様式9(その1)2023年データを登録する
 */
@Component
public class InsertPartyUsageShito0901Y2023Logic {
    ...
    public int practice(final Long documentCode, final PartyUsageDocumentPoliticalPropertyDto documentPropertyDto,
        ...
        List<OfferingPartyUsage0901Report2023Entity> list = new ArrayList<>();
        ...
        // 同一識別コードを設定
        Long code = 0L;
        Optional<OfferingPartyUsage0901Report2023Entity> optional = offeringPartyUsage0901Report2023Repository
                .findFirstByOrderByPartyUsage0901ReportCodeDesc();
        if (!optional.isEmpty()) {
            code = optional.get().getPartyUsage0901ReportCode();
        }

        for (OfferingPartyUsage0901Report2023Entity entity : list) {
            code++;
            entity.setPartyUsage0901ReportCode(code);
        }

        // repositoryで保存
        return offeringPartyUsage0901Report2023Repository.saveAll(list).size();
    }

    private OfferingPartyUsage0901Report2023Entity createEntity(final Long documentCode,
        ...
        OfferingPartyUsage0901Report2023Entity reportEntity = new OfferingPartyUsage0901Report2023Entity();
