package mitei.mitei.investigate.report.balance.politician.controller.party_jougen;
...
import mitei.mitei.investigate.report.balance.politician.service.party_jougen.SearchPartyJougenService;

/**
 * パーティ上限Contorller
 */
@Controller
@RequestMapping("/party-jougen")
public class SearchPartyJougenController extends AbstractTemplateCheckController {
    ...
    /** パーティ上限Service */
    @Autowired
    private SearchPartyJougenService searchPartyJougenService ;
     ...
     */
    @PostMapping("/search")
    public ResponseEntity<SearchKifuJougenMeisaiBalancesheetResultDto> practice(
        ...
        try {
            ...
            return ResponseEntity.ok(searchPartyJougenService.practice(capsuleDto));
