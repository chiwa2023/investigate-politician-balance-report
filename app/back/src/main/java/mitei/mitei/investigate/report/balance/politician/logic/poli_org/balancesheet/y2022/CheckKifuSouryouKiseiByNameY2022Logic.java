 ...
 */
@Component
public class CheckKifuSouryouKiseiByNameY2022Logic {
    ...
    public List<SouryouKiseiRelationCodeDto> practice(final Integer poliOrgCode, final Integer youshikiEdaKbn,
        ...
        // 取引相手名称トごとの合計金額を算出する
        List<SouryouKiseiGenBunshoEntity> listEntity = offeringBalancesheetIncome2022Repository.calcSumByPartnerName(
                offeringBalancesheetIncome2022Repository.findPartnerNameByPoliOrg(poliOrgCode, youshikiEdaKbn),
