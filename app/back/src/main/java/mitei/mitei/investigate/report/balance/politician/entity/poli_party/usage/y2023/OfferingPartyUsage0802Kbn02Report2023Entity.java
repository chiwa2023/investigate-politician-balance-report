package mitei.mitei.investigate.report.balance.politician.entity.poli_party.usage.y2023;
...
/**
 * offering_party_usage_0802_kbn_02_report_2023接続用Entity
 */
@Entity
@Table(name = "offering_party_usage_0802_kbn_02_report_2023")
public class OfferingPartyUsage0802Kbn02Report2023Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD
    ...
    @Column(name = "party_usage_0802_kbn_02_report_id")
    private Long partyUsage0802Kbn02ReportId = INIT_Long;

    /**
     * 使途報告書様式6(その2)区分2Idを取得する
     *
     * @return 使途報告書様式6(その2)区分2Id
     */
    public Long getPartyUsage0802Kbn02ReportId() {
        return partyUsage0802Kbn02ReportId;
    }

    /**
     * 使途報告書様式6(その2)区分2Idを設定する
     *
     * @param partyUsage0802Kbn02ReportId 使途報告書様式6(その2)区分2Id
     */
    public void setPartyUsage0802Kbn02ReportId(final Long partyUsage0802Kbn02ReportId) {
        this.partyUsage0802Kbn02ReportId = partyUsage0802Kbn02ReportId;
    }

    /** 使途報告書様式8(その2)区分2同一識別コード */
    @Column(name = "party_usage_0802_kbn_02_report_code")
    private Long partyUsage0802Kbn02ReportCode = INIT_Long;

    /**
     * 使途報告書様式8(その2)区分2同一識別コードを取得する
     *
     * @return 使途報告書様式8(その2)区分2同一識別コード
     */
    public Long getPartyUsage0802Kbn02ReportCode() {
        return partyUsage0802Kbn02ReportCode;
    }

    /**
     * 使途報告書様式8(その2)区分2同一識別コードを設定する
     *
     * @param partyUsage0802Kbn02ReportCode 使途報告書様式8(その2)区分2同一識別コード
     */
    public void setPartyUsage0802Kbn02ReportCode(final Long partyUsage0802Kbn02ReportCode) {
        this.partyUsage0802Kbn02ReportCode = partyUsage0802Kbn02ReportCode;
    }
    ...
    private Long totalAmount = INIT_Long;
