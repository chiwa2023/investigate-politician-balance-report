...
import mitei.mitei.investigate.report.balance.politician.service.offering.poli_party.SearchRegistPartyUsagePlanErrorService;

/**
 * 政党交付金使途報告書解析予定エラーリスト一覧取得Controller
 */
@RestController
@RequestMapping("/listup-party-usage-charset")
public class SearchRegistPartyUsagePlanErrorController extends AbstractTemplateCheckController {
    ...
    @PostMapping("/error")
    public ResponseEntity<List<TaskPlanPartyUsageDetailEntity>> practice(
        ...
        try {
            ...
            return ResponseEntity.ok(searchRegistPartyUsagePlanErrorService.practice());
