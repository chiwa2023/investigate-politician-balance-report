...
import mitei.mitei.investigate.report.balance.politician.service.offering.poli_org.SearchRegistBalancesheetPlanErrorService;

/**
 * 政治資金収支報告書解析予定エラーリスト一覧取得Controller
 */
@RestController
...
public class SearchRegistBalancesheetPlanErrorController extends AbstractTemplateCheckController {
    ...
    public ResponseEntity<List<TaskPlanBalancesheetDetailEntity>> practice(
        ...
        try {
            ...
            return ResponseEntity.ok(searchRegistBalancesheetPlanErrorService.practice());
