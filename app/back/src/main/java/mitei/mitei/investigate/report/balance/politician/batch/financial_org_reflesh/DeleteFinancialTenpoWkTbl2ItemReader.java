 ...
 */
@Component
public class DeleteFinancialTenpoWkTbl2ItemReader extends RepositoryItemReader<ZenginOrgBranchMasterEntity> {
     ...
     */
    public DeleteFinancialTenpoWkTbl2ItemReader(
        ...
        super.setMethodName("findDelteBranchWkTbl2");
