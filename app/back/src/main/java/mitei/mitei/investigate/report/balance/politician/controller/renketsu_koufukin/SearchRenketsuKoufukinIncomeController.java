...
import mitei.mitei.investigate.report.balance.politician.service.renketsu_koufukin.SearchRenketsuKoufukinIncomeService;

/**
 * 収入交付金連結結果取得Controller
 */
@Controller
@RequestMapping("/renketsu-koufukin")
public class SearchRenketsuKoufukinIncomeController extends AbstractTemplateCheckController {
    ...
    @PostMapping("/income")
    public ResponseEntity<RenketsuKoufukinIncomeDto> practice(@RequestBody final TemplatePagingCapsuleDto capsuleDto) {
        ...
        try {
            ...
            return ResponseEntity.ok(
                    searchRenketsuKoufukinIncomeService.practice(capsuleDto.getCheckPrivilegeDto().getLoginUserCode()));
