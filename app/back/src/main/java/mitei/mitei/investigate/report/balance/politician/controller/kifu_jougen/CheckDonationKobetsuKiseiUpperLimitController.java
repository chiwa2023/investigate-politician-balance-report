...
import mitei.mitei.investigate.report.balance.politician.service.kifu_jogen.CheckDonationKobetsuKiseiUpperLimitService;

/**
 * 個別規制政治団体個人(初回のみ)取得Controller
 */
@Component
@RequestMapping("/kifu-jougen")
public class CheckDonationKobetsuKiseiUpperLimitController extends AbstractTemplateCheckController {
     ...
     * @return 検索結果
     */
    @PostMapping("/kobetsu-search")
    public ResponseEntity<KobetsuKifuJougenResultDto> practice(
        ...
        try {
            ...
            return ResponseEntity.ok(checkDonationKobetsuKiseiUpperLimitService.practice(capsuleDto.getHoukokuNen(),
