 ...
 */
@Component
public class UkaiKenkinIncomeStage01TimesItemReader extends AbstractPagingItemReader<OfferingBalancesheetIncomeEntity> {
     ...
     */
    public UkaiKenkinIncomeStage01TimesItemReader(
