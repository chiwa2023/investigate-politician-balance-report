...
/**
 * スケジュール処理と関係なく政治資金収支報告書一括準備処理Controller
 */
@RestController
@RequestMapping("/force-balancesheet")
public class ForcePrepareBalancesheetWkTbController extends AbstractTemplateCheckController {
     ...
     */
    @PostMapping("/prepare") // SUPPRESS CHECKSTYLE ReturnCountCheck
