 ...
 */
@Component
public class UkaiKenkinIncomeStage04TimesItemReader extends AbstractPagingItemReader<OfferingBalancesheetIncomeEntity> {
     ...
     */
    public UkaiKenkinIncomeStage04TimesItemReader(
