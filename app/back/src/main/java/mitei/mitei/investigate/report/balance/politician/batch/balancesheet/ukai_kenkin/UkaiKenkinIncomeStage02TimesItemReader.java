 ...
 */
@Component
public class UkaiKenkinIncomeStage02TimesItemReader extends AbstractPagingItemReader<OfferingBalancesheetIncomeEntity> {
     ...
     */
    public UkaiKenkinIncomeStage02TimesItemReader(
