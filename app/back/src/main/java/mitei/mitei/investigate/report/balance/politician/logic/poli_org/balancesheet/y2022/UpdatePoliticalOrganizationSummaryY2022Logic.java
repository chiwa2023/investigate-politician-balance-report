 ...
 */
@Component
public class UpdatePoliticalOrganizationSummaryY2022Logic {
    ...
    public int practice(final Long oldCode, final CheckPrivilegeDto checkPrivilegeDto) {
        ...
        // 取得できた数を更新に値をセット
        for (OfferingBalancesheet0702And0713And0717Summary2022Entity entity : list) {
            SetTableDataHistoryUtil.practice(checkPrivilegeDto, entity, DataHistoryStatusConstants.UPDATE);
        }

        return offeringBalancesheet0702And0713And0717Summary2022Repository.saveAll(list).size();
