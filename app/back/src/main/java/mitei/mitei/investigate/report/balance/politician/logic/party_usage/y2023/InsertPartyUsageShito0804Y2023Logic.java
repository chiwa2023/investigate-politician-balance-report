 ...
 */
@Component
public class InsertPartyUsageShito0804Y2023Logic {
    ...
    public int practice(final boolean isSearchRelation, final Long documentCode,
        ...
        // すべてにク共通のEntityを作成
        OfferingPartyUsage0804Report2023Entity entityBase = new OfferingPartyUsage0804Report2023Entity();
        ...
        /* 区分1から12を順に処理 */
        List<OfferingPartyUsage0804Report2023Entity> list = new ArrayList<>();
        ...
        // 行ごとに同一識別コードを振番する
        Long code = 0L;
        Optional<OfferingPartyUsage0804Report2023Entity> optional = offeringPartyUsage0804Report2023Repository
    ...
    private List<OfferingPartyUsage0804Report2023Entity> createEntityInSheet(final int kbn, final String kbnName,
            final OfferingPartyUsage0804Report2023Entity entityBase, final List<Sheet0804Dto> listSheet,
            final boolean isSearchRelation) {

        // 明細が0であっても必ずシートが1枚はは入っている
        OfferingPartyUsage0804Report2023Entity entityReport = new OfferingPartyUsage0804Report2023Entity();
    ...
    private List<OfferingPartyUsage0804Report2023Entity> createEntityInRow(
            final OfferingPartyUsage0804Report2023Entity entityBase, final List<RowShitoCoreDto> listRow,
            final boolean isSearchRelation) {
    ...
    private OfferingPartyUsage0804Report2023Entity createEntity(final OfferingPartyUsage0804Report2023Entity entityBase,
            final RowShitoCoreDto rowDto, final boolean isSearchRelation) {

        OfferingPartyUsage0804Report2023Entity entity = new OfferingPartyUsage0804Report2023Entity();
