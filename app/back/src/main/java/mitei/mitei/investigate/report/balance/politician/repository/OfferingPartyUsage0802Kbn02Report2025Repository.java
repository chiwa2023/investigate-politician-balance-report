...
public interface OfferingPartyUsage0802Kbn02Report2025Repository  extends JpaRepository<OfferingPartyUsage0802Kbn02Report2025Entity, Integer>{
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM offering_party_usage_0802_kbn_02_report_2025 WHERE saishin_kbn= 1 AND MATCH(offering_party_usage_0802_kbn_02_report_2025_name) AGAINST (?1 IN NATURAL LANGUAGE MODE)", nativeQuery = true)
    List<OfferingPartyUsage0802Kbn02Report2025Entity> findFullText(String searchWords);
    ...
    Optional<OfferingPartyUsage0802Kbn02Report2025Entity> findFirstByOrderByPartyUsage0802Kbn02ReportCodeDesc();
