...
public interface SendAlertMail2024Repository extends JpaRepository<SendAlertMail2024Entity, Long> {
     ...
     * @return 未送信データリスト
     */
    List<SendAlertMail2024Entity> findBySaishinKbnAndSendDatetimeBeforeOrderBySendAlertMailId(Integer saishinKbn,
    ...
    Optional<SendAlertMail2024Entity> findFirstByOrderBySendAlertMailCodeDesc();
