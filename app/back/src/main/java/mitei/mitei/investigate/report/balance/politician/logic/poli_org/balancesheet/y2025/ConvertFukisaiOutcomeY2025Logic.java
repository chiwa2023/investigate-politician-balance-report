 ...
 */
@Component
public class ConvertFukisaiOutcomeY2025Logic {
    ...
    public List<WkTblFukisaiBalancesheetEntity> practiceCode(final Integer poliOrgCode,
        ...
        for (OfferingBalancesheetOutcome2025Entity entity : listOutcome) {
    ...
    private WkTblFukisaiBalancesheetEntity copyEntity(final OfferingBalancesheetOutcome2025Entity entity,
