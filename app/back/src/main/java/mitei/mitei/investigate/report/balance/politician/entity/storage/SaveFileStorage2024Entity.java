...
/**
 * save_file_storage_2024接続用Entity
 */
@Entity
@Table(name = "save_file_storage_2024")
public class SaveFileStorage2024Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
