...
/**
 * wk_tbl_balancesheet_income接続用Entity
 */
@Entity
@Table(name = "wk_tbl_balancesheet_income")
public class WkTblBalancesheetIncomeEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
