...
/**
 * task_plan_balancesheet_document接続用Entity
 */
@Entity
@Table(name = "task_plan_balancesheet_document")
public class TaskPlanBalancesheetDocumentEntity implements Serializable, // NOPMD DataClass
    ...
    @Column(name = "task_plan_balancesheet_document_id")
    private Long taskPlanBalancesheetDocumentId = INIT_Long;

    /**
     * 政治資金収支報告書と文書識別コードIdを取得する
     *
     * @return 政治資金収支報告書と文書識別コードId
     */
    public Long getTaskPlanBalancesheetDocumentId() {
        return taskPlanBalancesheetDocumentId;
    }

    /**
     * 政治資金収支報告書と文書識別コードIdを設定する
     *
     * @param taskPlanBalancesheetDocumentId 政治資金収支報告書と文書識別コードId
     */
    public void setTaskPlanBalancesheetDocumentId(final Long taskPlanBalancesheetDocumentId) {
        this.taskPlanBalancesheetDocumentId = taskPlanBalancesheetDocumentId;
    }
    ...
    /**
     * 政治資金収支報告書処理計画Idを取得する
     *
     * @return 政治資金収支報告書処理計画Id
     */
    ...
    /**
     * 政治資金収支報告書処理計画Idを設定する
     *
     * @param taskPlanBalancesheetDetailId 政治資金収支報告書処理計画Id
     */
