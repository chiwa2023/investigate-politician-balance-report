 ...
 */
@Component
public class InsertPoliticalOrganization0802Y2022Logic {
    ...
    public int practice(final Long documentCode,
        ...
        List<OfferingBalancesheetWithdrawal0802Transfer2022Entity> list = new ArrayList<>();

        // 同一識別コードの取得
        Long code = 0L;
        Optional<OfferingBalancesheetWithdrawal0802Transfer2022Entity> optional = offeringBalancesheetWithdrawal0802Transfer2022Repository
    ...
    private OfferingBalancesheetWithdrawal0802Transfer2022Entity createEntity(final Long code, final Long documentCode,
            final Sheet080200WithdrawalItemsByTransferDto sheetDto,
            final BalancesheetReportDocumentPoliticalPropertyDto documentPropertyDto,
            final CheckPrivilegeDto checkPrivilegeDto) {
        OfferingBalancesheetWithdrawal0802Transfer2022Entity balancesheetEntity = new OfferingBalancesheetWithdrawal0802Transfer2022Entity();
