 ...
 */
@Component
public class InsertPoliticalOrganizationSheet0701And0720Y2024Logic {
    ...
    public Long practice(final BalancesheetReportDocumentPoliticalPropertyDto documentPropertyDto,
        ...
        OfferingBalancesheet0701And0720Surface2024Entity balancesheetEntity = new OfferingBalancesheet0701And0720Surface2024Entity();
        // ヘッダ
        ...
        //同一識別コードの設定
        Long code = 1L;
        Optional<OfferingBalancesheet0701And0720Surface2024Entity> optional = offeringBalancesheet0701And0720Surface2024Repository.findFirstByOrderByOfferingBalancesheet0701And0720SurfaceCodeDesc();
        if(!optional.isEmpty()) {
        ...
        offeringBalancesheet0701And0720Surface2024Repository.save(balancesheetEntity);
