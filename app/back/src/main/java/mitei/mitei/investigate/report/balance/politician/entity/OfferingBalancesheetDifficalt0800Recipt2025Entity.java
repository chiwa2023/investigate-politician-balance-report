...
/**
 * offering_balancesheet_difficalt_0800_recipt_2025接続用Entity
 */
@Entity
@Table(name = "offering_balancesheet_difficalt_0800_recipt_2025")
public class OfferingBalancesheetDifficalt0800Recipt2025Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
    ...
    @Column(name = "offering_balancesheet_difficalt_0800_recipt_id")
    private Long offeringBalancesheetDifficalt0800ReciptId = INIT_Long;
     ...
     * @return 収支報告書様式8Id
     */
    public Long getOfferingBalancesheetDifficalt0800ReciptId() {
        return offeringBalancesheetDifficalt0800ReciptId;
    }

    /**
     * 収支報告書様式8Idを設定する
     *
     * @param offeringBalancesheetDifficalt0800ReciptId 収支報告書様式8Id
     */
    public void setOfferingBalancesheetDifficalt0800ReciptId(final Long offeringBalancesheetDifficalt0800ReciptId) {
        this.offeringBalancesheetDifficalt0800ReciptId = offeringBalancesheetDifficalt0800ReciptId;
    }

    /** 収支報告書様式8同一識別コード */
    @Column(name = "offering_balancesheet_difficalt_0800_recipt_code")
    private Long offeringBalancesheetDifficalt0800ReciptCode = INIT_Long;

    /**
     * 収支報告書様式8同一識別コードを取得する
     *
     * @return 収支報告書様式8同一識別コード
     */
    public Long getOfferingBalancesheetDifficalt0800ReciptCode() {
        return offeringBalancesheetDifficalt0800ReciptCode;
    }

    /**
     * 収支報告書様式8同一識別コードを設定する
     *
     * @param offeringBalancesheetDifficalt0800ReciptCode 収支報告書様式8同一識別コード
     */
    public void setOfferingBalancesheetDifficalt0800ReciptCode(final Long offeringBalancesheetDifficalt0800ReciptCode) {
        this.offeringBalancesheetDifficalt0800ReciptCode = offeringBalancesheetDifficalt0800ReciptCode;
    }
    ...
    /** 項目 */
    @Column(name = "koumoku")
    private String koumoku = INIT_String;
    ...
    /** 事情 */
    @Column(name = "jijyou")
    private String jijyou = INIT_String;
