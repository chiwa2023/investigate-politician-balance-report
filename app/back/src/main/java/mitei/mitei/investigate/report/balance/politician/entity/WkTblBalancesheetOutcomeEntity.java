...
/**
 * wk_tbl_balancesheet_outcome接続用Entity
 */
@Entity
@Table(name = "wk_tbl_balancesheet_outcome")
public class WkTblBalancesheetOutcomeEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
