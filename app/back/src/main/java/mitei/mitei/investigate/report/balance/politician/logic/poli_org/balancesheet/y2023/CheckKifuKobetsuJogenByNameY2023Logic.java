 ...
 */
@Component
public class CheckKifuKobetsuJogenByNameY2023Logic {
    ...
    public SearchKifuJougenMeisaiBalancesheetResultDto practice(final Integer poliOrgCode, final Integer seachKifuKbn ,final Integer youshikiEdaKbn,
        ...
        // 原文書名称の政治団体名を取得
        List<String> listOrgName = offeringBalancesheetIncome2023Repository.findPartnerNameByPoliOrg(poliOrgCode,
                youshikiEdaKbn);

        // 政治団体の明細を取得する
        List<OfferingBalancesheetIncome2023Entity> listOrgMeisai = offeringBalancesheetIncome2023Repository
