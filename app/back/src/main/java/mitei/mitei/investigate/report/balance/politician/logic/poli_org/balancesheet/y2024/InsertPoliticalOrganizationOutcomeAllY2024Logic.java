 ...
 */
@Component
public class InsertPoliticalOrganizationOutcomeAllY2024Logic {
    ...
    public int practice(final Long documentCode, // SUPPRESS CHECKSTYLE NOPMD
        ...
        List<OfferingBalancesheetOutcome2024Entity> list = new ArrayList<>();
        ...
        // 同一識別コードの設定
        Long code = 0L;
        Optional<OfferingBalancesheetOutcome2024Entity> optional = offeringBalancesheetOutcome2024Repository
        ...
        offeringBalancesheetOutcome2024Repository.saveAll(list);

        return list.size();
    }

    private List<OfferingBalancesheetOutcome2024Entity> createList(final Long documentCode,
    ...
    private OfferingBalancesheetOutcome2024Entity createEntity(final Long documentCode,
            final BalancesheetReportDocumentPoliticalPropertyDto documentPropertyDto, final Integer youshikiKbn,
            final Integer youshikiEdaKbn, final Row071415OrdinaryExpensesDto rowDto, final Long pageTotal,
            final String sonotaTotal, final String himoku, final CheckPrivilegeDto checkPrivilegeDto) {

        OfferingBalancesheetOutcome2024Entity outcomeEntity = new OfferingBalancesheetOutcome2024Entity();
