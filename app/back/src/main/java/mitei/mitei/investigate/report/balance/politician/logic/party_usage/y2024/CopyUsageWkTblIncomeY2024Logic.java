...
/**
 * 使途報告書収入テーブルワークテーブル複写用データ抽出Logic(2024)
 */
@Component
public class CopyUsageWkTblIncomeY2024Logic {
    ...
    public Integer practiceSize(final Long documentCode){
        return offeringPartyUsage0802Kbn02Report2024Repository.findByDocumentRow(documentCode);
    }
    ...
    public List<WkTblUsageIncomeEntity> practice(final Long documentCode, final Integer pageNumber,
        ...
        List<OfferingPartyUsage0802Kbn02Report2024Entity> listSrc = offeringPartyUsage0802Kbn02Report2024Repository
                .findByDocumentCodeOrderByPartyUsage0802Kbn02ReportId(documentCode, pageable);

        List<WkTblUsageIncomeEntity> list = new ArrayList<>();
        for (OfferingPartyUsage0802Kbn02Report2024Entity entitySrc : listSrc) {
     ...
     */
    private WkTblUsageIncomeEntity createEntity(final OfferingPartyUsage0802Kbn02Report2024Entity entitySrc,
