 ...
 */
@Component
public class SearchPartyJougenByGenbunshoNameY2025Logic {
    ...
    public SearchKifuJougenMeisaiBalancesheetResultDto practice(final KifuJougenConditionCapsuleDto capsuleDto) {
        ...
        if (capsuleDto.getAllCount().equals(0)) {
            Integer allCount = offeringBalancesheetIncome2025Repository.findCountTradingPartnerPartyByName(poliOrgCode);
        ...
        List<SouryouKiseiGenBunshoEntity> listSum = offeringBalancesheetIncome2025Repository
        ...
        for (SouryouKiseiGenBunshoEntity entity : listSum) {
            ...
            // 各関連者に紐づく入金明細を取得
            List<OfferingBalancesheetIncome2025Entity> listMeisaiOffering = offeringBalancesheetIncome2025Repository
    ...
    private KifuJougenTradingInfoDto createDto(final SouryouKiseiGenBunshoEntity entity,
            final List<OfferingBalancesheetIncome2025Entity> listMeisaiOffering) {
        ...
        // 代表として1件目を表示
        OfferingBalancesheetIncome2025Entity entityIncomeFirst = listMeisaiOffering.get(0);
        ...
        for (OfferingBalancesheetIncome2025Entity entityIncome : listMeisaiOffering) {
