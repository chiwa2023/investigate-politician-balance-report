...
public class InsertPartyUsageShito0806Logic {
    ...
    public int practice(final Long documentCode,
        ...
        List<OfferingPartyUsage0806Report2025Entity> list = new ArrayList<>();
        ...
        //同一識別コードを取得する
        Long code = 0L;
        Optional<OfferingPartyUsage0806Report2025Entity> optional = offeringPartyUsage0806Report2025Repository
        ...
        // repositoryで保存
        offeringPartyUsage0806Report2025Repository.saveAll(list);

        return list.size();
    }

    private List<OfferingPartyUsage0806Report2025Entity> createEntity(final Long documentCode,
            final PartyUsageDocumentPoliticalPropertyDto partyUsageDocumentPoliticalPropertyDto,
            final Sheet0806Dto sheet0806Dto, final CheckPrivilegeDto checkPrivilegeDto) {

        OfferingPartyUsage0806Report2025Entity reportEntity = new OfferingPartyUsage0806Report2025Entity();
    ...
    private List<OfferingPartyUsage0806Report2025Entity> createEntityByKbn01(final Long documentCode,
            final PartyUsageDocumentPoliticalPropertyDto partyUsageDocumentPoliticalPropertyDto,
    ...
    private List<OfferingPartyUsage0806Report2025Entity> createEntityByKbn02(final Long documentCode,
            final PartyUsageDocumentPoliticalPropertyDto partyUsageDocumentPoliticalPropertyDto,
    ...
    private List<OfferingPartyUsage0806Report2025Entity> createEntityByKbn03(final Long documentCode,
            final PartyUsageDocumentPoliticalPropertyDto partyUsageDocumentPoliticalPropertyDto,
    ...
    private OfferingPartyUsage0806Report2025Entity createEntityByRow0(final int kbn, final Long documentCode,
