...
/**
 * 使途報告書支出データをワークテーブルに複写するデータを抽出する(2023)
 */
@Component
public class CopyUsageWkTbOutncomeY2023Logic {
    ...
    public Integer practiceSize(final Long documentCode){
        return offeringPartyUsage0804Report2023Repository.findByDocumentRow(documentCode);
    }
    ...
    public List<WkTblUsageOutcomeEntity> practice(final Long documentCode, final Integer pageNumber,
        ...
        List<OfferingPartyUsage0804Report2023Entity> listSrc = offeringPartyUsage0804Report2023Repository
                .findByDocumentCodeOrderByPartyUsage0804ReportId(documentCode, pageable);

        List<WkTblUsageOutcomeEntity> list = new ArrayList<>();
        for (OfferingPartyUsage0804Report2023Entity entitySrc : listSrc) {
     ...
     */
    private WkTblUsageOutcomeEntity createEntity(final OfferingPartyUsage0804Report2023Entity entitySrc,
