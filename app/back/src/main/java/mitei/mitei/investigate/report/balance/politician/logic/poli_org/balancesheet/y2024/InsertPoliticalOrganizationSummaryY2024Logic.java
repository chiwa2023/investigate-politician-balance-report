 ...
 */
@Component
public class InsertPoliticalOrganizationSummaryY2024Logic {
    ...
    public int practice(final Long documentCode,
        ...
        OfferingBalancesheet0702And0713And0717Summary2024Entity summaryEntity = new OfferingBalancesheet0702And0713And0717Summary2024Entity();
        ...
        // 同一識別コードの取得
        Long code = 1L;
        Optional<OfferingBalancesheet0702And0713And0717Summary2024Entity> optional = offeringBalancesheet0702And0713And0717Summary2024Repository
        ...
        Long idRecord = offeringBalancesheet0702And0713And0717Summary2024Repository.save(summaryEntity)
