 ...
 */
@Component
public class UpdatePoliticalOrganizationSummaryY2024Logic {
    ...
    public int practice(final Long oldCode, final CheckPrivilegeDto checkPrivilegeDto) {
        ...
        // 取得できた数を更新に値をセット
        for (OfferingBalancesheet0702And0713And0717Summary2024Entity entity : list) {
            SetTableDataHistoryUtil.practice(checkPrivilegeDto, entity, DataHistoryStatusConstants.UPDATE);
        }

        return offeringBalancesheet0702And0713And0717Summary2024Repository.saveAll(list).size();
