 ...
 */
@Component
public class UkaiKenkinIncomeStage05TimesItemReader extends AbstractPagingItemReader<OfferingBalancesheetIncomeEntity> {
     ...
     */
    public UkaiKenkinIncomeStage05TimesItemReader(
