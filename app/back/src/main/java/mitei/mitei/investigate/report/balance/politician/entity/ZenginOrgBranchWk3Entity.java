...
/**
 * zengin_org_branch_Wk3接続用Entity
 */
@Entity
@Table(name = "zengin_org_branch_Wk3")
public class ZenginOrgBranchWk3Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
    ...
    @Column(name = "zengin_org_branch_wk3_id")
    private Integer zenginOrgBranchWk3Id = INIT_Integer;
     ...
     * @return 金融機関マスタId
     */
    public Integer getZenginOrgBranchWk3Id() {
        return zenginOrgBranchWk3Id;
    }

    /**
     * 金融機関マスタIdを設定する
     *
     * @param zenginOrgBranchWk3Id 金融機関マスタId
     */
    public void setZenginOrgBranchWk3Id(final Integer zenginOrgBranchWk3Id) {
        this.zenginOrgBranchWk3Id = zenginOrgBranchWk3Id;
    }

    /** 全銀協金融機関マスタ同一識別コード */
    @Column(name = "zengin_org_branch_wk3_code")
    private Integer zenginOrgBranchWk3Code = INIT_Integer;
     ...
     */
    public Integer getZenginOrgBranchWk3Code() {
        return zenginOrgBranchWk3Code;
    }

    /**
     * 全銀協金融機関マスタ同一識別コードを設定する
     *
     * @param zenginOrgBranchWk3Code 全銀協金融機関マスタ同一識別コード
     */
    public void setZenginOrgBranchWk3Code(final Integer zenginOrgBranchWk3Code) {
        this.zenginOrgBranchWk3Code = zenginOrgBranchWk3Code;
    }

    /** 全銀協金融機関名称 */
    @Column(name = "zengin_org_branch_wk3_name")
    private String zenginOrgBranchWk3Name = INIT_String;
     ...
     * @return 全銀協金融機関名称
     */
    public String getZenginOrgBranchWk3Name() {
        return zenginOrgBranchWk3Name;
    }

    /**
     * 全銀協金融機関名称を設定する
     *
     * @param zenginOrgBranchWk3Name 全銀協金融機関名称
     */
    public void setZenginOrgBranchWk3Name(final String zenginOrgBranchWk3Name) {
        this.zenginOrgBranchWk3Name = zenginOrgBranchWk3Name;
    }
