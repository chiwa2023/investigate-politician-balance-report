 ...
 */
@Component
public class ConvertFukisaiOutcomeY2023Logic {
    ...
    public List<WkTblFukisaiBalancesheetEntity> practiceCode(final Integer poliOrgCode,
        ...
        List<OfferingBalancesheetOutcome2023Entity> listOutcome = offeringBalancesheetOutcome2023Repository
        ...
        for (OfferingBalancesheetOutcome2023Entity entity : listOutcome) {
    ...
    private WkTblFukisaiBalancesheetEntity copyEntity(final OfferingBalancesheetOutcome2023Entity entity,
