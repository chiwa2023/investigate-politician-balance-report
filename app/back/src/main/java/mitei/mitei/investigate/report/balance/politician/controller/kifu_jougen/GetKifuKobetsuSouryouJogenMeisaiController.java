...
import mitei.mitei.investigate.report.balance.politician.service.kifu_jogen.GetKifuKobetsuSouryouJogenMeisaiService;

/**
 * 寄付上限チェックに必要な明細取得Controller
 */
@Controller
@RequestMapping("/kifu-jougen")
public class GetKifuKobetsuSouryouJogenMeisaiController extends AbstractTemplateCheckController {
   ...
   public ResponseEntity<SearchKifuJougenMeisaiBalancesheetResultDto> practice(
        ...
        try {
            ...
            return ResponseEntity.ok(getKifuKobetsuSouryouJogenMeisaiService.practice(capsuleDto));
