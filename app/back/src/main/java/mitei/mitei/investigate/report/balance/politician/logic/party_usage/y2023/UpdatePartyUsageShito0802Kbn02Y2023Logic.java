 ...
 */
@Component
public class UpdatePartyUsageShito0802Kbn02Y2023Logic {
    ...
    public int practice(final Long oldCode, final CheckPrivilegeDto checkPrivilegeDto) {
        ...
        List<OfferingPartyUsage0802Kbn02Report2023Entity> list = offeringPartyUsage0802Kbn02Report2023Repository
                .findByDocumentCodeOrderByPartyUsage0802Kbn02ReportId(oldCode);

        // 取得できた数を更新に値をセット
        for (OfferingPartyUsage0802Kbn02Report2023Entity entity : list) {
