 ...
 */
@Component
public class GetBakancesheet0213SummaryY2022Logic {

    /** 政治資金収支報告書要約Repository(2022) */
    @Autowired
    ...
    public KeinenHenkaSurfaceAndSummaryByYearDto practice(final Integer poliOrgCode) {
        ...
        // 最新の提出日の最新データを取得する
        Optional<OfferingBalancesheet0701And0720Surface2022Entity> optional = offeringBalancesheet0701And0720Surface2022Repository
        ...
        if (optional.isEmpty()) {
            ...
            // 表紙が取得できたので設定
            OfferingBalancesheet0701And0720Surface2022Entity entityDocument = optional.get();
            BeanUtils.copyProperties(entityDocument, entitySurface);

            // 表紙と同じ文書同一識別コードを持っている最新データを取得する
            List<OfferingBalancesheet0702And0713And0717Summary2022Entity> listYear = offeringBalancesheet0702And0713And0717Summary2022Repository
