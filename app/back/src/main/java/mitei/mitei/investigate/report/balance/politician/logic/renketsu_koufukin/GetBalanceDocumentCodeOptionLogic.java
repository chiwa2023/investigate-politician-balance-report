...
import mitei.mitei.investigate.report.balance.politician.logic.poli_org.balancesheet.y2022.GetBalanceDocumentCodeOptionY2022Logic;

/**
 * 政治団体から使途報告書文書コード選択肢リストを取得するLogic
 */
@Component
public class GetBalanceDocumentCodeOptionLogic {
    ...
    /** 登録対応年(2022)Logic */
    @Autowired // 2022
    private GetBalanceDocumentCodeOptionY2022Logic getBalanceDocumentCodeOptionY2022Logic;
    ...
    public List<SelectOptionDto> practice(final SearchDocumentCodeByOfferingCapsuleDto capsuleDto) {
        ...
        switch (houkokuNen) {
            case YEAR_2022:
                return getBalanceDocumentCodeOptionY2022Logic.practice(capsuleDto.getPoliOrgCode());
            default:
