 ...
 */
public interface OfferingPartyUsage0802Kbn02Report2023Repository
        extends JpaRepository<OfferingPartyUsage0802Kbn02Report2023Entity, Integer> {
     ...
     * @return データリスト(Id順)
     */
    List<OfferingPartyUsage0802Kbn02Report2023Entity> findByDocumentCodeOrderByPartyUsage0802Kbn02ReportId(
            Long documentCode);
     ...
     * @return 件数
     */
    @Query(value = "SELECT count(*) AS count FROM offering_party_usage_0802_kbn_02_report_2023 WHERE document_code = ?1", nativeQuery = true)
