 ...
 */
public interface OfferingPartyUsage0806Report2024Repository
        extends JpaRepository<OfferingPartyUsage0806Report2024Entity, Integer> {
    ...
    // * @return 検索結果
    // */
    // @Query(value = "SELECT * FROM offering_party_usage_0806_report_2024 WHERE
    // saishin_kbn= 1 AND MATCH(offering_party_usage_0806_report_2024_name) AGAINST
    // (?1 IN NATURAL LANGUAGE MODE)", nativeQuery = true)
    // List<OfferingPartyUsage0806Report2024Entity> findFullText(String
    // searchWords);
