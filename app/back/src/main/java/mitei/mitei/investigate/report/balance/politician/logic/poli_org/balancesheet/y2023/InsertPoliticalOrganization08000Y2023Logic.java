 ...
 */
@Component
public class InsertPoliticalOrganization08000Y2023Logic {
    ...
    public int practice(final Long documentCode,
        ...
        List<OfferingBalancesheetDifficalt0800Recipt2023Entity> list = new ArrayList<>();

        // コードの取得
        Long code = 0L;
        Optional<OfferingBalancesheetDifficalt0800Recipt2023Entity> optional = offeringBalancesheetDifficalt0800Recipt2023Repository
    ...
    private OfferingBalancesheetDifficalt0800Recipt2023Entity createEntity(final Long code,
        ...
        OfferingBalancesheetDifficalt0800Recipt2023Entity balancesheetEntity = new OfferingBalancesheetDifficalt0800Recipt2023Entity();
