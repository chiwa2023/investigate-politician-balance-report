 ...
 */
@Component
public class UkaiKenkinIncomeStage09TimesItemReader extends AbstractPagingItemReader<OfferingBalancesheetIncomeEntity> {
     ...
     */
    public UkaiKenkinIncomeStage09TimesItemReader(
