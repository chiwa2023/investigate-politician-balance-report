...
/**
 * task_plan_party_usage_document接続用Entity
 */
@Entity
@Table(name = "task_plan_party_usage_document")
public class TaskPlanPartyUsageDocumentEntity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
    ...
    @Column(name = "task_plan_party_usage_document_id")
    private Long taskPlanPartyUsageDocumentId = INIT_Long;

    /**
     * 政党交付金使途報告書文書識別コードIdを取得する
     *
     * @return 政党交付金使途報告書文書識別コードId
     */
    public Long getTaskPlanPartyUsageDocumentId() {
        return taskPlanPartyUsageDocumentId;
    }

    /**
     * 政党交付金使途報告書文書識別コードIdを設定する
     *
     * @param taskPlanPartyUsageDocumentId 政党交付金使途報告書文書識別コードId
     */
    public void setTaskPlanPartyUsageDocumentId(final Long taskPlanPartyUsageDocumentId) {
        this.taskPlanPartyUsageDocumentId = taskPlanPartyUsageDocumentId;
    }
    ...
    /**
     * 政党交付金使途報告書処理計画Idを取得する
     *
     * @return 政党交付金使途報告書処理計画Id
     */
    ...
    /**
     * 政党交付金使途報告書処理計画Idを設定する
     *
     * @param taskPlanPartyUsageDetailId 政党交付金使途報告書処理計画Id
     */
