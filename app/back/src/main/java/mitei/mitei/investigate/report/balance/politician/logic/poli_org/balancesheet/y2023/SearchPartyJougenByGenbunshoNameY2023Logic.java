 ...
 */
@Component
public class SearchPartyJougenByGenbunshoNameY2023Logic {
    ...
    public SearchKifuJougenMeisaiBalancesheetResultDto practice(final KifuJougenConditionCapsuleDto capsuleDto) {
        ...
        if (capsuleDto.getAllCount().equals(0)) {
            Integer allCount = offeringBalancesheetIncome2023Repository.findCountTradingPartnerPartyByName(poliOrgCode);
        ...
        List<SouryouKiseiGenBunshoEntity> listSum = offeringBalancesheetIncome2023Repository
        ...
        for (SouryouKiseiGenBunshoEntity entity : listSum) {
            ...
            // 各関連者に紐づく入金明細を取得
            List<OfferingBalancesheetIncome2023Entity> listMeisaiOffering = offeringBalancesheetIncome2023Repository
    ...
    private KifuJougenTradingInfoDto createDto(final SouryouKiseiGenBunshoEntity entity,
            final List<OfferingBalancesheetIncome2023Entity> listMeisaiOffering) {
        ...
        // 代表として1件目を表示
        OfferingBalancesheetIncome2023Entity entityIncomeFirst = listMeisaiOffering.get(0);
        ...
        for (OfferingBalancesheetIncome2023Entity entityIncome : listMeisaiOffering) {
