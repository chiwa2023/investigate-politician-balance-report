...
import mitei.mitei.investigate.report.balance.politician.service.poli_org.kanrensha.ShowBalancesheetReportByKanrenshaService;

/**
 * 関連者データを抽出する
 */
@Controller
@RequestMapping("/show-balancesheet")
public class ShowBalancesheetReportByKanrenshaController extends AbstractTemplateCheckController {
    ...
    /** 関連者データを抽出Service */
    @Autowired
    private ShowBalancesheetReportByKanrenshaService showBalancesheetReportByKanrensha;
     ...
     */
    @PostMapping("/kanrensha")
    public ResponseEntity<IncomeAndOutcomeNaturalSearchResultDto> practice(
            @RequestBody final KanrenshaBalancesheetConditionCapsuleDto capsuleDto) {
        ...
        try {
             ...
             * ここに固有のビジネス処理を記載する
             */
            return ResponseEntity.ok(showBalancesheetReportByKanrensha.practice(capsuleDto));
