 ...
 */
@Component
public class UpdatePoliticalOrganization0802Y2023Logic {
    ...
    public int practice(final Long oldCode, final CheckPrivilegeDto checkPrivilegeDto) {
        ...
        List<OfferingBalancesheetWithdrawal0802Transfer2023Entity> list = offeringBalancesheetWithdrawal0802Transfer2023Repository
                .findByDocumentCodeOrderByOfferingBalancesheetWithdrawal0802TransferId(oldCode);

        // 取得できた数を更新に値をセット
        for (OfferingBalancesheetWithdrawal0802Transfer2023Entity entity : list) {
