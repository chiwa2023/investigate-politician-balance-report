...
public interface OfferingPartyUsage0805Report2025Repository
    ...
    // * @return 検索結果
    // */
    // @Query(value = "SELECT * FROM offering_party_usage_0805_report_2025 WHERE
    // saishin_kbn= 1 AND MATCH(offering_party_usage_0805_report_2025_name) AGAINST
    // (?1 IN NATURAL LANGUAGE MODE)", nativeQuery = true)
    // List<OfferingPartyUsage0805Report2025Entity> findFullText(String
    // searchWords);
