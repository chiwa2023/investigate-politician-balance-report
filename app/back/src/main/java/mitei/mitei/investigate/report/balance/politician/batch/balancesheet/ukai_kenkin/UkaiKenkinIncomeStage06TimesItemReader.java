 ...
 */
@Component
public class UkaiKenkinIncomeStage06TimesItemReader extends AbstractPagingItemReader<OfferingBalancesheetIncomeEntity> {
     ...
     */
    public UkaiKenkinIncomeStage06TimesItemReader(
