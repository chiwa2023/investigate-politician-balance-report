...
/**
 * send_alert_mail_2022接続用Entity
 */
@Entity
@Table(name = "send_alert_mail_2022")
public class SendAlertMail2022Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
