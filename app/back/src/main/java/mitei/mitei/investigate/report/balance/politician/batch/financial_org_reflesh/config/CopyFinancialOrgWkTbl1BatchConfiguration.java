...
import mitei.mitei.investigate.report.balance.politician.batch.financial_org_reflesh.CleanZenginOrgBranchWkTbl1Tasklet;
...
import mitei.mitei.investigate.report.balance.politician.batch.financial_org_reflesh.FinancialOrgCsvWkTbl1Processor;
import mitei.mitei.investigate.report.balance.politician.batch.financial_org_reflesh.ZenginOrgBranchWkTbl1ItemWriter;
 ...
 */
@Configuration
public class CopyFinancialOrgWkTbl1BatchConfiguration {

    /** 機能名 */
    private static final String FUNCTION_NAME = "copyFinancialOrgWkTbl1";
    ...
    protected Step getStepInsert(final JobRepository jobRepository,
        ...
        return new StepBuilder(STEP_INSERT_NAME, jobRepository)
                .<FinancialOrgCsvDto, ZenginOrgBranchWk1Entity>chunk(CHUNK_SIZE, transactionManager)
                .reader(financialOrgCsvItemReader).processor(financialOrgCsvWkTbl1Processor)
                .writer(zenginOrgBranchWkTbl1ItemWriter).build();
    }
    ...
    protected Step getStepUpdate(final JobRepository jobRepository,
        ...
        return new StepBuilder(STEP_CLEAN_NAME, jobRepository)
                .tasklet(cleanZenginOrgBranchWkTbl1Tasklet, transactionManager).build();
    }
