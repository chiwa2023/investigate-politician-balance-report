 ...
 */
@Component
public class CheckKifuKobetsuJogenByRelationCodeY2023Logic {

    /** 政治資金収支報告書収入Repository(2023) */
    @Autowired
    ...
    public SearchKifuJougenMeisaiBalancesheetResultDto practice(final Integer poliOrgCode, final Integer seachKifuKbn ,final Integer youshikiEdaKbn,
        ...
        List<OfferingBalancesheetIncome2023Entity> listOrgMeisai = this.getSearchResult(poliOrgCode, youshikiEdaKbn,
                listOther, pageable);
        ...
        if (!listOrgMeisai.isEmpty()) {
            ...
            Long sum = 0L;
            for (OfferingBalancesheetIncome2023Entity entity : listOrgMeisai) {
    ...
    // 様式枝区分ことにリストを取得する
    private List<OfferingBalancesheetIncome2023Entity> getSearchResult(final Integer poliOrgCode,
        ...
        switch (youshikiEdaKbn) {
            case YoushikiEdaKbn.KOJIN:
                List<Integer> listPerson = offeringBalancesheetIncome2023Repository
                        .findRelationPersonByPoliOrg(poliOrgCode);
                return offeringBalancesheetIncome2023Repository
            ...
            case YoushikiEdaKbn.KIGYOU_DANTAI:
                List<Integer> listCorp = offeringBalancesheetIncome2023Repository
            ...
            case YoushikiEdaKbn.SEIJI_DANTAI:
                ...
                List<Integer> listOrg = offeringBalancesheetIncome2023Repository
    ...
    private KobetsuKiseiMeisaiEntity convertEntiy(final OfferingBalancesheetIncome2023Entity entity,
    ...
    // 取引明細Dtoを作成する
    private KifuJougenTradingInfoDto createTradingDto(final OfferingBalancesheetIncome2023Entity entity) {
    ...
    // 関連Idを取得する
    private Long getRelationId(final OfferingBalancesheetIncome2023Entity entity) {
    ...
    // 関連Codeを取得する
    private Integer getRelationCode(final OfferingBalancesheetIncome2023Entity entity) {
