 ...
 */
@Component
public class InsertPartyUsageShito0802And0803Y2023Logic {
    ...
    public int practice(final Long documentCode,
        ...
        OfferingPartyUsage0802And0803Report2023Entity reportEntity = new OfferingPartyUsage0802And0803Report2023Entity();
        ...
        // 同一識別コード取得
        Long code = 1L;
        Optional<OfferingPartyUsage0802And0803Report2023Entity> optional = offeringPartyUsage0802And0803Report2023Repository
        ...
        offeringPartyUsage0802And0803Report2023Repository.save(reportEntity);
