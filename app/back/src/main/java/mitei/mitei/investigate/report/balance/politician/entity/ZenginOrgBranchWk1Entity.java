...
/**
 * zengin_org_branch_wk1接続用Entity
 */
@Entity
@Table(name = "zengin_org_branch_wk1")
public class ZenginOrgBranchWk1Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
    ...
    @Column(name = "zengin_org_branch_wk1_id")
    private Integer zenginOrgBranchWk1Id = INIT_Integer;
     ...
     * @return 金融機関マスタId
     */
    public Integer getZenginOrgBranchWk1Id() {
        return zenginOrgBranchWk1Id;
    }

    /**
     * 金融機関マスタIdを設定する
     *
     * @param zenginOrgBranchWk1Id 金融機関マスタId
     */
    public void setZenginOrgBranchWk1Id(final Integer zenginOrgBranchWk1Id) {
        this.zenginOrgBranchWk1Id = zenginOrgBranchWk1Id;
    }

    /** 全銀協金融機関マスタ同一識別コード */
    @Column(name = "zengin_org_branch_wk1_code")
    private Integer zenginOrgBranchWk1Code = INIT_Integer;
     ...
     */
    public Integer getZenginOrgBranchWk1Code() {
        return zenginOrgBranchWk1Code;
    }

    /**
     * 全銀協金融機関マスタ同一識別コードを設定する
     *
     * @param zenginOrgBranchWk1Code 全銀協金融機関マスタ同一識別コード
     */
    public void setZenginOrgBranchWk1Code(final Integer zenginOrgBranchWk1Code) {
        this.zenginOrgBranchWk1Code = zenginOrgBranchWk1Code;
    }

    /** 全銀協金融機関名称 */
    @Column(name = "zengin_org_branch_wk1_name")
    private String zenginOrgBranchWk1Name = INIT_String;
     ...
     * @return 全銀協金融機関名称
     */
    public String getZenginOrgBranchWk1Name() {
        return zenginOrgBranchWk1Name;
    }

    /**
     * 全銀協金融機関名称を設定する
     *
     * @param zenginOrgBranchWk1Name 全銀協金融機関名称
     */
    public void setZenginOrgBranchWk1Name(final String zenginOrgBranchWk1Name) {
        this.zenginOrgBranchWk1Name = zenginOrgBranchWk1Name;
    }
