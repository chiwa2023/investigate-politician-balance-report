...
/**
 * 政党交付金使途報告書表紙と集計取得Logic(2024)
 */
@Component
public class GetUsage010203SummaryY2024Logic {

    /** 政党交付金使途報告書表紙(様式区分8の1と7)Repository(2024) */
    @Autowired
    private OfferingPartyUsage0801And0807Report2024Repository offeringPartyUsage0801And0807Report2024Repository;

    /** 政党交付金使途報告書集計表(様式区分8の2と3)Repository(2024) */
    @Autowired
    ...
    public KeinenUsageSurface02103SummaryByYearDto practice(final Integer pooliOrg) {
        ...
        Optional<OfferingPartyUsage0801And0807Report2024Entity> optional = offeringPartyUsage0801And0807Report2024Repository
        ...
        if (!optional.isEmpty()) {
            ...
            List<OfferingPartyUsage0802And0803Report2024Entity> list = offeringPartyUsage0802And0803Report2024Repository
