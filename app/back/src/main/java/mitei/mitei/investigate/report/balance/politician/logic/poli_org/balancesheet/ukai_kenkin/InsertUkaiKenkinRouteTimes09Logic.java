 ...
 */
@Component
public class InsertUkaiKenkinRouteTimes09Logic {
    ...
    public Integer practice(final Integer userCode, final WkTblUkaiKenkinPickupRouteEntity entity,
        ...
        List<Integer> listStage9 = wkTblUkaiKenkinRepository.findRouteByOrgCodeAndStage(userCode, stage9, listBase);
        List<Integer> listStage8 = wkTblUkaiKenkinRepository.findRouteByOrgCodeAndStage(userCode, stage8, listStage9);
        ...
        this.searchRoute(stage8, userCode, listStage8, listStage9, propertyEntity, code);
    ...
    public Integer practice(final Integer userCode, final WkTblUkaiKenkinPickupRouteEntity entity,
        ...
        // 経路は階層0→1,1→2,2→3,3-4,4-5(抽出された取り引相手政治団体識別コード)
        this.searchRoute(stage0, userCode, listStage0, listStage1, personWithYakuwariDto, code);
        this.searchRoute(stage1, userCode, listStage1, listStage2, personWithYakuwariDto, code);
        this.searchRoute(stage2, userCode, listStage2, listStage3, personWithYakuwariDto, code);
        this.searchRoute(stage3, userCode, listStage3, listStage4, personWithYakuwariDto, code);
        this.searchRoute(stage4, userCode, listStage4, listStage5, personWithYakuwariDto, code);
        this.searchRoute(stage5, userCode, listStage5, listStage6, personWithYakuwariDto, code);
        this.searchRoute(stage6, userCode, listStage6, listStage7, personWithYakuwariDto, code);
        this.searchRoute(stage7, userCode, listStage7, listStage8, personWithYakuwariDto, code);
        this.searchRoute(stage8, userCode, listStage8, listStage9, personWithYakuwariDto, code);

        // 迂回献金した場合の参照データを保存する
        List<WkTblUkaiKenkinEntity> listPair = wkTblUkaiKenkinRepository
                .findByInsertUserCodeAndTradingPartnerCodeAndPickupStage(userCode, entity.getTradingPartnerCode(),
                        stage0);
        this.recordEntity(listPair, personWithYakuwariDto, code);
