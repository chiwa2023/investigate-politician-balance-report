...
/**
 * task_plan_party_usage_detail接続用Entity
 */
@Entity
@Table(name = "task_plan_party_usage_detail")
public class TaskPlanPartyUsageDetailEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
