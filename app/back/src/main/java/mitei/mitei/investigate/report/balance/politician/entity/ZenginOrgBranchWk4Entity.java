...
/**
 * zengin_org_branch_Wk4接続用Entity
 */
@Entity
@Table(name = "zengin_org_branch_Wk4")
public class ZenginOrgBranchWk4Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
    ...
    @Column(name = "zengin_org_branch_wk4_id")
    private Integer zenginOrgBranchWk4Id = INIT_Integer;
     ...
     * @return 金融機関マスタId
     */
    public Integer getZenginOrgBranchWk4Id() {
        return zenginOrgBranchWk4Id;
    }

    /**
     * 金融機関マスタIdを設定する
     *
     * @param zenginOrgBranchWk4Id 金融機関マスタId
     */
    public void setZenginOrgBranchWk4Id(final Integer zenginOrgBranchWk4Id) {
        this.zenginOrgBranchWk4Id = zenginOrgBranchWk4Id;
    }

    /** 全銀協金融機関マスタ同一識別コード */
    @Column(name = "zengin_org_branch_wk4_code")
    private Integer zenginOrgBranchWk4Code = INIT_Integer;
     ...
     */
    public Integer getZenginOrgBranchWk4Code() {
        return zenginOrgBranchWk4Code;
    }

    /**
     * 全銀協金融機関マスタ同一識別コードを設定する
     *
     * @param zenginOrgBranchWk4Code 全銀協金融機関マスタ同一識別コード
     */
    public void setZenginOrgBranchWk4Code(final Integer zenginOrgBranchWk4Code) {
        this.zenginOrgBranchWk4Code = zenginOrgBranchWk4Code;
    }

    /** 全銀協金融機関名称 */
    @Column(name = "zengin_org_branch_wk4_name")
    private String zenginOrgBranchWk4Name = INIT_String;
     ...
     * @return 全銀協金融機関名称
     */
    public String getZenginOrgBranchWk4Name() {
        return zenginOrgBranchWk4Name;
    }

    /**
     * 全銀協金融機関名称を設定する
     *
     * @param zenginOrgBranchWk4Name 全銀協金融機関名称
     */
    public void setZenginOrgBranchWk4Name(final String zenginOrgBranchWk4Name) {
        this.zenginOrgBranchWk4Name = zenginOrgBranchWk4Name;
    }
