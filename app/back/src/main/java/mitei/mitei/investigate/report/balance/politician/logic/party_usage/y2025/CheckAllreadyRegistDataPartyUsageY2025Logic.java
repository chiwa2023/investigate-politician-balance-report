 ...
 */
@Component
public class CheckAllreadyRegistDataPartyUsageY2025Logic {
    ...
    public List<Long> practice(final PartyUsageDocumentPoliticalPropertyDto documentPropertyDto) {
        ...
        List<OfferingPartyUsage0801And0807Report2025Entity> listData = offeringPartyUsage0801And0807Report2025Repository
        ...
        for (OfferingPartyUsage0801And0807Report2025Entity entity : listData) {
