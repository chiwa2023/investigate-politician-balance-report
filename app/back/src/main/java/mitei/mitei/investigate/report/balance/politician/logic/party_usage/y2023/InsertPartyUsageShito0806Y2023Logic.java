...
import mitei.mitei.investigate.report.balance.politician.entity.poli_party.usage.y2023.OfferingPartyUsage0806Report2023Entity;
 ...
 */
@Component
public class InsertPartyUsageShito0806Y2023Logic {
    ...
    public int practice(final Long documentCode,
        ...
        List<OfferingPartyUsage0806Report2023Entity> list = new ArrayList<>();
        ...
        // 同一識別コードを取得する
        Long code = 0L;
        Optional<OfferingPartyUsage0806Report2023Entity> optional = offeringPartyUsage0806Report2023Repository
        ...
        // 最後に同一識別コードをふる
        for (OfferingPartyUsage0806Report2023Entity entity : list) {
            code++;
            entity.setPartyUsage0806ReportCode(code);
        }

        // repositoryで保存
        return offeringPartyUsage0806Report2023Repository.saveAll(list).size();
    }

    private List<OfferingPartyUsage0806Report2023Entity> createEntity(final Long documentCode,
            final PartyUsageDocumentPoliticalPropertyDto partyUsageDocumentPoliticalPropertyDto,
            final Sheet0806Dto sheet0806Dto, final CheckPrivilegeDto checkPrivilegeDto) {

        OfferingPartyUsage0806Report2023Entity reportEntity = new OfferingPartyUsage0806Report2023Entity();
    ...
    private List<OfferingPartyUsage0806Report2023Entity> createEntityByKbn01(final Long documentCode,
            final PartyUsageDocumentPoliticalPropertyDto partyUsageDocumentPoliticalPropertyDto,
    ...
    private List<OfferingPartyUsage0806Report2023Entity> createEntityByKbn02(final Long documentCode,
            final PartyUsageDocumentPoliticalPropertyDto partyUsageDocumentPoliticalPropertyDto,
    ...
    private List<OfferingPartyUsage0806Report2023Entity> createEntityByKbn03(final Long documentCode,
            final PartyUsageDocumentPoliticalPropertyDto partyUsageDocumentPoliticalPropertyDto,
    ...
    private OfferingPartyUsage0806Report2023Entity createEntityByRow0(final int kbn, final Long documentCode,
