 ...
 */
@Component
public class ConvertSheetDtoToEntity0709AnonymousInPoliticalPartyY2023Logic {
     ...
     */
    public List<OfferingBalancesheetIncome2023Entity> practice(final Long documentCode,
    ...
    private OfferingBalancesheetIncome2023Entity createEntity0900(final Long documentCode,
        ...
        OfferingBalancesheetIncome2023Entity incomeEntity = new OfferingBalancesheetIncome2023Entity();
