 ...
 */
@Component
public class CheckAllreadyRegistDataPoliticalOrganizationY2023Logic {
    ...
    public List<Long> practice(final BalancesheetReportDocumentPoliticalPropertyDto documentPropertyDto) {
        ...
        List<OfferingBalancesheet0701And0720Surface2023Entity> listData = offeringBalancesheet0701And0720Surface2023Repository
        ...
        for (OfferingBalancesheet0701And0720Surface2023Entity entity : listData) {
