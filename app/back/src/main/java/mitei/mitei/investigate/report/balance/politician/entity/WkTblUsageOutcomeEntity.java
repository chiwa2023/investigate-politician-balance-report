...
/**
 * wk_tbl_usage_outcome接続用Entity
 */
@Entity
@Table(name = "wk_tbl_usage_outcome")
public class WkTblUsageOutcomeEntity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
