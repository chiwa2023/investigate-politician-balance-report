...
import mitei.mitei.investigate.report.balance.politician.service.renketsu_koufukin.SearchRenketsuOutcomeSuccessService;

/**
 * 交付金連結紐づけ成功結果取得Controller
 */
@Controller
@RequestMapping("/renketsu-koufukin")
public class SearchRenketsuOutcomeSuccessController extends AbstractTemplateCheckController {
    ...
    @PostMapping("/outcome-success")
    public ResponseEntity<RenketsuKoufukinWkTblDto> practice(@RequestBody final TemplatePagingCapsuleDto capsuleDto) {
        ...
        try {
             ...
             * ここに固有のビジネス処理を記載する
             */
            return ResponseEntity.ok(searchRenketsuOutcomeSuccessService.practice(capsuleDto));
