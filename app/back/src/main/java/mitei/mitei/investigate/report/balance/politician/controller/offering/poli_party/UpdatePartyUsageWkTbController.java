...
/**
 * 政党交付金使途報告書一括処理ワークテーブル変更
 */
@RestController
@RequestMapping("/update-party-usage-prepare")
public class UpdatePartyUsageWkTbController extends AbstractTemplateCheckController {
    ...
    @Autowired
    private UpdatePartyUsageWkTbControllerWorksBand worksBandController;
    ...
    public ResponseEntity<TemplateFrameworkResultDto> practice(
            final @RequestBody UpdatePartyUsageWkTblCapsuleDto capsuleDto)
