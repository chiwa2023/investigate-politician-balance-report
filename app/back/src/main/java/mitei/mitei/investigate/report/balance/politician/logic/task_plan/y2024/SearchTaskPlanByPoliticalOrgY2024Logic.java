 ...
 */
@Component
public class SearchTaskPlanByPoliticalOrgY2024Logic {
    ...
    public List<TaskPlanSelectOptionDto> practice(final List<Integer> listPoriOrg, final Integer userCode) {
        ...
        List<TaskPlan2024Entity> listEntity = taskPlan2024Repository
        ...
        for (TaskPlan2024Entity entity : listEntity) {
    ...
    private TaskPlanSelectOptionDto createDto(final TaskPlan2024Entity entity) {
