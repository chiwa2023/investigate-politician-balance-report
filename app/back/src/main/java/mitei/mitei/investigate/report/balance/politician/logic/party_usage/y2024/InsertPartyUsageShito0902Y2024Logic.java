 ...
 */
@Component
public class InsertPartyUsageShito0902Y2024Logic {
    ...
    public int practice(final Long documentCode,
        ...
        List<OfferingPartyUsage0902Report2024Entity> list = new ArrayList<>();

        // 初期同一識別コードを取得
        Long code = 0L;
        Optional<OfferingPartyUsage0902Report2024Entity> optional = offeringPartyUsage0902Report2024Repository
        ...
        // repositoryで保存
        return offeringPartyUsage0902Report2024Repository.saveAllAndFlush(list).size();
    }

    private OfferingPartyUsage0902Report2024Entity createEntity(final Long code, final Long documentCode,
        ...
        OfferingPartyUsage0902Report2024Entity entity = new OfferingPartyUsage0902Report2024Entity();
