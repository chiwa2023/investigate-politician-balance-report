...
public interface OfferingBalancesheetIncome2025Repository
     ...
     */
    @Query(value = "SELECT DISTINCT relation_person_code_income FROM offering_balancesheet_income_2025 WHERE political_organization_code=?1 AND youshiki_kbn=7 AND youshiki_eda_kbn=1 ", nativeQuery = true)
     ...
     * @return 取引相手関連者同一識別コードリスト
     */
    @Query(value = "SELECT DISTINCT relation_corp_code_income FROM offering_balancesheet_income_2025 WHERE political_organization_code=?1 AND youshiki_kbn=7 AND youshiki_eda_kbn=2 ", nativeQuery = true)
     ...
     * @return 取引相手関連者同一識別コードリスト
     */
    @Query(value = "SELECT DISTINCT relation_political_org_code_income FROM offering_balancesheet_income_2025 WHERE political_organization_code=?1 AND youshiki_kbn=7 AND youshiki_eda_kbn=3 ", nativeQuery = true)
     ...
     * @return 収入データリスト
     */
    List<OfferingBalancesheetIncome2025Entity> findByPoliticalOrganizationCodeInAndYoushikiKbnInAndSaishinKbn(List<Integer> listPoliOrgCode,List<Integer> listYoushikiKbn,Integer saishinKbn);
