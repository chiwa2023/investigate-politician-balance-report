...
public interface OfferingBalancesheetIncome2025Repository
     ...
     * @return 取引相手名称リスト
     */
    @Query(value = "SELECT DISTINCT partner_name FROM offering_balancesheet_income_2025 WHERE political_organization_code=?1 AND youshiki_kbn=7 AND youshiki_eda_kbn=?2 ", nativeQuery = true)
     ...
     */
    @Query(value = "SELECT DISTINCT relation_person_code_income FROM offering_balancesheet_income_2025 WHERE political_organization_code=?1 AND youshiki_kbn=?2 AND youshiki_eda_kbn=1 and saishin_kbn = 1", nativeQuery = true)
     ...
     * @return 取引相手関連者同一識別コードリスト
     */
    @Query(value = "SELECT DISTINCT relation_corp_code_income FROM offering_balancesheet_income_2025 WHERE political_organization_code=?1 AND youshiki_kbn=?2 AND youshiki_eda_kbn=2 and saishin_kbn = 1 ", nativeQuery = true)
     ...
     * @return 取引相手関連者同一識別コードリスト
     */
    @Query(value = "SELECT DISTINCT relation_political_org_code_income FROM offering_balancesheet_income_2025 WHERE political_organization_code=?1 AND youshiki_kbn=?2 AND youshiki_eda_kbn=3 and saishin_kbn = 1 ", nativeQuery = true)
     ...
     * @return 合計額リスト
     */
    @Query(value = "SELECT sum(kingaku) AS sum , partner_name AS partner_name , partner_juusho AS partner_juusho FROM offering_balancesheet_income_2025 WHERE partner_name IN (?1) AND dantai_kbn IN (?3) AND youshiki_kbn=7 AND youshiki_eda_kbn=?2 AND saishin_kbn=1 GROUP BY partner_name,partner_juusho", nativeQuery = true)
     ...
     * @return 検索結果
     */
    List<OfferingBalancesheetIncome2025Entity> findByPartnerNameInAndDantaiKbnInAndYoushikiEdaKbnAndSaishinKbnOrderByPartnerNameAscPartnerJuushoAsc(
     ...
     * @return 検索結果
     */
    List<OfferingBalancesheetIncome2025Entity> findByRelationPersonCodeIncomeInAndDantaiKbnInAndYoushikiEdaKbnAndSaishinKbnOrderByRelationPersonIdIncomeAsc(
     ...
     * @return 検索結果
     */
    List<OfferingBalancesheetIncome2025Entity> findByRelationCorpCodeIncomeInAndDantaiKbnInAndYoushikiEdaKbnAndSaishinKbnOrderByRelationCorpCodeIncomeAsc(
            List<Integer> listRelationCode, List<String> listDantaiKbn, Integer youshikiEdaKbn, Integer saishinKbn,
            Pageable pageable);
     ...
     * @return 検索結果
     */
    List<OfferingBalancesheetIncome2025Entity> findByRelationPoliticalOrgCodeIncomeInAndDantaiKbnInAndYoushikiEdaKbnAndSaishinKbnOrderByRelationPoliticalOrgCodeIncomeAsc(
            List<Integer> listRelationCode, List<String> listDantaiKbn, Integer youshikiEdaKbn, Integer saishinKbn,
            Pageable pageable);
     ...
     * @return 収入データリスト
     */
    List<OfferingBalancesheetIncome2025Entity> findByPoliticalOrganizationCodeInAndYoushikiKbnInAndSaishinKbn(
     ...
     * @return 収支報告書収入データ
     */
    @Query(value = "SELECT *,(?2) AS pickup_stage FROM offering_balancesheet_income_2025 WHERE political_organization_code IN ("
     ...
     * @return 総件数
     */
    @Query(value = "SELECT COUNT(*) FROM offering_balancesheet_income_2025 WHERE political_organization_code IN ("
            + " SELECT trading_partner_code FROM wk_tbl_ukai_kenkin"
            + " WHERE insert_user_code = ?1 AND  pickup_stage = (?2-1) "
            + " AND ((youshiki_eda_kbn = 3 AND youshiki_kbn = 7) OR youshiki_kbn = ?3)" + ")"
            + " AND (youshiki_kbn = 7 OR youshiki_kbn = ?3)", nativeQuery = true)
     ...
     * @return 件数
     */
    @Query(value = "SELECT count(distinct trading_partner_code)" + " FROM offering_balancesheet_income_2025" // NOPMD
     ...
     * @return 件数
     */
    @Query(value = "SELECT count(distinct partner_name,partner_juusho)" + " FROM offering_balancesheet_income_2025"
    ...
    @Query(value = "SELECT sum(kingaku) AS sum , trading_partner_code AS relation_code"
            + " FROM offering_balancesheet_income_2025"
            + " WHERE political_organization_code= ?1 AND youshiki_kbn = 11 AND trading_partner_code <> 0"
     ...
     * @return 検索結果
     */
    List<OfferingBalancesheetIncome2025Entity> findByPoliticalOrganizationCodeAndTradingPartnerCodeAndYoushikiKbnAndSaishinKbn(
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT COUNT(*) FROM offering_balancesheet_income_2025" // 改行調整
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM offering_balancesheet_income_2025" // 改行調整
            + "  WHERE trading_partner_Kbn = ?1 AND trading_partner_code = ?2"
            + "    AND ( (youshiki_kbn IN ?3 AND youshiki_eda_kbn IN ?4 ) OR"
            + "          (youshiki_kbn IN ?5 AND youshiki_eda_kbn IN ?6 ) OR"
            + "          (youshiki_kbn IN ?7 AND youshiki_eda_kbn IN ?8 ) ) AND saishin_kbn = 1 ", nativeQuery = true)
    List<OfferingBalancesheetIncome2025Entity> findDataByPartnerCode(Integer partnerKbn, Integer partnerCode,
            List<Integer> list1, List<Integer> list2, List<Integer> list3, List<Integer> list4, List<Integer> list5,
