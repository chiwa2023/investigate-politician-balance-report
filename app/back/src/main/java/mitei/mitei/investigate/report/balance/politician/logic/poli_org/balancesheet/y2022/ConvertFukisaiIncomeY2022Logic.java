 ...
 */
@Component
public class ConvertFukisaiIncomeY2022Logic {
    ...
    public List<WkTblFukisaiBalancesheetEntity> practice(final FukisaiSearchConditionDto conditionDto,
        ...
        if (conditionDto.getIsSearchCode()) {
            ...
            String dantaiName;
            Optional<OfferingBalancesheetIncome2022Entity> optional = offeringBalancesheetIncome2022Repository
            ...
            listIncome = offeringBalancesheetIncome2022Repository.findByPartnerNameIsNotAndSaishinKbnAndDantaiName(
        ...
        for (OfferingBalancesheetIncome2022Entity entity : listIncome) {
    ...
    private WkTblFukisaiBalancesheetEntity copyEntity(final OfferingBalancesheetIncome2022Entity entity,
