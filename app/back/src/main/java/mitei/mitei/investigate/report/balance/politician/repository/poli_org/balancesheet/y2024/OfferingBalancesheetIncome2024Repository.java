...
public interface OfferingBalancesheetIncome2024Repository
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM offering_balancesheet_income_2024 WHERE saishin_kbn= 1 AND accrual_date_value BETWEEN ?2 AND ?3 AND MATCH(search_words) AGAINST (?1 IN BOOLEAN MODE)", nativeQuery = true)
