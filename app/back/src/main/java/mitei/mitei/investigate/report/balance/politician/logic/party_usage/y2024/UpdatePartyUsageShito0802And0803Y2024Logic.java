 ...
 */
@Component
public class UpdatePartyUsageShito0802And0803Y2024Logic {
    ...
    public int practice(final Long oldCode, final CheckPrivilegeDto checkPrivilegeDto) {
        ...
        // 取得できた数を更新に値をセット
        for (OfferingPartyUsage0802And0803Report2024Entity entity : list) {
            SetTableDataHistoryUtil.practice(checkPrivilegeDto, entity, DataHistoryStatusConstants.UPDATE);
        }

        return offeringPartyUsage0802And0803Report2024Repository.saveAll(list).size();
    }
