 ...
 */
@Component
public class UpdatePartyUsageShito0802And0803Y2022Logic {
    ...
    public int practice(final Long oldCode, final CheckPrivilegeDto checkPrivilegeDto) {
        ...
        // 取得できた数を更新に値をセット
        for (OfferingPartyUsage0802And0803Report2022Entity entity : list) {
            SetTableDataHistoryUtil.practice(checkPrivilegeDto, entity, DataHistoryStatusConstants.UPDATE);
        }

        return offeringPartyUsage0802And0803Report2022Repository.saveAll(list).size();
    }
