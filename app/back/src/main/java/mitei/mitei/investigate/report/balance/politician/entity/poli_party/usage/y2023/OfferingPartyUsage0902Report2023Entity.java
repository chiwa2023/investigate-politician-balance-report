...
/**
 * offering_party_usage_0902_report_2023接続用Entity
 */
@Entity
@Table(name = "offering_party_usage_0902_report_2023")
public class OfferingPartyUsage0902Report2023Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD
    ...
    @Column(name = "party_usage_0902_report_id")
    private Long partyUsage0902ReportId = INIT_Long;

    /**
     * 使途報告書様式9その2Idを取得する
     *
     * @return 使途報告書様式9その2Id
     */
    public Long getPartyUsage0902ReportId() {
        return partyUsage0902ReportId;
    }

    /**
     * 使途報告書様式9その2Idを設定する
     *
     * @param partyUsage0902ReportId 使途報告書様式9その2Id
     */
    public void setPartyUsage0902ReportId(final Long partyUsage0902ReportId) {
        this.partyUsage0902ReportId = partyUsage0902ReportId;
    }

    /** 使途報告書様式9その2同一識別コード */
    @Column(name = "party_usage_0902_report_code")
    private Long partyUsage0902ReportCode = INIT_Long;

    /**
     * 使途報告書様式9その2同一識別コードを取得する
     *
     * @return 使途報告書様式9その2同一識別コード
     */
    public Long getPartyUsage0902ReportCode() {
        return partyUsage0902ReportCode;
    }

    /**
     * 使途報告書様式9その2同一識別コードを設定する
     *
     * @param partyUsage0902ReportCode 使途報告書様式9その2同一識別コード
     */
    public void setPartyUsage0902ReportCode(final Long partyUsage0902ReportCode) {
