 ...
 */
@Component
public class CheckKifuSouryouKiseiByNameY2024Logic {
    ...
    public List<SouryouKiseiRelationCodeDto> practice(final Integer poliOrgCode, final Integer youshikiEdaKbn,
        ...
        // 取引相手名称トごとの合計金額を算出する
        List<SouryouKiseiGenBunshoEntity> listEntity = offeringBalancesheetIncome2024Repository.calcSumByPartnerName(
                offeringBalancesheetIncome2024Repository.findPartnerNameByPoliOrg(poliOrgCode, youshikiEdaKbn),
