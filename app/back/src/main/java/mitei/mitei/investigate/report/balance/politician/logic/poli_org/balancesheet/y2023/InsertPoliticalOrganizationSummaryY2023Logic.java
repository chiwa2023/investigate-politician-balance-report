 ...
 */
@Component
public class InsertPoliticalOrganizationSummaryY2023Logic {
    ...
    public int practice(final Long documentCode,
        ...
        OfferingBalancesheet0702And0713And0717Summary2023Entity summaryEntity = new OfferingBalancesheet0702And0713And0717Summary2023Entity();
        ...
        // 同一識別コードの取得
        Long code = 1L;
        Optional<OfferingBalancesheet0702And0713And0717Summary2023Entity> optional = offeringBalancesheet0702And0713And0717Summary2023Repository
        ...
        Long idRecord = offeringBalancesheet0702And0713And0717Summary2023Repository.save(summaryEntity)
