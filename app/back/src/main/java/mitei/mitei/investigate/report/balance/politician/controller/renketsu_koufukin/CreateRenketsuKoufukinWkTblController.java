...
public class CreateRenketsuKoufukinWkTblController extends AbstractTemplateCheckController {
    ...
    public ResponseEntity<TemplateWithTaskPlanInfoResultDto> practice(
            @RequestBody final CreateRenketsuKoufukinCapsuleDto capsuleDto) {
        ...
        try {
            ...
            // 非同期でBatch起動
            createRenketsuKoufukinWkTblAyncService.practice(capsuleDto, taskName, code, year);
