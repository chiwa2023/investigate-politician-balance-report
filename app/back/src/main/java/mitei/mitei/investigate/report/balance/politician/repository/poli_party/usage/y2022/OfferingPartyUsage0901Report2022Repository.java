...
/**
 * offering_party_usage_0901_report_2022接続用Repository
 */
public interface OfferingPartyUsage0901Report2022Repository  extends JpaRepository<OfferingPartyUsage0901Report2022Entity, Integer>{
    ...
    Optional<OfferingPartyUsage0901Report2022Entity> findFirstByOrderByPartyUsage0901ReportCodeDesc();
     ...
     * @return データリスト(Id順)
     */
    List<OfferingPartyUsage0901Report2022Entity> findByDocumentCodeOrderByPartyUsage0901ReportId(Long documentCode);
