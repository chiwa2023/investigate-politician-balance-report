...
/**
 * 収支報告書の迂回献金の政治団体データを取得する(2022)
 */
@Component
public class PoliOrgUkaiKenkinDetailY2022Logic {

    /** 収支報告書収入Repository(2022) */
    @Autowired
    ...
    public Integer practiceCount(final int userCode, final int stage, final Integer koufukinKbn) {
        ...
        return offeringBalancesheetIncome2022Repository.findUkaiKenkiMeisaiCount(userCode, stage, koufukinKbn);
    }
    ...
    public List<OfferingBalancesheetIncomeEntity> practice(final int userCode, final int stage,
        ...
        return offeringBalancesheetIncome2022Repository.findUkaiKenkiMeisai(userCode, stage, koufukinKbn, pageable)
                .toList();
    }
