 ...
 */
@Component
public class InsertPartyUsageShito0902Y2022Logic {
    ...
    public int practice(final Long documentCode,
        ...
        List<OfferingPartyUsage0902Report2022Entity> list = new ArrayList<>();

        // 初期同一識別コードを取得
        Long code = 0L;
        Optional<OfferingPartyUsage0902Report2022Entity> optional = offeringPartyUsage0902Report2022Repository
        ...
        // repositoryで保存
        return offeringPartyUsage0902Report2022Repository.saveAllAndFlush(list).size();
    }

    private OfferingPartyUsage0902Report2022Entity createEntity(final Long code, final Long documentCode,
        ...
        OfferingPartyUsage0902Report2022Entity entity = new OfferingPartyUsage0902Report2022Entity();
