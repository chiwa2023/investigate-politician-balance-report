 ...
 */
@Component
public class ConvertUkaiKenkinIncomeByCodeY2025Logic {
    ...
    public List<WkTblUkaiKenkinEntity> practice(final List<Integer> listPoliOrgCode,
        ...
        List<OfferingBalancesheetIncome2025Entity> listByPoliOrg = offeringBalancesheetIncome2025Repository
        ...
        for (OfferingBalancesheetIncome2025Entity entityIncome : listByPoliOrg) {
            list.add(
    ...
    private WkTblUkaiKenkinEntity convertEntity(final OfferingBalancesheetIncome2025Entity entityIncome,
    ...
    private void setKanrenSha(final WkTblUkaiKenkinEntity entity,
            final OfferingBalancesheetIncome2025Entity entityIncome) {
