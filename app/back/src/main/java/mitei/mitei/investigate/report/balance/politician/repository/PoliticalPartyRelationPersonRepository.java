 ...
 */
@Component
public interface PoliticalPartyRelationPersonRepository  extends JpaRepository<PoliticalPartyRelationPersonEntity, Long>{
    ...
    List<PoliticalPartyRelationPersonEntity> findByPoliticalPartyCodeAndSaishinKbn(int poliPtyCode,Integer saishinKbn,Pageable pageable);
