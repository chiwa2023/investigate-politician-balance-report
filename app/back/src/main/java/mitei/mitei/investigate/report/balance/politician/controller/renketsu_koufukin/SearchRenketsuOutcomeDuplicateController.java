...
import mitei.mitei.investigate.report.balance.politician.service.renketsu_koufukin.SearchRenketsuOutcomeDuplicateService;

/**
 * 支出交付金連結重複取得Controller
 */
@Controller
@RequestMapping("/renketsu-koufukin")
public class SearchRenketsuOutcomeDuplicateController extends AbstractTemplateCheckController {
    ...
    @PostMapping("/outcome-duplicate")
    public ResponseEntity<RenketsuKoufukinWkTblDto> practice(
        ...
        try {
            ...
            return ResponseEntity.ok(searchRenketsuOutcomeDuplicateService.practice(capsuleDto));
