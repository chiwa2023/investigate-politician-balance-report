 ...
 */
@Component
public class InsertPartyUsageShito0804Y2022Logic {
    ...
    public int practice(final boolean isSearchRelation, final Long documentCode,
        ...
        // すべてにク共通のEntityを作成
        OfferingPartyUsage0804Report2022Entity entityBase = new OfferingPartyUsage0804Report2022Entity();
        ...
        /* 区分1から12を順に処理 */
        List<OfferingPartyUsage0804Report2022Entity> list = new ArrayList<>();
        ...
        // 行ごとに同一識別コードを振番する
        Long code = 0L;
        Optional<OfferingPartyUsage0804Report2022Entity> optional = offeringPartyUsage0804Report2022Repository
                .findFirstByOrderByPartyUsage0804ReportCodeDesc();
        if (!optional.isEmpty()) {
            code = optional.get().getPartyUsage0804ReportCode();
        }
        for (OfferingPartyUsage0804Report2022Entity entity : list) {
            code++;
            entity.setPartyUsage0804ReportCode(code);
        }

        // repositoryで保存
        return offeringPartyUsage0804Report2022Repository.saveAll(list).size();
    }

    private List<OfferingPartyUsage0804Report2022Entity> createEntityInSheet(final int kbn, final String kbnName,
            final OfferingPartyUsage0804Report2022Entity entityBase, final List<Sheet0804Dto> listSheet,
            final boolean isSearchRelation) {

        // 明細が0であっても必ずシートが1枚はは入っている
        OfferingPartyUsage0804Report2022Entity entityReport = new OfferingPartyUsage0804Report2022Entity();
    ...
    private List<OfferingPartyUsage0804Report2022Entity> createEntityInRow(
            final OfferingPartyUsage0804Report2022Entity entityBase, final List<RowShitoCoreDto> listRow,
            final boolean isSearchRelation) {
    ...
    private OfferingPartyUsage0804Report2022Entity createEntity(final OfferingPartyUsage0804Report2022Entity entityBase,
            final RowShitoCoreDto rowDto, final boolean isSearchRelation) {

        OfferingPartyUsage0804Report2022Entity entity = new OfferingPartyUsage0804Report2022Entity();
