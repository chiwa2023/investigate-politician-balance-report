 ...
 */
@Component
public class DeleteFinancialTenpoWkTbl3ItemReader extends RepositoryItemReader<ZenginOrgBranchMasterEntity> {
     ...
     */
    public DeleteFinancialTenpoWkTbl3ItemReader(
        ...
        super.setMethodName("findDelteBranchWkTbl3");
