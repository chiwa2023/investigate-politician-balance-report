...
import mitei.mitei.investigate.report.balance.politician.service.membership_fee.CalcSumMembershipFeeInsuService;
...
public class CalcSumMembershipFeeInsuController extends AbstractTemplateCheckController {
    ...
    public ResponseEntity<FeeSummaryResultDto> practice(@RequestBody final CalcMebershipFeeInsuCapsuleDto capsuleDto) {
        ...
        try {
            ...
            return ResponseEntity.ok(calcSumMembershipFeeInsuService.practice(capsuleDto.getPoliticalPartyCode()));
