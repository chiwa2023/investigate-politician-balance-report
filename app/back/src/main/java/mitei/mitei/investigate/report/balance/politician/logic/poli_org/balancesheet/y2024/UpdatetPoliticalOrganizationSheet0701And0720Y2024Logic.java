 ...
 */
@Component
public class UpdatetPoliticalOrganizationSheet0701And0720Y2024Logic {
    ...
    public int practice(final Long oldCode, final CheckPrivilegeDto checkPrivilegeDto) {
        ...
        // 取得できた数を更新に値をセット
        for (OfferingBalancesheet0701And0720Surface2024Entity entity : list) {
            SetTableDataHistoryUtil.practice(checkPrivilegeDto, entity, DataHistoryStatusConstants.UPDATE);
        }

        return offeringBalancesheet0701And0720Surface2024Repository.saveAll(list).size();
    }
