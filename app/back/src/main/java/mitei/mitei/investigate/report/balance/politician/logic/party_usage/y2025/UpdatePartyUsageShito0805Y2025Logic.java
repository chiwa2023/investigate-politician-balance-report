 ...
 */
@Component
public class UpdatePartyUsageShito0805Y2025Logic {
    ...
    public int practice(final Long oldCode, final CheckPrivilegeDto checkPrivilegeDto) {
        ...
        // 取得できた数を更新に値をセット
        for (OfferingPartyUsage0805Report2025Entity entity : list) {
            SetTableDataHistoryUtil.practice(checkPrivilegeDto, entity, DataHistoryStatusConstants.UPDATE);
        }

        return offeringPartyUsage0805Report2025Repository.saveAll(list).size();
    }
