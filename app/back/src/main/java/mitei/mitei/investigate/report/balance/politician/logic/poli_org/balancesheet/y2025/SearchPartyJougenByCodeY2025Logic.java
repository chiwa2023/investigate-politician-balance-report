 ...
 */
@Component
public class SearchPartyJougenByCodeY2025Logic {
    ...
    public SearchKifuJougenMeisaiBalancesheetResultDto practice(final KifuJougenConditionCapsuleDto capsuleDto) {
        ...
        if (capsuleDto.getAllCount().equals(0)) {
            Integer allCount = offeringBalancesheetIncome2025Repository.findCountTradingPartnerParty(poliOrgCode);
        ...
        List<PartyJougenByCodeEntity> listSum = offeringBalancesheetIncome2025Repository
