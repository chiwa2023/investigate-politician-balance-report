...
/**
 * send_alert_mail_2025接続用Entity
 */
@Entity
@Table(name = "send_alert_mail_2025")
public class SendAlertMail2025Entity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
