...
public interface OfferingPartyUsage0801And0807Report2024Repository
    ...
    // * @return 検索結果
    // */
    // @Query(value = "SELECT * FROM offering_party_usage_0801_and_0807_report_2024
    // WHERE saishin_kbn= 1 AND
    // MATCH(offering_party_usage_0801_and_0807_report_2024_name) AGAINST (?1 IN
    // NATURAL LANGUAGE MODE)", nativeQuery = true)
    // List<OfferingPartyUsage0801And0807Report2024Entity> findFullText(String
    // searchWords);
