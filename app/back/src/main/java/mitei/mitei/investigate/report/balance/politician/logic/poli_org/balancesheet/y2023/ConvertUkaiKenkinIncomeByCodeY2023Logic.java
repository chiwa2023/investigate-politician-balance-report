 ...
 */
@Component
public class ConvertUkaiKenkinIncomeByCodeY2023Logic {
    ...
    public List<WkTblUkaiKenkinEntity> practice(final List<Integer> listPoliOrgCode,
        ...
        List<OfferingBalancesheetIncome2023Entity> listByPoliOrg = offeringBalancesheetIncome2023Repository
        ...
        for (OfferingBalancesheetIncome2023Entity entityIncome : listByPoliOrg) {
            list.add(
    ...
    private WkTblUkaiKenkinEntity convertEntity(final OfferingBalancesheetIncome2023Entity entityIncome,
    ...
    private void setKanrenSha(final WkTblUkaiKenkinEntity entity,
            final OfferingBalancesheetIncome2023Entity entityIncome) {
