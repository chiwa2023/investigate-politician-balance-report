 ...
 */
@Component
public class CheckKifuKobetsuJogenByRelationCodeY2022Logic {
    ...
    public SearchKifuJougenMeisaiBalancesheetResultDto practice(final Integer poliOrgCode, final Integer seachKifuKbn ,final Integer youshikiEdaKbn,
        ...
        List<OfferingBalancesheetIncome2022Entity> listOrgMeisai = this.getSearchResult(poliOrgCode, youshikiEdaKbn,
                listOther, pageable);
    ...
    // 様式枝区分ことにリストを取得する
    private List<OfferingBalancesheetIncome2022Entity> getSearchResult(final Integer poliOrgCode,
        ...
        switch (youshikiEdaKbn) {
            case YoushikiEdaKbn.KOJIN:
                List<Integer> listPerson = offeringBalancesheetIncome2022Repository
                        .findRelationPersonByPoliOrg(poliOrgCode);
                return offeringBalancesheetIncome2022Repository
            ...
            case YoushikiEdaKbn.KIGYOU_DANTAI:
                List<Integer> listCorp = offeringBalancesheetIncome2022Repository
            ...
            case YoushikiEdaKbn.SEIJI_DANTAI:
                ...
                List<Integer> listOrg = offeringBalancesheetIncome2022Repository
    ...
    // 関連Idを取得する
    private Long getRelationId(final OfferingBalancesheetIncome2022Entity entity) {
    ...
    // 関連Codeを取得する
    private Integer getRelationCode(final OfferingBalancesheetIncome2022Entity entity) {
