 ...
 */
@Component
public class CheckKifuSouryouKiseiByPersonCodeY2025Logic {
    ...
    public List<SouryouKiseiRelationCodeDto> practice(final Integer poliOrgCode, final List<String> listDantaiKbn) {
        ...
        List<SouryouKiseiByCodeEntity> listSum = offeringBalancesheetIncome2025Repository.calcSumByRelationPerson(
                offeringBalancesheetIncome2025Repository.findRelationPersonByPoliOrg(poliOrgCode,YoushikiKbn.DONATE), listDantaiKbn);
