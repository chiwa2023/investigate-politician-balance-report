...
import mitei.mitei.investigate.report.balance.politician.service.offering.poli_org.UpdateBalancesheetPlanService;

/**
 * 政治資金収支報告書一括処理予定更新Controller
 */
@RestController
@RequestMapping("/update-balancesheet-prepare")
public class UpdateBalancesheetPlanController extends AbstractTemplateCheckController {
    ...
    public ResponseEntity<TemplateFrameworkResultDto> practice(
            final @RequestBody UpdateBalancesheetTaskPlanCapsuleDto capsuleDto)
        ...
        try {
             ...
             * ここに固有のビジネス処理を記載する
             */
            Long newId = updateBalancesheetPlanService.practice(capsuleDto.getTaskPlanBalancesheetDetailEntity(),
