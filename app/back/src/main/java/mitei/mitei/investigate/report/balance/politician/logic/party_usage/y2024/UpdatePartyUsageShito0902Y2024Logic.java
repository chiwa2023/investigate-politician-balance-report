 ...
 */
@Component
public class UpdatePartyUsageShito0902Y2024Logic {
    ...
    public int practice(final Long oldCode, final CheckPrivilegeDto checkPrivilegeDto) {
        ...
        List<OfferingPartyUsage0902Report2024Entity> list = offeringPartyUsage0902Report2024Repository
                .findByDocumentCodeOrderByPartyUsage0902ReportId(oldCode);

        // 取得できた数を更新に値をセット
        for (OfferingPartyUsage0902Report2024Entity entity : list) {
            SetTableDataHistoryUtil.practice(checkPrivilegeDto, entity, DataHistoryStatusConstants.UPDATE);
        }

        return offeringPartyUsage0902Report2024Repository.saveAll(list).size();
    }
