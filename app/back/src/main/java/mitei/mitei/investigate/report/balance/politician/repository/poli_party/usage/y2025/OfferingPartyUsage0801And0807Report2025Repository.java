 ...
 */
public interface OfferingPartyUsage0801And0807Report2025Repository
        extends JpaRepository<OfferingPartyUsage0801And0807Report2025Entity, Integer> {
    ...
    // * @return 検索結果
    // */
    // @Query(value = "SELECT * FROM offering_party_usage_0801_and_0807_report_2025
    // WHERE saishin_kbn= 1 AND
    // MATCH(offering_party_usage_0801_and_0807_report_2025_name) AGAINST (?1 IN
    // NATURAL LANGUAGE MODE)", nativeQuery = true)
    // List<OfferingPartyUsage0801And0807Report2025Entity> findFullText(String
    // searchWords);
     ...
     * @return データリスト
     */
    List<OfferingPartyUsage0801And0807Report2025Entity> findByPartyUsage0801And0807ReportCodeOrderByPartyUsage0801And0807ReportId(
     ...
     * @return データリスト
     */
    List<OfferingPartyUsage0801And0807Report2025Entity> findBySaishinKbnAndPoliticalOrganizationCodeAndOfferingDate(
    ...
    @Query(value = "SELECT offering_date,MAX(offering_balancesheet_0701_and_0720_surface_code) AS document_code"
            + "  FROM offering_balancesheet_0701_and_0720_surface_2025" + "    WHERE political_organization_code = ?1"
     ...
     * @return 検索結果
     */
    Optional<OfferingPartyUsage0801And0807Report2025Entity> findFirstByPoliticalOrganizationCodeAndSaishinKbnOrderByOfferingDateDesc(
