 ...
 */
@Component
public class InsertPoliticalOrganizationSheet0701And0720Y2022Logic {
    ...
    public Long practice(final BalancesheetReportDocumentPoliticalPropertyDto documentPropertyDto,
        ...
        OfferingBalancesheet0701And0720Surface2022Entity balancesheetEntity = new OfferingBalancesheet0701And0720Surface2022Entity();
        // ヘッダ
        ...
        //同一識別コードの設定
        Long code = 1L;
        Optional<OfferingBalancesheet0701And0720Surface2022Entity> optional = offeringBalancesheet0701And0720Surface2022Repository.findFirstByOrderByOfferingBalancesheet0701And0720SurfaceCodeDesc();
        if(!optional.isEmpty()) {
        ...
        offeringBalancesheet0701And0720Surface2022Repository.save(balancesheetEntity);
