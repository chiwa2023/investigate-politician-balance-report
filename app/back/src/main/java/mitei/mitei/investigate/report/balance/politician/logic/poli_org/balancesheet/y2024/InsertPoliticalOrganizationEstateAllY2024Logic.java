...
/**
 * 政治資金収支報告書の資産明細を登録する
 * 悲観テーブルロックの時間をできうる限り短くするため、単純ロジックを数多く繰り返しているだけで複雑度が上がっていることを加味して、
 * すべての資産データ登録をこのLogicに集めた
 */
@Component
public class InsertPoliticalOrganizationEstateAllY2024Logic {
    ...
    public int practice(final Long documentCode, // SUPPRESS CHECKSTYLE NOPMD
        ...
        List<OfferingBalancesheet0718Estate2024Entity> listAsset = new ArrayList<>();
        ...
        // 同一識別コードの設定
        Long codeAsset = 0L;
        Optional<OfferingBalancesheet0718Estate2024Entity> optionalAsset = offeringBalancesheet0718Estate2024Repository
        ...
        for (OfferingBalancesheet0718Estate2024Entity entity : listAsset) {
            codeAsset++;
            entity.setOfferingBalancesheet0718EstateCode(codeAsset);
        }

        final int sizeAsset = offeringBalancesheet0718Estate2024Repository.saveAll(listAsset).size();

        // シート19-1,2,3を登録する
        List<OfferingBalancesheet0719RealEstate2024Entity> listRealEstate = new ArrayList<>();
        Integer kbnEstate;
        ...
        Optional<OfferingBalancesheet0719RealEstate2024Entity> optionalRealEstate = offeringBalancesheet0719RealEstate2024Repository
    ...
    private OfferingBalancesheet0718Estate2024Entity createAssetEntity(final Long documentCode,
            final BalancesheetReportDocumentPoliticalPropertyDto documentPropertyDto,
            final Row071800ClassificationOfAssetsByItemDto rowDto, final CheckPrivilegeDto checkPrivilegeDto) {

        OfferingBalancesheet0718Estate2024Entity balancesheetEntity = new OfferingBalancesheet0718Estate2024Entity();
    ...
    private OfferingBalancesheet0719RealEstate2024Entity createRealEstateEntity(final Long documentCode,
            final BalancesheetReportDocumentPoliticalPropertyDto documentPropertyDto,
            final Row071900CurrentStatusOfRealEstateUseDto rowDto, final Integer kbn,
            final CheckPrivilegeDto checkPrivilegeDto) {

        OfferingBalancesheet0719RealEstate2024Entity balancesheetEntity = new OfferingBalancesheet0719RealEstate2024Entity();
