...
/**
 * 使途報告書支出データをワークテーブルに複写するデータを抽出する(2025)
 */
@Component
public class CopyUsageWkTbOutncomeY2025Logic {
    ...
    public Integer practiceSize(final Long documentCode){
        return offeringPartyUsage0804Report2025Repository.findByDocumentRow(documentCode);
    }
    ...
    public List<WkTblUsageOutcomeEntity> practice(final Long documentCode, final Integer pageNumber,
        ...
        List<OfferingPartyUsage0804Report2025Entity> listSrc = offeringPartyUsage0804Report2025Repository
                .findByDocumentCodeOrderByPartyUsage0804ReportId(documentCode, pageable);

        List<WkTblUsageOutcomeEntity> list = new ArrayList<>();
        for (OfferingPartyUsage0804Report2025Entity entitySrc : listSrc) {
     ...
     */
    private WkTblUsageOutcomeEntity createEntity(final OfferingPartyUsage0804Report2025Entity entitySrc,
