 ...
 */
@Component
public class InsertPoliticalOrganizationEstateAllY2023Logic {
    ...
    public int practice(final Long documentCode, // SUPPRESS CHECKSTYLE NOPMD
        ...
        List<OfferingBalancesheet0718Estate2023Entity> listAsset = new ArrayList<>();
        ...
        // 同一識別コードの設定
        Long codeAsset = 0L;
        Optional<OfferingBalancesheet0718Estate2023Entity> optionalAsset = offeringBalancesheet0718Estate2023Repository
        ...
        for (OfferingBalancesheet0718Estate2023Entity entity : listAsset) {
            codeAsset++;
            entity.setOfferingBalancesheet0718EstateCode(codeAsset);
        }

        final int sizeAsset = offeringBalancesheet0718Estate2023Repository.saveAll(listAsset).size();

        // シート19-1,2,3を登録する
        List<OfferingBalancesheet0719RealEstate2023Entity> listRealEstate = new ArrayList<>();
        Integer kbnEstate;
        ...
        Optional<OfferingBalancesheet0719RealEstate2023Entity> optionalRealEstate = offeringBalancesheet0719RealEstate2023Repository
    ...
    private OfferingBalancesheet0718Estate2023Entity createAssetEntity(final Long documentCode,
            final BalancesheetReportDocumentPoliticalPropertyDto documentPropertyDto,
            final Row071800ClassificationOfAssetsByItemDto rowDto, final CheckPrivilegeDto checkPrivilegeDto) {

        OfferingBalancesheet0718Estate2023Entity balancesheetEntity = new OfferingBalancesheet0718Estate2023Entity();
    ...
    private OfferingBalancesheet0719RealEstate2023Entity createRealEstateEntity(final Long documentCode,
            final BalancesheetReportDocumentPoliticalPropertyDto documentPropertyDto,
            final Row071900CurrentStatusOfRealEstateUseDto rowDto, final Integer kbn,
            final CheckPrivilegeDto checkPrivilegeDto) {

        OfferingBalancesheet0719RealEstate2023Entity balancesheetEntity = new OfferingBalancesheet0719RealEstate2023Entity();
