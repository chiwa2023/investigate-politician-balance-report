...
import mitei.mitei.investigate.report.balance.politician.batch.year_reflesh.tasklet.RefleshYearDataAccessDdlasklet;
...
public class RefleshYearDataAccessObjectAndLogicBatchConfiguration {
    ...
    protected Step getStep(final JobRepository jobRepository, final PlatformTransactionManager transactionManager) {
        ...
        return new StepBuilder(STEP_NAME, jobRepository)
                ...
                .tasklet(refleshYearDataAccessDdlasklet, transactionManager) // DDL
