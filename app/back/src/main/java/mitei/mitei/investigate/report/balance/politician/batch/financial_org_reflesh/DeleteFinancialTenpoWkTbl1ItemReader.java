 ...
 */
@Component
public class DeleteFinancialTenpoWkTbl1ItemReader extends RepositoryItemReader<ZenginOrgBranchMasterEntity> {
     ...
     */
    public DeleteFinancialTenpoWkTbl1ItemReader(
        ...
        super.setMethodName("findDelteBranchWkTbl1");
