...
public interface OfferingBalancesheetOutcome2022Repository  extends JpaRepository<OfferingBalancesheetOutcome2022Entity, Integer>{
     ...
     * @return 検索結果
     */
    @Query(value = "SELECT * FROM offering_balancesheet_outcome_2022 WHERE saishin_kbn= 1 AND accrual_date_value BETWEEN ?3 AND ?4 AND MATCH(search_words) AGAINST (?1 IN BOOLEAN MODE) LIMIT ?2,100", nativeQuery = true)
