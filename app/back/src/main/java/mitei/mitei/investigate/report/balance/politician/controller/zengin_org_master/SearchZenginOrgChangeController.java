...
import mitei.mitei.investigate.report.balance.politician.service.zengin_org.SearchZenginOrgChangeService;

/**
 * 金融機関支店再テーブル検索Controller
 */
@RequestMapping("/zengin-org-change")
@Controller
public class SearchZenginOrgChangeController extends AbstractTemplateCheckController {
     ...
     */
    @PostMapping("/search")
    public ResponseEntity<List<ZenginOrgChangeBranchEntity>> practice(
            final @RequestBody SearchZenginChangeConditionCapsuleDto capsuleDto)
        ...
        try {
            ...
            return ResponseEntity.ok(searchZenginOrgChangeService.practice(capsuleDto));
