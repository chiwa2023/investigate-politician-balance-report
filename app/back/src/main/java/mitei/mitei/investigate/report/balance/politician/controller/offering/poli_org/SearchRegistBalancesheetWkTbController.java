...
import mitei.mitei.investigate.report.balance.politician.service.offering.poli_org.SearchRegistBalancesheetWkTbService;

/**
 * 政治資金収支報告書一括処理ワークテーブル政治団体指定データ検索処理
 */
@RestController
@RequestMapping("/listup-balancesheet-poli-org")
public class SearchRegistBalancesheetWkTbController extends AbstractTemplateCheckController {
    ...
    @Autowired
    private SearchRegistBalancesheetWkTbService searchRegistBalancesheetWkTbService;

    /**
     * 正常登録された政治資金収支報告書一括処理ワークテーブルリストを検索する
     *
    ...
    @PostMapping("/normal")
    public ResponseEntity<List<WkTblPoliOrgBalancesheetReportEntity>> practice(
        ...
        try {
            ...
            return ResponseEntity.ok(searchRegistBalancesheetWkTbService.practice());
