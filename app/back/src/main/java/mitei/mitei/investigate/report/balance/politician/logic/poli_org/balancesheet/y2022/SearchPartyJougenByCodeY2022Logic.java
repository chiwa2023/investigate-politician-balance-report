 ...
 */
@Component
public class SearchPartyJougenByCodeY2022Logic {
    ...
    public SearchKifuJougenMeisaiBalancesheetResultDto practice(final KifuJougenConditionCapsuleDto capsuleDto) {
        ...
        if (capsuleDto.getAllCount().equals(0)) {
            Integer allCount = offeringBalancesheetIncome2022Repository.findCountTradingPartnerParty(poliOrgCode);
        ...
        List<PartyJougenByCodeEntity> listSum = offeringBalancesheetIncome2022Repository
