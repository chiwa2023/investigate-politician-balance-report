...
/**
 * save_file_storage_2022接続用Entity
 */
@Entity
@Table(name = "save_file_storage_2022")
public class SaveFileStorage2022Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
