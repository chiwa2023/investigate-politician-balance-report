...
/**
 * task_plan_balancesheet_detail接続用Entity
 */
@Entity
@Table(name = "task_plan_balancesheet_detail")
public class TaskPlanBalancesheetDetailEntity implements Serializable, AllTabeDataHistoryInterface { // NOPMD DataClass
    ...
    @Column(name = "task_plan_balancesheet_detail_id")
    ...
    @Column(name = "task_plan_balancesheet_detail_code")
