...
import mitei.mitei.investigate.report.balance.politician.logic.party_usage.y2023.InsertPartyUsageShito0802Kbn02Y2023Logic;
// importを追加
        ...
        switch (documentPropertyDto.getNendo()) {
            ...
            case YEAR_2022:
                size = insertPartyUsageShito0802Kbn02Y2022Logic.practice(documentCode, documentPropertyDto,
                        kbn080202Dto, checkPrivilegeDto); // 2022
                break; // 2022
            ...
            // 2023年
            case YEAR_2023:
                size = insertPartyUsageShito0802Kbn02Y2023Logic.practice(documentCode, documentPropertyDto,
                        kbn080202Dto, checkPrivilegeDto);
                break;
