 ...
 */
@Component
public class CheckKifuSouryouKiseiByNameY2023Logic {
    ...
    public List<SouryouKiseiRelationCodeDto> practice(final Integer poliOrgCode, final Integer youshikiEdaKbn,
        ...
        // 取引相手名称トごとの合計金額を算出する
        List<SouryouKiseiGenBunshoEntity> listEntity = offeringBalancesheetIncome2023Repository.calcSumByPartnerName(
                offeringBalancesheetIncome2023Repository.findPartnerNameByPoliOrg(poliOrgCode, youshikiEdaKbn),
