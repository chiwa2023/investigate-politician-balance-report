 ...
 */
@Component
public class ConvertFukisaiIncomeY2025Logic {
    ...
    public List<WkTblFukisaiBalancesheetEntity> practice(final FukisaiSearchConditionDto conditionDto,
        ...
        if (conditionDto.getIsSearchCode()) {
            ...
            String dantaiName;
            Optional<OfferingBalancesheetIncome2025Entity> optional = offeringBalancesheetIncome2025Repository
            ...
            listIncome = offeringBalancesheetIncome2025Repository.findByPartnerNameIsNotAndSaishinKbnAndDantaiName(
        ...
        for (OfferingBalancesheetIncome2025Entity entity : listIncome) {
    ...
    private WkTblFukisaiBalancesheetEntity copyEntity(final OfferingBalancesheetIncome2025Entity entity,
