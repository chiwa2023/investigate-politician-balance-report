 ...
 */
@Component
public class ConvertFukisaiIncomeY2024Logic {
    ...
    public List<WkTblFukisaiBalancesheetEntity> practice(final FukisaiSearchConditionDto conditionDto,
        ...
        if (conditionDto.getIsSearchCode()) {
            ...
            String dantaiName;
            Optional<OfferingBalancesheetIncome2024Entity> optional = offeringBalancesheetIncome2024Repository
            ...
            listIncome = offeringBalancesheetIncome2024Repository.findByPartnerNameIsNotAndSaishinKbnAndDantaiName(
        ...
        for (OfferingBalancesheetIncome2024Entity entity : listIncome) {
    ...
    private WkTblFukisaiBalancesheetEntity copyEntity(final OfferingBalancesheetIncome2024Entity entity,
