 ...
 */
@Component
public class SearchPartyJougenByGenbunshoNameY2022Logic {
    ...
    public SearchKifuJougenMeisaiBalancesheetResultDto practice(final KifuJougenConditionCapsuleDto capsuleDto) {
        ...
        if (capsuleDto.getAllCount().equals(0)) {
            Integer allCount = offeringBalancesheetIncome2022Repository.findCountTradingPartnerPartyByName(poliOrgCode);
        ...
        List<SouryouKiseiGenBunshoEntity> listSum = offeringBalancesheetIncome2022Repository
        ...
        for (SouryouKiseiGenBunshoEntity entity : listSum) {
            ...
            // 各関連者に紐づく入金明細を取得
            List<OfferingBalancesheetIncome2022Entity> listMeisaiOffering = offeringBalancesheetIncome2022Repository
    ...
    private KifuJougenTradingInfoDto createDto(final SouryouKiseiGenBunshoEntity entity,
            final List<OfferingBalancesheetIncome2022Entity> listMeisaiOffering) {
        ...
        // 代表として1件目を表示
        OfferingBalancesheetIncome2022Entity entityIncomeFirst = listMeisaiOffering.get(0);
        ...
        for (OfferingBalancesheetIncome2022Entity entityIncome : listMeisaiOffering) {
