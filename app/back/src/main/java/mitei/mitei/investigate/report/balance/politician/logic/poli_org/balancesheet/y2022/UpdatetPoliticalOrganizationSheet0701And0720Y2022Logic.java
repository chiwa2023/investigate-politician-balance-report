 ...
 */
@Component
public class UpdatetPoliticalOrganizationSheet0701And0720Y2022Logic {
    ...
    public int practice(final Long oldCode, final CheckPrivilegeDto checkPrivilegeDto) {
        ...
        List<OfferingBalancesheet0701And0720Surface2022Entity> list = offeringBalancesheet0701And0720Surface2022Repository
                .findByOfferingBalancesheet0701And0720SurfaceCodeOrderByOfferingBalancesheet0701And0720SurfaceId(
                        oldCode);

        // 取得できた数を更新に値をセット
        for (OfferingBalancesheet0701And0720Surface2022Entity entity : list) {
            SetTableDataHistoryUtil.practice(checkPrivilegeDto, entity, DataHistoryStatusConstants.UPDATE);
        }

        return offeringBalancesheet0701And0720Surface2022Repository.saveAll(list).size();
    }
