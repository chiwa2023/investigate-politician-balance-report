...
public interface OfferingPartyUsage0901Report2023Repository  extends JpaRepository<OfferingPartyUsage0901Report2023Entity, Integer>{
    ...
    // * @return 検索結果
    // */
    // @Query(value = "SELECT * FROM offering_party_usage_0901_report_2023 WHERE
    // saishin_kbn= 1 AND MATCH(offering_party_usage_0901_report_2023_name) AGAINST
    // (?1 IN NATURAL LANGUAGE MODE)", nativeQuery = true)
    // List<OfferingPartyUsage0901Report2023Entity> findFullText(String
    // searchWords);
