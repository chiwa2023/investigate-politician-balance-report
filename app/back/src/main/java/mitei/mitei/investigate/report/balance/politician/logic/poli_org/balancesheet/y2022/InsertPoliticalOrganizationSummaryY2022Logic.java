 ...
 */
@Component
public class InsertPoliticalOrganizationSummaryY2022Logic {
    ...
    public int practice(final Long documentCode,
        ...
        OfferingBalancesheet0702And0713And0717Summary2022Entity summaryEntity = new OfferingBalancesheet0702And0713And0717Summary2022Entity();
        ...
        // 同一識別コードの取得
        Long code = 1L;
        Optional<OfferingBalancesheet0702And0713And0717Summary2022Entity> optional = offeringBalancesheet0702And0713And0717Summary2022Repository
        ...
        Long idRecord = offeringBalancesheet0702And0713And0717Summary2022Repository.save(summaryEntity)
