...
import mitei.mitei.investigate.report.balance.politician.service.offering.poli_org.SearchRegistBalancesheetWkTbErrorService;

/**
 * 政治資金収支報告書一括処理ワークテーブル政治団体未指定データ検索処理
 */
@RestController
@RequestMapping("/listup-balancesheet-poli-org")
public class SearchRegistBalancesheetWkTbErrorController extends AbstractTemplateCheckController {
    ...
    public ResponseEntity<List<WkTblPoliOrgBalancesheetReportEntity>> practice(
        ...
        try {
            ...
            return ResponseEntity.ok(searchRegistBalancesheetWkTbErrorService.practice());
