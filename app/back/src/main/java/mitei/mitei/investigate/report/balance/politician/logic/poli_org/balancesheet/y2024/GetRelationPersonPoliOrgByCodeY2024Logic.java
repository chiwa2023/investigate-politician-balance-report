...
/**
 * 対象の政治団体に属する関連者すべてを抽出する(2024年)
 */
@Component
public class GetRelationPersonPoliOrgByCodeY2024Logic {
    ...
    public PoliticalOrganizationPropertyEntity practice(final Integer poliOrgCode) {
        ...
        Optional<OfferingBalancesheet0701And0720Surface2024Entity> optionalSurface = offeringBalancesheet0701And0720Surface2024Repository
