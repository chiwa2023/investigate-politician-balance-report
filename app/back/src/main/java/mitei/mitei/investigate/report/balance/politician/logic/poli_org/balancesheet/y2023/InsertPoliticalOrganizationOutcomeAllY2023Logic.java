 ...
 */
@Component
public class InsertPoliticalOrganizationOutcomeAllY2023Logic {
    ...
    public int practice(final Long documentCode, // SUPPRESS CHECKSTYLE NOPMD
        ...
        List<OfferingBalancesheetOutcome2023Entity> list = new ArrayList<>();
        ...
        // 同一識別コードの設定
        Long code = 0L;
        Optional<OfferingBalancesheetOutcome2023Entity> optional = offeringBalancesheetOutcome2023Repository
        ...
        offeringBalancesheetOutcome2023Repository.saveAll(list);

        return list.size();
    }

    private List<OfferingBalancesheetOutcome2023Entity> createList(final Long documentCode,
    ...
    private OfferingBalancesheetOutcome2023Entity createEntity(final Long documentCode,
            final BalancesheetReportDocumentPoliticalPropertyDto documentPropertyDto, final Integer youshikiKbn,
            final Integer youshikiEdaKbn, final Row071415OrdinaryExpensesDto rowDto, final Long pageTotal,
            final String sonotaTotal, final String himoku, final CheckPrivilegeDto checkPrivilegeDto) {

        OfferingBalancesheetOutcome2023Entity outcomeEntity = new OfferingBalancesheetOutcome2023Entity();
