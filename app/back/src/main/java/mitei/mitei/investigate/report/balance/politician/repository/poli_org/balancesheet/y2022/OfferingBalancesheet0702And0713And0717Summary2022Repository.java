...
/**
 * offering_balancesheet_0702_and_0713_and_0717_summary_2022接続用Repository
 */
public interface OfferingBalancesheet0702And0713And0717Summary2022Repository
        extends JpaRepository<OfferingBalancesheet0702And0713And0717Summary2022Entity, Integer> {
    ...
    Optional<OfferingBalancesheet0702And0713And0717Summary2022Entity> findFirstByOrderByOfferingBalancesheet0702And0713And0717SummaryCodeDesc();
     ...
     * @return データリスト
     */
    List<OfferingBalancesheet0702And0713And0717Summary2022Entity> findByDocumentCodeOrderByOfferingBalancesheet0702And0713And0717SummaryId(
            Long documentCode);
     ...
     * @return 検索結果
     */
    List<OfferingBalancesheet0702And0713And0717Summary2022Entity> findByRelationPersonCodeDelegateInAndSaishinKbn(
     ...
     * @return 検索結果
     */
    List<OfferingBalancesheet0702And0713And0717Summary2022Entity> findByPoliticalOrganizationCodeAndSaishinKbn(
    ...
    @Query(value = "SELECT SUM(koji_futan_goukei),SUM(koji_futan_suu)"
            + "FROM offering_balancesheet_0702_and_0713_and_0717_summary_2022 WHERE relation_person_code_delegate IN( ?1 ) AND saishin_kbn= 1", nativeQuery = true)
