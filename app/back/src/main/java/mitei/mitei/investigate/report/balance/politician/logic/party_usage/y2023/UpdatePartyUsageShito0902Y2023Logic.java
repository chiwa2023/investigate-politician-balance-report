 ...
 */
@Component
public class UpdatePartyUsageShito0902Y2023Logic {
    ...
    public int practice(final Long oldCode, final CheckPrivilegeDto checkPrivilegeDto) {
        ...
        List<OfferingPartyUsage0902Report2023Entity> list = offeringPartyUsage0902Report2023Repository
                .findByDocumentCodeOrderByPartyUsage0902ReportId(oldCode);

        // 取得できた数を更新に値をセット
        for (OfferingPartyUsage0902Report2023Entity entity : list) {
            SetTableDataHistoryUtil.practice(checkPrivilegeDto, entity, DataHistoryStatusConstants.UPDATE);
        }

        return offeringPartyUsage0902Report2023Repository.saveAll(list).size();
    }
