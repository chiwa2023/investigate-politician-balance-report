...
import mitei.mitei.investigate.report.balance.politician.batch.financial_org_reflesh.config.UpdateDeleteZenginMasterFromIdoAsyncService;
...
/**
 * 異動先設定済削除変更テーブルからマスタテーブルに複写Batchを強制起動するContorller
 */
@Controller
@RequestMapping("/zengin-org-master")
public class ForceDeleteRegistZenginOrgMasterController extends AbstractTemplateCheckController {
    ...
    @Autowired
    private UpdateDeleteZenginMasterFromIdoAsyncService updateDeleteZenginMasterFromIdoAsyncService;
     ...
     */
    @PostMapping("/force-copy-master-delete")
    public ResponseEntity<TemplateFrameworkResultDto> practice(
        ...
        try {
             ...
             * ここに固有のビジネス処理を記載する
             */
            updateDeleteZenginMasterFromIdoAsyncService.practice(capsuleDto);
