 ...
 */
@Component
public class InsertPartyUsageShito0802And0803Y2025Logic {
    ...
    public int practice(final Long documentCode,
        ...
        OfferingPartyUsage0802And0803Report2025Entity reportEntity = new OfferingPartyUsage0802And0803Report2025Entity();
        ...
        // 同一識別コード取得
        Long code = 1L;
        Optional<OfferingPartyUsage0802And0803Report2025Entity> optional = offeringPartyUsage0802And0803Report2025Repository
        ...
        offeringPartyUsage0802And0803Report2025Repository.save(reportEntity);
