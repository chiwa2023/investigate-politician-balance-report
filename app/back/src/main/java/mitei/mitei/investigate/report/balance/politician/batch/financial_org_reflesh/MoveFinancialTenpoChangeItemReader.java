...
/**
 * 全銀金融機関支店異動のうち移転を抽出するItemReader
 */
@Component
public class MoveFinancialTenpoChangeItemReader extends RepositoryItemReader<ZenginOrgChangeBranchEntity> {
     ...
     */
    public MoveFinancialTenpoChangeItemReader(
        ...
        list.add(ZenginOrgChangeKbnConstants.MOVE);
        list.add(false);
