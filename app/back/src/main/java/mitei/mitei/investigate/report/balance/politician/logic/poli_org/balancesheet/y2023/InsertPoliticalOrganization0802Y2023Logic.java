 ...
 */
@Component
public class InsertPoliticalOrganization0802Y2023Logic {
    ...
    public int practice(final Long documentCode,
        ...
        List<OfferingBalancesheetWithdrawal0802Transfer2023Entity> list = new ArrayList<>();

        // 同一識別コードの取得
        Long code = 0L;
        Optional<OfferingBalancesheetWithdrawal0802Transfer2023Entity> optional = offeringBalancesheetWithdrawal0802Transfer2023Repository
        ...
        // 登録
        return offeringBalancesheetWithdrawal0802Transfer2023Repository.saveAll(list).size();
    }

    private OfferingBalancesheetWithdrawal0802Transfer2023Entity createEntity(final Long code, final Long documentCode,
            final Sheet080200WithdrawalItemsByTransferDto sheetDto,
            final BalancesheetReportDocumentPoliticalPropertyDto documentPropertyDto,
            final CheckPrivilegeDto checkPrivilegeDto) {
        OfferingBalancesheetWithdrawal0802Transfer2023Entity balancesheetEntity = new OfferingBalancesheetWithdrawal0802Transfer2023Entity();
