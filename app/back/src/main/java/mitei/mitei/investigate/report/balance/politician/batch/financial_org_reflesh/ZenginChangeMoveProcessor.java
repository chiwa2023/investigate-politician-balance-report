 ...
 */
@Component
public class ZenginChangeMoveProcessor  implements ItemProcessor<ZenginOrgChangeBranchEntity, ZenginOrgChangeBranchEntity>{
    ...
    public ZenginOrgChangeBranchEntity process(final ZenginOrgChangeBranchEntity item) throws Exception {
        final int kbn = ZenginOrgChangeKbnConstants.MOVE;
