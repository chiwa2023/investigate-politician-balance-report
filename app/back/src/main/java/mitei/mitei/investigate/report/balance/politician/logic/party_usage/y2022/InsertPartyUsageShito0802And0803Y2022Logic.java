 ...
 */
@Component
public class InsertPartyUsageShito0802And0803Y2022Logic {
    ...
    public int practice(final Long documentCode,
        ...
        OfferingPartyUsage0802And0803Report2022Entity reportEntity = new OfferingPartyUsage0802And0803Report2022Entity();
        ...
        // 同一識別コード取得
        Long code = 1L;
        Optional<OfferingPartyUsage0802And0803Report2022Entity> optional = offeringPartyUsage0802And0803Report2022Repository
        ...
        offeringPartyUsage0802And0803Report2022Repository.save(reportEntity);
