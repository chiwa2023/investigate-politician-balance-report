...
/**
 * offering_party_usage_0901_report_2025接続用Entity
 */
@Entity
@Table(name = "offering_party_usage_0901_report_2025")
public class OfferingPartyUsage0901Report2025Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
