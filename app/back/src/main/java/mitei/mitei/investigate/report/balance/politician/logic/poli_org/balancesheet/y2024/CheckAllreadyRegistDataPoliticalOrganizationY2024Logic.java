 ...
 */
@Component
public class CheckAllreadyRegistDataPoliticalOrganizationY2024Logic {
    ...
    public List<Long> practice(final BalancesheetReportDocumentPoliticalPropertyDto documentPropertyDto) {
        ...
        List<OfferingBalancesheet0701And0720Surface2024Entity> listData = offeringBalancesheet0701And0720Surface2024Repository
        ...
        for (OfferingBalancesheet0701And0720Surface2024Entity entity : listData) {
