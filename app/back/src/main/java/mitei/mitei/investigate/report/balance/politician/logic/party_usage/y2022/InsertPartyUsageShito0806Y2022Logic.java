 ...
 */
@Component
public class InsertPartyUsageShito0806Y2022Logic {
    ...
    public int practice(final Long documentCode,
        ...
        List<OfferingPartyUsage0806Report2022Entity> list = new ArrayList<>();
        ...
        // 同一識別コードを取得する
        Long code = 0L;
        Optional<OfferingPartyUsage0806Report2022Entity> optional = offeringPartyUsage0806Report2022Repository
    ...
    private List<OfferingPartyUsage0806Report2022Entity> createEntity(final Long documentCode,
            final PartyUsageDocumentPoliticalPropertyDto partyUsageDocumentPoliticalPropertyDto,
            final Sheet0806Dto sheet0806Dto, final CheckPrivilegeDto checkPrivilegeDto) {

        OfferingPartyUsage0806Report2022Entity reportEntity = new OfferingPartyUsage0806Report2022Entity();
    ...
    private List<OfferingPartyUsage0806Report2022Entity> createEntityByKbn01(final Long documentCode,
            final PartyUsageDocumentPoliticalPropertyDto partyUsageDocumentPoliticalPropertyDto,
    ...
    private List<OfferingPartyUsage0806Report2022Entity> createEntityByKbn02(final Long documentCode,
            final PartyUsageDocumentPoliticalPropertyDto partyUsageDocumentPoliticalPropertyDto,
    ...
    private List<OfferingPartyUsage0806Report2022Entity> createEntityByKbn03(final Long documentCode,
            final PartyUsageDocumentPoliticalPropertyDto partyUsageDocumentPoliticalPropertyDto,
    ...
    private OfferingPartyUsage0806Report2022Entity createEntityByRow0(final int kbn, final Long documentCode,
