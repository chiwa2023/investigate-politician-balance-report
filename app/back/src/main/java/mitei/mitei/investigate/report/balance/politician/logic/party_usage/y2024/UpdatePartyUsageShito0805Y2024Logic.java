 ...
 */
@Component
public class UpdatePartyUsageShito0805Y2024Logic {
    ...
    public int practice(final Long oldCode, final CheckPrivilegeDto checkPrivilegeDto) {
        ...
        List<OfferingPartyUsage0805Report2024Entity> list = offeringPartyUsage0805Report2024Repository
                .findByDocumentCodeOrderByPartyUsage0805ReportId(oldCode);

        // 取得できた数を更新に値をセット
        for (OfferingPartyUsage0805Report2024Entity entity : list) {
