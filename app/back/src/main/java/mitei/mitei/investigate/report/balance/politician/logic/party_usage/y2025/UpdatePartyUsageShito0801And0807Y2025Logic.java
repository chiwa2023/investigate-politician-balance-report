 ...
 */
@Component
public class UpdatePartyUsageShito0801And0807Y2025Logic {
    ...
    public int practice(final Long oldCode, final CheckPrivilegeDto checkPrivilegeDto) {
        ...
        // 取得できた数を更新に値をセット
        for (OfferingPartyUsage0801And0807Report2025Entity entity : list) {
            SetTableDataHistoryUtil.practice(checkPrivilegeDto, entity, DataHistoryStatusConstants.UPDATE);
        }

        return offeringPartyUsage0801And0807Report2025Repository.saveAll(list).size();
    }
