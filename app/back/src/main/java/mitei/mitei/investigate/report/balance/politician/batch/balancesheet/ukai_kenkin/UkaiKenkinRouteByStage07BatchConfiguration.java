 ...
 */
@Configuration
public class UkaiKenkinRouteByStage07BatchConfiguration {

    /** 機能名 */
    private static final String FUNCTION_NAME = "ukaiKenkinRouteByStage07";
    ...
    protected Job getJob(final JobRepository jobRepository, @Qualifier(STEP_CLEAN_NAME) final Step stepClean,
        ...
        return new JobBuilder(JOB_NAME, jobRepository).incrementer(new RunIdIncrementer()).flow(stepClean)
                ...
                .next(stepStage6).next(stepStage7) // ここまで階層
                .next(stepPickupZero)
