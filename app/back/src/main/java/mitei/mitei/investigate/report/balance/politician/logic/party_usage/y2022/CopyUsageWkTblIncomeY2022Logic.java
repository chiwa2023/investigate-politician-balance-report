...
/**
 * 使途報告書収入テーブルワークテーブル複写用データ抽出Logic(2022)
 */
@Component
public class CopyUsageWkTblIncomeY2022Logic {
    ...
    public Integer practiceSize(final Long documentCode){
        return offeringPartyUsage0802Kbn02Report2022Repository.findByDocumentRow(documentCode);
    }
    ...
    public List<WkTblUsageIncomeEntity> practice(final Long documentCode, final Integer pageNumber,
        ...
        List<OfferingPartyUsage0802Kbn02Report2022Entity> listSrc = offeringPartyUsage0802Kbn02Report2022Repository
                .findByDocumentCodeOrderByPartyUsage0802Kbn02ReportId(documentCode, pageable);

        List<WkTblUsageIncomeEntity> list = new ArrayList<>();
        for (OfferingPartyUsage0802Kbn02Report2022Entity entitySrc : listSrc) {
     ...
     */
    private WkTblUsageIncomeEntity createEntity(final OfferingPartyUsage0802Kbn02Report2022Entity entitySrc,
