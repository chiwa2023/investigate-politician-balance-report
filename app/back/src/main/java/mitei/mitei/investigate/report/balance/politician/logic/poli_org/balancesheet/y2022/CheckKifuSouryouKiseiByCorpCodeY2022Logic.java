 ...
 */
@Component
public class CheckKifuSouryouKiseiByCorpCodeY2022Logic {
    ...
    public List<SouryouKiseiRelationCodeDto> practice(final Integer poliOrgCode, final List<String> listDantaiKbn) {
        ...
        List<SouryouKiseiByCodeEntity> listSum = offeringBalancesheetIncome2022Repository.calcSumByRelationCorp(
                offeringBalancesheetIncome2022Repository.findRelationCorpByPoliOrg(poliOrgCode,YoushikiKbn.DONATE), listDantaiKbn);
