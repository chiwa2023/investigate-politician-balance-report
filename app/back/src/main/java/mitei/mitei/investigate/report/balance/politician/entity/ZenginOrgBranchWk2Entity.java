...
/**
 * zengin_org_branch_Wk2接続用Entity
 */
@Entity
@Table(name = "zengin_org_branch_Wk2")
public class ZenginOrgBranchWk2Entity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
    ...
    @Column(name = "zengin_org_branch_wk2_id")
    private Integer zenginOrgBranchWk2Id = INIT_Integer;
     ...
     * @return 金融機関マスタId
     */
    public Integer getZenginOrgBranchWk2Id() {
        return zenginOrgBranchWk2Id;
    }

    /**
     * 金融機関マスタIdを設定する
     *
     * @param zenginOrgBranchWk2Id 金融機関マスタId
     */
    public void setZenginOrgBranchWk2Id(final Integer zenginOrgBranchWk2Id) {
        this.zenginOrgBranchWk2Id = zenginOrgBranchWk2Id;
    }

    /** 全銀協金融機関マスタ同一識別コード */
    @Column(name = "zengin_org_branch_wk2_code")
    private Integer zenginOrgBranchWk2Code = INIT_Integer;
     ...
     */
    public Integer getZenginOrgBranchWk2Code() {
        return zenginOrgBranchWk2Code;
    }

    /**
     * 全銀協金融機関マスタ同一識別コードを設定する
     *
     * @param zenginOrgBranchWk2Code 全銀協金融機関マスタ同一識別コード
     */
    public void setZenginOrgBranchWk2Code(final Integer zenginOrgBranchWk2Code) {
        this.zenginOrgBranchWk2Code = zenginOrgBranchWk2Code;
    }

    /** 全銀協金融機関名称 */
    @Column(name = "zengin_org_branch_wk2_name")
    private String zenginOrgBranchWk2Name = INIT_String;
     ...
     * @return 全銀協金融機関名称
     */
    public String getZenginOrgBranchWk2Name() {
        return zenginOrgBranchWk2Name;
    }

    /**
     * 全銀協金融機関名称を設定する
     *
     * @param zenginOrgBranchWk2Name 全銀協金融機関名称
     */
    public void setZenginOrgBranchWk2Name(final String zenginOrgBranchWk2Name) {
        this.zenginOrgBranchWk2Name = zenginOrgBranchWk2Name;
    }
