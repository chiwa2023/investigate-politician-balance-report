 ...
 */
@Component
public class InsertPartyUsageShito0802Kbn02Y2023Logic {
    ...
    public int practice(final Long documentCode,
        ...
        List<OfferingPartyUsage0802Kbn02Report2023Entity> list = new ArrayList<>();

        // 同一識別コードの設定
        Long code = 0L;
        Optional<OfferingPartyUsage0802Kbn02Report2023Entity> optional = offeringPartyUsage0802Kbn02Report2023Repository
        ...
        // repositoryで保存
        return offeringPartyUsage0802Kbn02Report2023Repository.saveAll(list).size();
    }

    private OfferingPartyUsage0802Kbn02Report2023Entity createEntity(final Long code, final Long documentCode,
        ...
        OfferingPartyUsage0802Kbn02Report2023Entity reportEntity = new OfferingPartyUsage0802Kbn02Report2023Entity();
