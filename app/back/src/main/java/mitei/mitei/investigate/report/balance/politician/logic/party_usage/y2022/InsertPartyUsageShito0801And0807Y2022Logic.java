 ...
 */
@Component
public class InsertPartyUsageShito0801And0807Y2022Logic {
    ...
    public Long practice(final PartyUsageDocumentPoliticalPropertyDto partyUsageDocumentPoliticalPropertyDto,
        ...
        OfferingPartyUsage0801And0807Report2022Entity reportEntity = new OfferingPartyUsage0801And0807Report2022Entity();
        ...
        Long code = 1L;
        // 同一識別コードの最大値を取得し、＋１する
        Optional<OfferingPartyUsage0801And0807Report2022Entity> optional = offeringPartyUsage0801And0807Report2022Repository
        ...
        // repositoryで保存
        offeringPartyUsage0801And0807Report2022Repository.save(reportEntity);
