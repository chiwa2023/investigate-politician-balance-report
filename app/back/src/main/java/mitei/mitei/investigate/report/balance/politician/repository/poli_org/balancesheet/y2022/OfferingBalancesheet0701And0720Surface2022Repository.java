 ...
 */
public interface OfferingBalancesheet0701And0720Surface2022Repository
        extends JpaRepository<OfferingBalancesheet0701And0720Surface2022Entity, Integer> {
    ...
    // offering_balancesheet_0701_and_0720_surface_2022 WHERE saishin_kbn= 1 AND
    // MATCH(offering_balancesheet_0701_and_0720_surface_2022_name) AGAINST (?1 IN
    // NATURAL LANGUAGE MODE)", nativeQuery = true)
    // List<OfferingBalancesheet0701And0720Surface2022Entity> findFullText(String
    // searchWords);
     ...
     * @return データリスト
     */
    List<OfferingBalancesheet0701And0720Surface2022Entity> findByOfferingBalancesheet0701And0720SurfaceCodeOrderByOfferingBalancesheet0701And0720SurfaceId(
     ...
     * @return データリスト
     */
    List<OfferingBalancesheet0701And0720Surface2022Entity> findBySaishinKbnAndPoliticalOrganizationCodeAndOfferingDate(
