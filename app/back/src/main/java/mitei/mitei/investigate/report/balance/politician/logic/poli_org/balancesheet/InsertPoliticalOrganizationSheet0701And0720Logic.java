...
import mitei.mitei.investigate.report.balance.politician.repository.OfferingBalancesheet0701And0720Surface2025Repository;
...
public class InsertPoliticalOrganizationSheet0701And0720Logic {
    ...
    public Long practice(final BalancesheetReportDocumentPoliticalPropertyDto documentPropertyDto,
        ...
        OfferingBalancesheet0701And0720Surface2025Entity balancesheetEntity = new OfferingBalancesheet0701And0720Surface2025Entity();
        // ヘッダ
        ...
        //同一識別コードの設定
        Long code = 1L;
        Optional<OfferingBalancesheet0701And0720Surface2025Entity> optional = offeringBalancesheet0701And0720Surface2025Repository.findFirstByOrderByOfferingBalancesheet0701And0720SurfaceCodeDesc();
        if(!optional.isEmpty()) {
        ...
        offeringBalancesheet0701And0720Surface2025Repository.save(balancesheetEntity);
