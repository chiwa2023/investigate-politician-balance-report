...
/**
 * 政党交付金使途報告書一括処理ワークテーブル政治団体指定データ検索処理
 */
@RestController
@RequestMapping("/listup-party-usage-poli-org")
public class SearchRegistPartyUsageWkTbController extends AbstractTemplateCheckController {
    ...
    public ResponseEntity<List<WkTblPoliOrgPartyUsageReportEntity>> practice(
        ...
        try {
            ...
            return ResponseEntity.ok(searchRegistPartyUsageWkTbService.practice());
