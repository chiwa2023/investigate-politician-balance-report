...
/**
 * wk_tbl_usage_income接続用Entity
 */
@Entity
@Table(name = "wk_tbl_usage_income")
public class WkTblUsageIncomeEntity  implements Serializable,AllTabeDataHistoryInterface{ // NOPMD DataClass
    ...
    @Column(name = "worktable_id")
    private Long worktableId = INIT_Long;
     ...
     * ワークテーブルId
     *
     * @param worktableId ワークテーブルId
     */
    public void setWorktableId(final Long worktableId) {
