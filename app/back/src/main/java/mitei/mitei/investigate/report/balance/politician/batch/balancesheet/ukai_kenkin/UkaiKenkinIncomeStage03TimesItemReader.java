 ...
 */
@Component
public class UkaiKenkinIncomeStage03TimesItemReader extends AbstractPagingItemReader<OfferingBalancesheetIncomeEntity> {
     ...
     */
    public UkaiKenkinIncomeStage03TimesItemReader(
