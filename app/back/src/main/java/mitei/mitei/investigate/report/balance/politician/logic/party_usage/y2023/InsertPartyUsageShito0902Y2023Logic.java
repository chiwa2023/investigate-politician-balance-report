 ...
 */
@Component
public class InsertPartyUsageShito0902Y2023Logic {
    ...
    public int practice(final Long documentCode,
        ...
        List<OfferingPartyUsage0902Report2023Entity> list = new ArrayList<>();

        // 初期同一識別コードを取得
        Long code = 0L;
        Optional<OfferingPartyUsage0902Report2023Entity> optional = offeringPartyUsage0902Report2023Repository
        ...
        // repositoryで保存
        return offeringPartyUsage0902Report2023Repository.saveAllAndFlush(list).size();
    }

    private OfferingPartyUsage0902Report2023Entity createEntity(final Long code, final Long documentCode,
        ...
        OfferingPartyUsage0902Report2023Entity entity = new OfferingPartyUsage0902Report2023Entity();
