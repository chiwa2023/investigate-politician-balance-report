 ...
 */
@Component
public class CheckKifuSouryouKiseiByCorpCodeY2024Logic {
    ...
    public List<SouryouKiseiRelationCodeDto> practice(final Integer poliOrgCode, final List<String> listDantaiKbn) {
        ...
        List<SouryouKiseiByCodeEntity> listSum = offeringBalancesheetIncome2024Repository.calcSumByRelationCorp(
                offeringBalancesheetIncome2024Repository.findRelationCorpByPoliOrg(poliOrgCode,YoushikiKbn.DONATE), listDantaiKbn);
