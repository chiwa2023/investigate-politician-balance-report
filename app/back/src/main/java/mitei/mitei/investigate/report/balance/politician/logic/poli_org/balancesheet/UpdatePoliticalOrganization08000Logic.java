...
import mitei.mitei.investigate.report.balance.politician.logic.poli_org.balancesheet.y2023.UpdatePoliticalOrganization08000Y2023Logic;
// importを追加
...
public class UpdatePoliticalOrganization08000Logic {
    ...
    public int practice(final int houkokuNen, final Long oldCode, final CheckPrivilegeDto checkPrivilegeDto) {
        ...
        switch (houkokuNen) {
            ...
            case YEAR_2023:
                result = updatePoliticalOrganization08000Y2023Logic.practice(oldCode, checkPrivilegeDto);
                break;
