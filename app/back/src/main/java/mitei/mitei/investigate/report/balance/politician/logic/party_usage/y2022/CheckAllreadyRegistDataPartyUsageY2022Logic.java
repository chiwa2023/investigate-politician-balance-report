 ...
 */
@Component
public class CheckAllreadyRegistDataPartyUsageY2022Logic {
    ...
    public List<Long> practice(final PartyUsageDocumentPoliticalPropertyDto documentPropertyDto) {
        ...
        List<OfferingPartyUsage0801And0807Report2022Entity> listData = offeringPartyUsage0801And0807Report2022Repository
        ...
        for (OfferingPartyUsage0801And0807Report2022Entity entity : listData) {
