 ...
 */
@Component
public class InsertPartyUsageShito0805Y2024Logic {
    ...
    public int practice(final Long documentCode,
        ...
        List<OfferingPartyUsage0805Report2024Entity> list = new ArrayList<>();

        // 同一識別コード最大値を取得
        Long code = 0L;
        Optional<OfferingPartyUsage0805Report2024Entity> optional = offeringPartyUsage0805Report2024Repository
        ...
        // repositoryで保存
        return offeringPartyUsage0805Report2024Repository.saveAll(list).size();
    }

    private OfferingPartyUsage0805Report2024Entity createEntity(final Long code, final Long documentCode,
        ...
        OfferingPartyUsage0805Report2024Entity reportEntity = new OfferingPartyUsage0805Report2024Entity();
