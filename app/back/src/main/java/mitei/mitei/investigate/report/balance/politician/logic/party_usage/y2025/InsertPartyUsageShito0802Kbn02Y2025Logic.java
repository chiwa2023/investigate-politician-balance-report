 ...
 */
@Component
public class InsertPartyUsageShito0802Kbn02Y2025Logic {
    ...
    public int practice(final Long documentCode,
        ...
        // 同一識別コードの設定
        Long code = 0L;
        Optional<OfferingPartyUsage0802Kbn02Report2025Entity> optional = offeringPartyUsage0802Kbn02Report2025Repository
        ...
        // repositoryで保存
        return offeringPartyUsage0802Kbn02Report2025Repository.saveAll(list).size();
    }

    private OfferingPartyUsage0802Kbn02Report2025Entity createEntity(final Long code, final Long documentCode,
