 ...
 */
@Component
public class ZenginChangeAddProcessor  implements ItemProcessor<ZenginOrgChangeBranchEntity, ZenginOrgChangeBranchEntity>{
    ...
    public ZenginOrgChangeBranchEntity process(final ZenginOrgChangeBranchEntity item) throws Exception {
        final int kbn = ZenginOrgChangeKbnConstants.ADD;
