 ...
 */
@Component
public class InsertPoliticalOrganization08000Y2022Logic {
    ...
    public int practice(final Long documentCode,
        ...
        List<OfferingBalancesheetDifficalt0800Recipt2022Entity> list = new ArrayList<>();

        // コードの取得
        Long code = 0L;
        Optional<OfferingBalancesheetDifficalt0800Recipt2022Entity> optional = offeringBalancesheetDifficalt0800Recipt2022Repository
    ...
    private OfferingBalancesheetDifficalt0800Recipt2022Entity createEntity(final Long code,
        ...
        OfferingBalancesheetDifficalt0800Recipt2022Entity balancesheetEntity = new OfferingBalancesheetDifficalt0800Recipt2022Entity();
