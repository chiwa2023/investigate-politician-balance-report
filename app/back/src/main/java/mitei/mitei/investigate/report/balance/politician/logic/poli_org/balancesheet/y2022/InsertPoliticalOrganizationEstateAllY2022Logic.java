 ...
 */
@Component
public class InsertPoliticalOrganizationEstateAllY2022Logic {
    ...
    public int practice(final Long documentCode, // SUPPRESS CHECKSTYLE NOPMD
        ...
        List<OfferingBalancesheet0718Estate2022Entity> listAsset = new ArrayList<>();
        ...
        // 同一識別コードの設定
        Long codeAsset = 0L;
        Optional<OfferingBalancesheet0718Estate2022Entity> optionalAsset = offeringBalancesheet0718Estate2022Repository
        ...
        for (OfferingBalancesheet0718Estate2022Entity entity : listAsset) {
            codeAsset++;
            entity.setOfferingBalancesheet0718EstateCode(codeAsset);
        }

        final int sizeAsset = offeringBalancesheet0718Estate2022Repository.saveAll(listAsset).size();

        // シート19-1,2,3を登録する
        List<OfferingBalancesheet0719RealEstate2022Entity> listRealEstate = new ArrayList<>();
        Integer kbnEstate;
        ...
        Optional<OfferingBalancesheet0719RealEstate2022Entity> optionalRealEstate = offeringBalancesheet0719RealEstate2022Repository
    ...
    private OfferingBalancesheet0718Estate2022Entity createAssetEntity(final Long documentCode,
            final BalancesheetReportDocumentPoliticalPropertyDto documentPropertyDto,
            final Row071800ClassificationOfAssetsByItemDto rowDto, final CheckPrivilegeDto checkPrivilegeDto) {

        OfferingBalancesheet0718Estate2022Entity balancesheetEntity = new OfferingBalancesheet0718Estate2022Entity();
    ...
    private OfferingBalancesheet0719RealEstate2022Entity createRealEstateEntity(final Long documentCode,
            final BalancesheetReportDocumentPoliticalPropertyDto documentPropertyDto,
            final Row071900CurrentStatusOfRealEstateUseDto rowDto, final Integer kbn,
            final CheckPrivilegeDto checkPrivilegeDto) {

        OfferingBalancesheet0719RealEstate2022Entity balancesheetEntity = new OfferingBalancesheet0719RealEstate2022Entity();
