...
/**
 * 対象の政治団体に属する関連者すべてを抽出する(2023年)
 */
@Component
public class GetRelationPersonPoliOrgByCodeY2023Logic {
    ...
    public PoliticalOrganizationPropertyEntity practice(final Integer poliOrgCode) {
        ...
        Optional<OfferingBalancesheet0701And0720Surface2023Entity> optionalSurface = offeringBalancesheet0701And0720Surface2023Repository
