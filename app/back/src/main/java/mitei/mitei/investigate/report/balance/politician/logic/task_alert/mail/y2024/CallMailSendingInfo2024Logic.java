 ...
 */
@Component
public class CallMailSendingInfo2024Logic implements CallMailSendingInfoInterface {
    ...
    public SendMailCapsuleDto practice(final LocalDateTime localDateTime) {
        ...
        // 最新区分かつ
        List<SendAlertMail2024Entity> listEntity = sendAlertMail2024Repository
        ...
        for (SendAlertMail2024Entity entity : listEntity) {
     ...
     * @return 送信予定Dto
     */
    private MailDataDto createDto(final SendAlertMail2024Entity entity) {
