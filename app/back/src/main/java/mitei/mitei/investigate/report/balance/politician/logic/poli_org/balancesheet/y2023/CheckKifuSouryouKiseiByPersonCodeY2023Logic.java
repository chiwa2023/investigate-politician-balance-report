 ...
 */
@Component
public class CheckKifuSouryouKiseiByPersonCodeY2023Logic {
    ...
    public List<SouryouKiseiRelationCodeDto> practice(final Integer poliOrgCode, final List<String> listDantaiKbn) {
        ...
        List<SouryouKiseiByCodeEntity> listSum = offeringBalancesheetIncome2023Repository.calcSumByRelationPerson(
                offeringBalancesheetIncome2023Repository.findRelationPersonByPoliOrg(poliOrgCode,YoushikiKbn.DONATE), listDantaiKbn);
