 ...
 */
@Component
public class ConvertUkaiKenkinIncomeByCodeY2024Logic {
    ...
    public List<WkTblUkaiKenkinEntity> practice(final List<Integer> listPoliOrgCode,
        ...
        List<OfferingBalancesheetIncome2024Entity> listByPoliOrg = offeringBalancesheetIncome2024Repository
        ...
        for (OfferingBalancesheetIncome2024Entity entityIncome : listByPoliOrg) {
            list.add(
    ...
    private WkTblUkaiKenkinEntity convertEntity(final OfferingBalancesheetIncome2024Entity entityIncome,
    ...
    private void setKanrenSha(final WkTblUkaiKenkinEntity entity,
            final OfferingBalancesheetIncome2024Entity entityIncome) {
