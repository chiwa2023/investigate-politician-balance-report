 ...
 */
@Component
public class InsertPartyUsageShito0805Y2023Logic {
    ...
    public int practice(final Long documentCode,
        ...
        List<OfferingPartyUsage0805Report2023Entity> list = new ArrayList<>();

        // 同一識別コード最大値を取得
        Long code = 0L;
        Optional<OfferingPartyUsage0805Report2023Entity> optional = offeringPartyUsage0805Report2023Repository
    ...
    private OfferingPartyUsage0805Report2023Entity createEntity(final Long code, final Long documentCode,
        ...
        OfferingPartyUsage0805Report2023Entity reportEntity = new OfferingPartyUsage0805Report2023Entity();
