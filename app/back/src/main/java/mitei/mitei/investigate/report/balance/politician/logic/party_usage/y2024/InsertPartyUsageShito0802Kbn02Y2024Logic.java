 ...
 */
@Component
public class InsertPartyUsageShito0802Kbn02Y2024Logic {
    ...
    public int practice(final Long documentCode,
        ...
        List<OfferingPartyUsage0802Kbn02Report2024Entity> list = new ArrayList<>();

        // 同一識別コードの設定
        Long code = 0L;
        Optional<OfferingPartyUsage0802Kbn02Report2024Entity> optional = offeringPartyUsage0802Kbn02Report2024Repository
    ...
    private OfferingPartyUsage0802Kbn02Report2024Entity createEntity(final Long code, final Long documentCode,
        ...
        OfferingPartyUsage0802Kbn02Report2024Entity reportEntity = new OfferingPartyUsage0802Kbn02Report2024Entity();
