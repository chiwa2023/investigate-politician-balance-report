 ...
 */
@Configuration
public class UkaiKenkinRouteByStage06BatchConfiguration {

    /** 機能名 */
    private static final String FUNCTION_NAME = "ukaiKenkinRouteByStage06";
    ...
    protected Job getJob(final JobRepository jobRepository, @Qualifier(STEP_CLEAN_NAME) final Step stepClean,
            ...
            @Qualifier(STEP_STAGE_6) final Step stepStage6,
