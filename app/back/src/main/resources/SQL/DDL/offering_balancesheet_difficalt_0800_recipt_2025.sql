CREATE TABLE `offering_balancesheet_difficalt_0800_recipt_2025` (
  `offering_balancesheet_difficalt_0800_recipt_id` bigint NOT NULL AUTO_INCREMENT COMMENT '収支報告書様式8Id',
  `offering_balancesheet_difficalt_0800_recipt_code` bigint DEFAULT NULL COMMENT '収支報告書様式8同一識別コード',
  ...
  `koumoku` varchar(210) DEFAULT NULL COMMENT '項目',
  ...
  `jijyou` varchar(210) DEFAULT NULL COMMENT '事情',
