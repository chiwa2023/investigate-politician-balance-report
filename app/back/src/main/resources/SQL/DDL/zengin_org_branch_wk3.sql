CREATE TABLE `zengin_org_branch_wk3` (
  `zengin_org_branch_wk3_id` int NOT NULL AUTO_INCREMENT COMMENT '金融機関マスタId',
  `zengin_org_branch_wk3_code` int DEFAULT NULL COMMENT '全銀協金融機関マスタ同一識別コード',
  `zengin_org_branch_wk3_name` varchar(300) DEFAULT NULL COMMENT '全銀協金融機関名称',
  ...
  PRIMARY KEY (`zengin_org_branch_wk3_id`)
