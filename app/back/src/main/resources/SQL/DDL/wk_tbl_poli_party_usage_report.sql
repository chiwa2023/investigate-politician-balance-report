CREATE TABLE `wk_tbl_poli_party_usage_report` (
  `wk_tbl_poli_party_usage_report_id` bigint NOT NULL AUTO_INCREMENT COMMENT '政党交付金使途報告書登録準備ワークテーブルId',
  `wk_tbl_poli_party_usage_report_code` int DEFAULT NULL COMMENT '政党交付金使途報告書登録準備ワークテーブル同一識別コード',
  `saishin_kbn` int DEFAULT NULL COMMENT '最新区分',
  `task_plan_party_usage_detail_id` bigint DEFAULT NULL COMMENT '政党交付金使途報告書予定計画Id',
  `task_plan_party_usage_detail_code` bigint DEFAULT NULL COMMENT '政党交付金使途報告書予定計同一識別コード',
  ...
  PRIMARY KEY (`wk_tbl_poli_party_usage_report_id`)
