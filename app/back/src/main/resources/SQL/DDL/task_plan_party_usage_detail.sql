CREATE TABLE `task_plan_party_usage_detail` (
  `task_plan_party_usage_detail_id` bigint NOT NULL AUTO_INCREMENT COMMENT '政党交付金使途報告書準備登録タスクId',
  `task_plan_party_usage_detail_code` bigint DEFAULT NULL COMMENT '政党交付金使途報告書準備登録タスク定同一識別コード',
  ...
  `document_key` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '文書認識Key',
  ...
  PRIMARY KEY (`task_plan_party_usage_detail_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1469 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
