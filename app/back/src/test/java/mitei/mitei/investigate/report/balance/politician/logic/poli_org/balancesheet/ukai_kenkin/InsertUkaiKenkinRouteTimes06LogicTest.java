...
/**
 * InsertUkaiKenkinRouteTimes06Logic単体テスト
 */
@SpringJUnitConfig
...
class InsertUkaiKenkinRouteTimes06LogicTest {
    ...
    void testProperty6() {
        ...
        insertUkaiKenkinRouteTimes06Logic.practice(userCode, entityRoute, propertyEntity);
    ...
    void testYakuwari6() {
        ...
        insertUkaiKenkinRouteTimes06Logic.practice(userCode, entityRoute, personWithYakuwariDto);
