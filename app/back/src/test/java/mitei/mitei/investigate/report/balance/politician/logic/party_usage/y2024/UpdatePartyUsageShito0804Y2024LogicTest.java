...
/**
 * UpdatePartyUsageShito0804Y2024Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0804Y2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Transactional
    @Sql("offering_party_usage_0804_report_2024.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0804Report2024Entity> listPre = offeringPartyUsage0804Report2024Repository
                .findByDocumentCodeOrderByPartyUsage0804ReportId(oldDcoumentCode);

        OfferingPartyUsage0804Report2024Entity preEntity = listPre.get(0);
        ...
        int size = updatePartyUsageShito0804Y2024Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingPartyUsage0804Report2024Entity> listPro = offeringPartyUsage0804Report2024Repository
                .findByDocumentCodeOrderByPartyUsage0804ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0804Report2024Entity proEntity;
