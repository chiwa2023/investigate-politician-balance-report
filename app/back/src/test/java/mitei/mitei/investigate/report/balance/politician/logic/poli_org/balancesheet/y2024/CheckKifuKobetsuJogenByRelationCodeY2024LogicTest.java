...
/**
 * CheckKifuKobetsuJogenByRelationCodeY2024Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class CheckKifuKobetsuJogenByRelationCodeY2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql({ "kobetsu_kisei_2024.sql", "../kifu_souryou_kisei/political_organization.sql" })
    void testPoliOrg() {
        ...
        SearchKifuJougenMeisaiBalancesheetResultDto resultDto = checkKifuKobetsuJogenByRelationCodeY2024Logic
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql({ "kobetsu_kisei_2024.sql", "../kifu_souryou_kisei/relation_person.sql" })
    void testPersonal() {
