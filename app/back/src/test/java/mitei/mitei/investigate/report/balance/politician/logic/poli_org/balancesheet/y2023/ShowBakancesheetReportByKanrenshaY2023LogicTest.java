...
/**
 * ShowBakancesheetReportByKanrenshaY2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class ShowBakancesheetReportByKanrenshaY2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Transactional
    @Tag("TableTruncate")
    @Sql({ "search_kanrensha_income_2023.sql", "search_kanrensha_outcome_2023.sql" })
    void test() { // NOPMD

        KanrenshaBalancesheetConditionCapsuleDto capsuleDto = new KanrenshaBalancesheetConditionCapsuleDto();
        capsuleDto.setHoukokuNen(2023);
        ...
        IncomeAndOutcomeNaturalSearchResultDto resultDto = showBakancesheetReportByKanrenshaY2023Logic
                .practice(capsuleDto);
        ...
        assertEquals(LocalDate.of(2023, 9, 30), dto000.getAccrualDateValue(), "収入発生日実値0");
        ...
        assertEquals(LocalDate.of(2023, 2, 15), dto101.getAccrualDateValue(), "支出発生日実値0");
