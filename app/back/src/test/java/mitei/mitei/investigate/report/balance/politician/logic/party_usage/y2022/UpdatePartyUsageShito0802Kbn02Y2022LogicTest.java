...
/**
 * UpdatePartyUsageShito0802Kbn02Y2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0802Kbn02Y2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("offering_party_usage_0802_kbn_02_report_2022.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0802Kbn02Report2022Entity> listPre = offeringPartyUsage0802Kbn02Report2022Repository
                .findByDocumentCodeOrderByPartyUsage0802Kbn02ReportId(oldDcoumentCode);

        OfferingPartyUsage0802Kbn02Report2022Entity preEntity = listPre.get(0);
        ...
        int size = updatePartyUsageShito0802Kbn02Y2022Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingPartyUsage0802Kbn02Report2022Entity> listPro = offeringPartyUsage0802Kbn02Report2022Repository
                .findByDocumentCodeOrderByPartyUsage0802Kbn02ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0802Kbn02Report2022Entity proEntity;
