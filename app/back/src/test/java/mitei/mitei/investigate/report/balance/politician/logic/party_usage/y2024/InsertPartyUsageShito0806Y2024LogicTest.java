...
/**
 * InsertPartyUsageShito0806Y2024Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class InsertPartyUsageShito0806Y2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() { // NOPMD
        ...
        int size = insertPartyUsageShito0806Y2024Logic.practice(documentCode, documentPropertyDto, allShitoBook.getShito0806Dto(), CreateTestPrivilegeDtoUtil.pracitce());
        
        
        List<OfferingPartyUsage0806Report2024Entity> list0806 = offeringPartyUsage0806Report2024Repository
                .findByDocumentCodeOrderByPartyUsage0806ReportId(documentCode);

        assertThat(list0806.size()).isEqualTo(size);// 区分データ3件と集計データの計4件

        OfferingPartyUsage0806Report2024Entity entity080601 = list0806.get(0);
        OfferingPartyUsage0806Report2024Entity entity080602 = list0806.get(1);
        OfferingPartyUsage0806Report2024Entity entity080603 = list0806.get(2);
        OfferingPartyUsage0806Report2024Entity entity080604 = list0806.get(3);
