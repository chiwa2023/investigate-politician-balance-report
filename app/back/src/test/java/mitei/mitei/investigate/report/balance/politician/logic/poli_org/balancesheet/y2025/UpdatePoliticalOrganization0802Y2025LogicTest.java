...
/**
 * UpdatePoliticalOrganization0802Y2025Logic単体テスト
 * 
 */
@SpringJUnitConfig
...
class UpdatePoliticalOrganization0802Y2025LogicTest {
    ...
    @Test
    @Transactional
    @Sql("offering_balancesheet_withdrawal_0802_transfer_2025.sql")
    void testPractice() {
        Long oldDcoumentCode = 3232L;

        List<OfferingBalancesheetWithdrawal0802Transfer2025Entity> listPre = offeringBalancesheetWithdrawal0802Transfer2025Repository
                .findByDocumentCodeOrderByOfferingBalancesheetWithdrawal0802TransferId(oldDcoumentCode);

        OfferingBalancesheetWithdrawal0802Transfer2025Entity preEntity = listPre.get(0);
        ...
        int size = updatePoliticalOrganization0802Y2025Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingBalancesheetWithdrawal0802Transfer2025Entity> listPro = offeringBalancesheetWithdrawal0802Transfer2025Repository
                .findByDocumentCodeOrderByOfferingBalancesheetWithdrawal0802TransferId(oldDcoumentCode);
        ...
        OfferingBalancesheetWithdrawal0802Transfer2025Entity proEntity;
