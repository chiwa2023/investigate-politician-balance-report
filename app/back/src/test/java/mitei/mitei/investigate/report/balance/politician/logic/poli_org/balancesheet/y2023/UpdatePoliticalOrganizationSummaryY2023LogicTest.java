...
/**
 * UpdatePoliticalOrganizationSummaryY2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePoliticalOrganizationSummaryY2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("offering_balancesheet_0702_and_0713_and_0717_summary_2023.sql")
    void testPractice() throws Exception {

        Long oldDcoumentCode = 3232L;

        List<OfferingBalancesheet0702And0713And0717Summary2023Entity> listPre = offeringBalancesheet0702And0713And0717Summary2023Repository
                .findByDocumentCodeOrderByOfferingBalancesheet0702And0713And0717SummaryId(oldDcoumentCode);

        OfferingBalancesheet0702And0713And0717Summary2023Entity preEntity = listPre.get(0);
        ...
        int size = updatePoliticalOrganizationSummaryY2023Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingBalancesheet0702And0713And0717Summary2023Entity> listPro = offeringBalancesheet0702And0713And0717Summary2023Repository
                .findByDocumentCodeOrderByOfferingBalancesheet0702And0713And0717SummaryId(oldDcoumentCode);
        ...
        OfferingBalancesheet0702And0713And0717Summary2023Entity proEntity;
