...
/**
 * UpdatePartyUsageShito0802And0803Y2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0802And0803Y2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Transactional
    @Sql("offering_party_usage_0802_and_0803_report_2023.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0802And0803Report2023Entity> listPre = offeringPartyUsage0802And0803Report2023Repository
                .findByDocumentCodeOrderByPartyUsage0802And0803ReportId(oldDcoumentCode);

        OfferingPartyUsage0802And0803Report2023Entity preEntity = listPre.get(0);
        ...
        int size = updatePartyUsageShito0802And0803Y2023Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingPartyUsage0802And0803Report2023Entity> listPro = offeringPartyUsage0802And0803Report2023Repository
                .findByDocumentCodeOrderByPartyUsage0802And0803ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0802And0803Report2023Entity proEntity;
