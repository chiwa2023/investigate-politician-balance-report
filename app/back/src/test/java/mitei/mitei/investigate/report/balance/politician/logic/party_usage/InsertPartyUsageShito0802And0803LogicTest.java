...
class InsertPartyUsageShito0802And0803LogicTest {
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2022/offering_party_usage_0802_and_0803_report_2022.sql")
    void testPractice2022() {
        ...
        insertPartyUsageShito0802And0803Logic.practice(documentCode, documentlPropertyDto, new Shito0802Dto(),
                new Shito0803Dto(), CreateTestPrivilegeDtoUtil.pracitce());

        assertEquals(2L, offeringPartyUsage0802And0803Report2022Repository.count(), "追加で1件");
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2024/offering_party_usage_0802_and_0803_report_2024.sql")
    void testPractice2024() {
        ...
        assertEquals(2L, offeringPartyUsage0802And0803Report2024Repository.count(), "追加で1件");
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2023/offering_party_usage_0802_and_0803_report_2023.sql")
    void testPractice2023() {
        ...
        assertEquals(2L, offeringPartyUsage0802And0803Report2023Repository.count(), "追加で1件");
