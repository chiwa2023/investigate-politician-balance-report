...
/**
 * CopyFinancialOrgWkTbl3BatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
class CopyFinancialOrgWkTbl3BatchConfigurationTest {
    // CHECKSTYLE:OFF
    ...
    @Autowired
    private Job copyFinancialOrgWkTbl3;

    @Test
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(CopyFinancialOrgWkTbl3BatchConfiguration.JOB_NAME, copyFinancialOrgWkTbl3.getName(), "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(copyFinancialOrgWkTbl3);
