 ...
 */
class ConvertSheetDtoToEntity0704BorrowedLogicTest {
    ...
    void testPractice() {
        ...
        ConvertSheetDtoToEntity0704BorrowedLogic convertSheetDtoToEntity0704BorrowedLogic = new ConvertSheetDtoToEntity0704BorrowedLogic();

        List<OfferingBalancesheetIncome2025Entity> list = convertSheetDtoToEntity0704BorrowedLogic
