...
/**
 * ForcePreparePartyUsageWkTbController単体テスト
 */
@SpringJUnitConfig
...
class ForcePreparePartyUsageWkTbControllerTest {
    ...
    void testPractice() throws Exception {
        ...
        List<TaskPlanPartyUsageDetailEntity> listData = taskPlanPartyUsageDetailRepository.findAll();
        Path copyPath = Paths.get(GetCurrentResourcePath.getBackTestResourcePath(),
                "sample/usgae/2022_政治家女子48党_SITO.xml");
        for (TaskPlanPartyUsageDetailEntity entity : listData) {
        ...
        String path = "http://localhost:9080/force-party-usage/prepare";
