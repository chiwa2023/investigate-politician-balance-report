...
/**
 * CheckKifuSouryouKiseiByPersonCodeY2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class CheckKifuSouryouKiseiByPersonCodeY2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql({ "souryou_kisei_2023.sql", "../kifu_souryou_kisei/relation_person.sql" })
    void test() throws Exception {

        // 政治団体区分が政党のリスト(通称A枠用)
        List<SouryouKiseiRelationCodeDto> list = checkKifuSouryouKiseiByPersonCodeY2023Logic.practice(100,
                getDantaiKbnListLogic.practiceParty());

        // CheckKifuSouryouKiseiByNameY2023Logicのテストと
