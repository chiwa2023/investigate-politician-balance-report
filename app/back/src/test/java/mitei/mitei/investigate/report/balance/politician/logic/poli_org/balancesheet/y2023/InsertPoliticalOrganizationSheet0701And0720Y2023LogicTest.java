...
class InsertPoliticalOrganizationSheet0701And0720Y2023LogicTest {
    ...
    void testPractice() { // NOPMD
        ...
        Long documentCode = insertPoliticalOrganizationSheet0701And0720Y2023Logic.practice(documentPropertyDto, allBookDto,
                CreateTestPrivilegeDtoUtil.pracitce());

        List<OfferingBalancesheet0701And0720Surface2023Entity> list = offeringBalancesheet0701And0720Surface2023Repository
        ...
        OfferingBalancesheet0701And0720Surface2023Entity entity = list.get(0);
