...
class InsertPoliticalOrganizationOutcomeAllY2024LogicTest {
    ...
    void testPractice() { // NOPMD
        ...
        int size = insertPoliticalOrganizationOutcomeAllY2024Logic.practice(documentCode, documentPropertyDto, allBookDto,
