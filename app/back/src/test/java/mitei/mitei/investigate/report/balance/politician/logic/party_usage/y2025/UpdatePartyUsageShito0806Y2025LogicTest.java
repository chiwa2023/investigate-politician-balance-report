...
/**
 * UpdatePartyUsageShito0806Y2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0806Y2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("offering_party_usage_0806_report_2025.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0806Report2025Entity> listPre = offeringPartyUsage0806Report2025Repository
                .findByDocumentCodeOrderByPartyUsage0806ReportId(oldDcoumentCode);

        OfferingPartyUsage0806Report2025Entity preEntity = listPre.get(0);
        ...
        int size = updatePartyUsageShito0806Y2025Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingPartyUsage0806Report2025Entity> listPro = offeringPartyUsage0806Report2025Repository
                .findByDocumentCodeOrderByPartyUsage0806ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0806Report2025Entity proEntity;
