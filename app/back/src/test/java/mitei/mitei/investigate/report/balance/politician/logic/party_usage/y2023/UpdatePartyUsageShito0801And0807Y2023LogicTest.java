...
/**
 * UpdatePartyUsageShito0801And0807Y2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0801And0807Y2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Transactional
    @Sql("offering_party_usage_0801_and_0807_report_2023.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0801And0807Report2023Entity> listPre = offeringPartyUsage0801And0807Report2023Repository
                .findByPartyUsage0801And0807ReportCodeOrderByPartyUsage0801And0807ReportId(oldDcoumentCode);

        OfferingPartyUsage0801And0807Report2023Entity preEntity = listPre.get(0);
        ...
        int size = updatePartyUsageShito0801And0807Y2023Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingPartyUsage0801And0807Report2023Entity> listPro = offeringPartyUsage0801And0807Report2023Repository
                .findByPartyUsage0801And0807ReportCodeOrderByPartyUsage0801And0807ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0801And0807Report2023Entity proEntity;
