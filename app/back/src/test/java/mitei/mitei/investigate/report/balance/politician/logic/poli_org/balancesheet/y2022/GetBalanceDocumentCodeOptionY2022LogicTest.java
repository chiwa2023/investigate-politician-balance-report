...
/**
 * GetBalanceDocumentCodeOptionY2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class GetBalanceDocumentCodeOptionY2022LogicTest {
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("balance_option_2022.sql")
    void test() {
        // CHECKSTYLE:OFF

        final int poliOrgCode = 9890;

        List<SelectOptionDto> listOption = getBalanceDocumentCodeOptionY2022Logic.practice(poliOrgCode);
