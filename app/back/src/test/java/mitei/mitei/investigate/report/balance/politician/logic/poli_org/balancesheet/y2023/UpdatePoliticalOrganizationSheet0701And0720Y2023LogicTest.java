...
/**
 * UpdatetPoliticalOrganizationSheet0701And0720Y2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePoliticalOrganizationSheet0701And0720Y2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("offering_balancesheet_0701_and_0720_surface_2023.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingBalancesheet0701And0720Surface2023Entity> listPre = offeringBalancesheet0701And0720Surface2023Repository
                .findByOfferingBalancesheet0701And0720SurfaceCodeOrderByOfferingBalancesheet0701And0720SurfaceId(
                        oldDcoumentCode);

        OfferingBalancesheet0701And0720Surface2023Entity preEntity = listPre.get(0);
        ...
        int size = updatetPoliticalOrganizationSheet0701And0720Y2023Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingBalancesheet0701And0720Surface2023Entity> listPro = offeringBalancesheet0701And0720Surface2023Repository
                .findByOfferingBalancesheet0701And0720SurfaceCodeOrderByOfferingBalancesheet0701And0720SurfaceId(
                        oldDcoumentCode);
        ...
        OfferingBalancesheet0701And0720Surface2023Entity proEntity;
