...
class InsertPoliticalOrganizationSummaryLogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice2025() { // NOPMD
        ...
        sheet02.setKojiFutanGoukei("30001");
        sheet02.setKojiFutanSuu("30002");
        ...
        // 登録作業
        int size = insertPoliticalOrganizationSummaryLogic.practice(documentCode, documentPropertyDto,
        ...
        OfferingBalancesheet0702And0713And0717Summary2025Entity entitySummary = list.get(0);
    ...
    void testPractice2024() { // NOPMD
        ...
        List<OfferingBalancesheet0702And0713And0717Summary2024Entity> list = offeringBalancesheet0702And0713And0717Summary2024Repository
                .findByDocumentCodeOrderByOfferingBalancesheet0702And0713And0717SummaryId(documentCode);

        assertThat(size).isEqualTo(1); // 1件だけ登録
        assertThat(list.size()).isEqualTo(size);

        OfferingBalancesheet0702And0713And0717Summary2024Entity entitySummary = list.get(0);
