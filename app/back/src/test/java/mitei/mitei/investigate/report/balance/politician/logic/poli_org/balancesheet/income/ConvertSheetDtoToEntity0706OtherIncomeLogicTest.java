 ...
 */
class ConvertSheetDtoToEntity0706OtherIncomeLogicTest {
    ...
    void testPractice() {
        ...
        ConvertSheetDtoToEntity0706OtherIncomeLogic convertSheetDtoToEntity0706OtherIncomeLogic = new ConvertSheetDtoToEntity0706OtherIncomeLogic();

        List<OfferingBalancesheetIncome2025Entity> list = convertSheetDtoToEntity0706OtherIncomeLogic
