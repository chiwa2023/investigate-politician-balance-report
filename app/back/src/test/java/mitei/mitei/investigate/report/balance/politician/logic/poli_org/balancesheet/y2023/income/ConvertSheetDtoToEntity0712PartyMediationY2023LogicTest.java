...
class ConvertSheetDtoToEntity0712PartyMediationLogicTest {
    ...
    /** テスト対象 */
    @Autowired
    private ConvertSheetDtoToEntity0712PartyMediationY2023Logic convertSheetDtoToEntity0712PartyMediationY2023Logic;
    ...
    void testPractice() { // NOPMD
        ...
        List<OfferingBalancesheetIncome2023Entity> list = convertSheetDtoToEntity0712PartyMediationY2023Logic.practice(
