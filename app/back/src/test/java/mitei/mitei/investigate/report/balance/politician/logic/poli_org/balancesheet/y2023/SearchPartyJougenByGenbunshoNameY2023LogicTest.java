...
/**
 * SearchPartyJougenByGenbunshoNameY2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class SearchPartyJougenByGenbunshoNameY2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        SearchKifuJougenMeisaiBalancesheetResultDto resultDto00 = searchPartyJougenByGenbunshoNameY2023Logic.practice(capsuleDto);
        ...
        SearchKifuJougenMeisaiBalancesheetResultDto resultDto01 = searchPartyJougenByGenbunshoNameY2023Logic.practice(capsuleDto1);
