...
/**
 * GetUsageDocumentCodeOptionY2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class GetUsageDocumentCodeOptionY2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("usage_option_2022.sql")
    void test() {

        final int poliOrgCode = 9890;

        List<SelectOptionDto> listOption = getUsageDocumentCodeOptionY2022Logic.practice(poliOrgCode);
