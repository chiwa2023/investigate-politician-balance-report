...
class InsertPoliticalOrganizationSheet0701And0720LogicTest {
    ...
    void testPractice2025() { // NOPMD
        ...
        sheet0.setHoukokuNen(2025);
        sheet0.setDateKaisai("R4/12/2");
        ...
        sheet0.setKaikeiSekinnshaNameLast("会計責任者の姓1");
        sheet0.setKaikeiSekinnshaNameFirst("会計責任者の名1");
        sheet0.setJimuTantousha1NameLast("事務担当者1の姓");
        sheet0.setJimuTantousha1NameFirst("事務担当者1の名1");
        ...
        sheet0.setKanriDantaiPeriodStart("R4/1/3");
        sheet0.setKanriDantaiPeriodEnd("R4/12/5");
        sheet0.setKanriDantaiPeriodRest("R4/1/1-R4/2/2、R4/3/1-R4/4/1");
        sheet0.setKokkaiGiinDantaiKbn(1);
        sheet0.setKokkaiGiin1NameLast("公職者の姓");
        sheet0.setKokkaiGiin1NameFirst("公職者の名");
        sheet0.setKokkaiGiin1ShuuSan("衆議院4");
        sheet0.setKokkaiGiin1GenKouho("1");
        sheet0.setGiinDantantaiTokureiPeriodStart("R4/1/2");
        sheet0.setGiinDantantaiTokureiPeriodEnd("R4/1/3");
    ...
    void testPractice2024() { // NOPMD
        ...
        List<OfferingBalancesheet0701And0720Surface2024Entity> list = offeringBalancesheet0701And0720Surface2024Repository
                .findByOfferingBalancesheet0701And0720SurfaceCodeOrderByOfferingBalancesheet0701And0720SurfaceId(
                        documentCode);
        ...
        OfferingBalancesheet0701And0720Surface2024Entity entity = list.get(0);
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2022/offering_balancesheet_0701_and_0720_surface_2022.sql")
    void testPractice2022() {

        assertEquals(1L, offeringBalancesheet0701And0720Surface2022Repository.count(), TEST_INIT_COUNT);
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2023/offering_balancesheet_0701_and_0720_surface_2023.sql")
    void testPractice2023() {

        assertEquals(1L, offeringBalancesheet0701And0720Surface2023Repository.count(), TEST_INIT_COUNT);
