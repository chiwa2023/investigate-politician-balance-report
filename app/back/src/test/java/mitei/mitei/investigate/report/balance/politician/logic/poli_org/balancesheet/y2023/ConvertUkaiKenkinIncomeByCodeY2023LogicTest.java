...
/**
 * ConvertUkaiKenkinIncomeY2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class ConvertUkaiKenkinIncomeByCodeY2023LogicTest {
    // CHECKSTYLE:OFF

    /** テスト対象 */
    @Autowired
    private ConvertUkaiKenkinIncomeByCodeY2023Logic convertUkaiKenkinIncomeByCodeY2023Logic;
    ...
    @Test
    @Tag("TableTruncate")
    @Sql({ "convert_ukai_kenkin_income_2023.sql", "../ukai_kenkin/political_organization_property.sql" })
    void test() throws Exception { // NOPMD
        ...
        List<WkTblUkaiKenkinEntity> list = convertUkaiKenkinIncomeByCodeY2023Logic.practice(listCode, propertyEntity,
        ...
        assertEquals(2023, entity00.getHoukokuNen(), "報告年データ1");
        ...
        assertEquals(LocalDate.of(2023, 9, 30), entity00.getAccrualDateValue(), "発生日実値データ1");
        ...
        assertEquals(LocalDate.of(2023, 8, 30), entity03.getAccrualDateValue(), "発生日実値データ4");
