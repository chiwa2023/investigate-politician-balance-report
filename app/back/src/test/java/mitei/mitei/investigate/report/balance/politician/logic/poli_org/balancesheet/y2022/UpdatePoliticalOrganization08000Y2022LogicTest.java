...
/**
 * UpdatePoliticalOrganization08000Y2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePoliticalOrganization08000Y2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Transactional
    @Sql("offering_balancesheet_difficalt_0800_recipt_2022.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingBalancesheetDifficalt0800Recipt2022Entity> listPre = offeringBalancesheetDifficalt0800Recipt2022Repository
                .findByDocumentCodeOrderByOfferingBalancesheetDifficalt0800ReciptId(oldDcoumentCode);

        OfferingBalancesheetDifficalt0800Recipt2022Entity preEntity = listPre.get(0);
        ...
        int size = updatePoliticalOrganization08000Y2022Logic.practice(oldDcoumentCode, checkPrivilegeDto);
        
        List<OfferingBalancesheetDifficalt0800Recipt2022Entity> listPro = offeringBalancesheetDifficalt0800Recipt2022Repository
                .findByDocumentCodeOrderByOfferingBalancesheetDifficalt0800ReciptId(oldDcoumentCode);
        ...
        OfferingBalancesheetDifficalt0800Recipt2022Entity proEntity;
