...
/**
 * ConvertFukisaiIncomeY2024Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class ConvertFukisaiIncomeY2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("convert_income_fukisai_2024.sql")
    void testSearchCode() {
        ...
        List<WkTblFukisaiBalancesheetEntity> listEntity = convertFukisaiIncomeY2024Logic.practice(conditionDto,
                privilegeDto);
        ...
        assertEquals(LocalDate.of(2024, 7, 29), entity00.getAccrualDateValue(), "発生日実値");
    ...
    void testZero() {
        ...
        List<WkTblFukisaiBalancesheetEntity> listEntity1 = convertFukisaiIncomeY2024Logic.practice(conditionDto1,
                privilegeDto);
        ...
        List<WkTblFukisaiBalancesheetEntity> listEntity2 = convertFukisaiIncomeY2024Logic.practice(conditionDto2,
                privilegeDto);
