...
/**
 * UpdatePartyUsageShito0801And0807Y2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0801And0807Y2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("offering_party_usage_0801_and_0807_report_2022.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0801And0807Report2022Entity> listPre = offeringPartyUsage0801And0807Report2022Repository
                .findByPartyUsage0801And0807ReportCodeOrderByPartyUsage0801And0807ReportId(oldDcoumentCode);

        OfferingPartyUsage0801And0807Report2022Entity preEntity = listPre.get(0);
        ...
        int size = updatePartyUsageShito0801And0807Y2022Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingPartyUsage0801And0807Report2022Entity> listPro = offeringPartyUsage0801And0807Report2022Repository
                .findByPartyUsage0801And0807ReportCodeOrderByPartyUsage0801And0807ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0801And0807Report2022Entity proEntity;
