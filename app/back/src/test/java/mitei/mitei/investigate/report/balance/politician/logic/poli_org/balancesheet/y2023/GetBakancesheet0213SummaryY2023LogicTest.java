...
class GetBakancesheet0213SummaryY2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("keinen_henka_balancesheet_0213_summary_2023.sql")
    void test() {

        final int myYear = 2023;
        // 両方取得できた場合
        KeinenHenkaSurfaceAndSummaryByYearDto byYearDto00 = getBakancesheet0213SummaryY2023Logic.practice(4340);
        ...
        KeinenHenkaSurfaceAndSummaryByYearDto byYearDto01 = getBakancesheet0213SummaryY2023Logic.practice(8180);
        ...
        // 取得できなかった場合
        KeinenHenkaSurfaceAndSummaryByYearDto byYearDto02 = getBakancesheet0213SummaryY2023Logic.practice(499);
