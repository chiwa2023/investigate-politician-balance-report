...
/**
 * KoufukinRenketsuOutcomeItemReader単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class KoufukinRenketsuOutcomeItemReaderTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        koufukinRenketsuOutcomeItemReader.setPageSize(10);
        koufukinRenketsuOutcomeItemReader.beforeStep(this.getStepExecution());

        WkTblRenketsuKoufukinSelectDto entity = koufukinRenketsuOutcomeItemReader.read();
        assertEquals(16L, entity.getBalancesheetId());
        assertEquals(52L, entity.getUsageReportId());
    }
