...
/**
 * SearchPartyJougenByGenbunshoNameY2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class SearchPartyJougenByGenbunshoNameY2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        SearchKifuJougenMeisaiBalancesheetResultDto resultDto00 = searchPartyJougenByGenbunshoNameY2025Logic.practice(capsuleDto);
        ...
        SearchKifuJougenMeisaiBalancesheetResultDto resultDto01 = searchPartyJougenByGenbunshoNameY2025Logic.practice(capsuleDto1);
