...
class InsertPoliticalOrganizationOutcomeAllY2025LogicTest {
    ...
    void testPractice() { // NOPMD
        ...
        int size = insertPoliticalOrganizationOutcomeAllY2025Logic.practice(documentCode, documentPropertyDto, allBookDto,
