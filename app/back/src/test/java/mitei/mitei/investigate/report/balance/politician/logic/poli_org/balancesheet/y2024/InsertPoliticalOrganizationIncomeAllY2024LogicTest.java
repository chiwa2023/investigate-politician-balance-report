...
class InsertPoliticalOrganizationIncomeAllY2024LogicTest {
    ...
    void testPractice() { // NOPMD
        ...
        int size = insertPoliticalOrganizationIncomeAllY2024Logic.practice(documentCode, documentPropertyDto, allBookDto,
