...
import mitei.mitei.investigate.report.balance.politician.entity.poli_party.usage.y2023.OfferingPartyUsage0902Report2023Entity;
...
/**
 * UpdatePartyUsageShito0902Y2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0902Y2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Transactional
    @Sql("offering_party_usage_0902_report_2023.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0902Report2023Entity> listPre = offeringPartyUsage0902Report2023Repository
                .findByDocumentCodeOrderByPartyUsage0902ReportId(oldDcoumentCode);

        OfferingPartyUsage0902Report2023Entity preEntity = listPre.get(0);
        ...
        int size = updatePartyUsageShito0902Y2023Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingPartyUsage0902Report2023Entity> listPro = offeringPartyUsage0902Report2023Repository
                .findByDocumentCodeOrderByPartyUsage0902ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0902Report2023Entity proEntity;
        for (int index = 0; index < size; index++) {
            proEntity = listPro.get(index);

            // id順に取得しているのでidは一緒です
            assertThat(proEntity.getPartyUsage0902ReportId()).isEqualTo(preEntity.getPartyUsage0902ReportId());
