...
/**
 * UpdateDeleteZenginMasterFromIdoAsyncService単体テスト
 */
@SpringJUnitConfig
...
class UpdateDeleteZenginMasterFromIdoAsyncServiceTest {
    ...
    void test() {
        ...
        assertDoesNotThrow(() -> updateDeleteZenginMasterFromIdoAsyncService.practice(capsuleDto));
    }
