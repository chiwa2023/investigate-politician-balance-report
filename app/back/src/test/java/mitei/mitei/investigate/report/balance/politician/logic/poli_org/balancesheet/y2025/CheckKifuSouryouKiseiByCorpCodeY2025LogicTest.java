...
/**
 * CheckKifuSouryouKiseiByCorpCodeY2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class CheckKifuSouryouKiseiByCorpCodeY2025LogicTest {
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql({ "souryou_kisei_2025.sql", "../kifu_souryou_kisei/relation_corp.sql" })
    void test() throws Exception {
        // CHECKSTYLE:OFF

        // 政治団体区分が政党のリスト(通称A枠用)
        List<SouryouKiseiRelationCodeDto> list = checkKifuSouryouKiseiByCorpCodeY2025Logic.practice(100,
