...
/**
 * SearchPartyJougenByGenBunshoNameLogic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class SearchPartyJougenByGenBunshoNameLogicTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        SearchKifuJougenMeisaiBalancesheetResultDto resultDto0 = searchPartyJougenByGenBunshoNameLogic
                .practice(capsuleDto0);
