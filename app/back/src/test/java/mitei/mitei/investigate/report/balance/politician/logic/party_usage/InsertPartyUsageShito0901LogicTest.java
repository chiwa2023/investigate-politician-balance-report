...
import mitei.mitei.investigate.report.balance.politician.repository.poli_party.usage.y2023.OfferingPartyUsage0901Report2023Repository;
// import追加指定位置
...
class InsertPartyUsageShito0901LogicTest {
    ...
    void testPractice20251() { // NOPMD
        ...
        int size = insertPartyUsageShito0901Logic.practice(documentCode, partyUsageDocumentPoliticalPropertyDto,
                shito0901Dto, CreateTestPrivilegeDtoUtil.pracitce());

        List<OfferingPartyUsage0901Report2025Entity> list = offeringPartyUsage0901Report2025Repository
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2022/offering_party_usage_0901_report_2022.sql")
    void testPractice2022() {

        assertEquals(1L, offeringPartyUsage0901Report2022Repository.count(), "初期入力1件");
        ...
        insertPartyUsageShito0901Logic.practice(documentCode, documentlPropertyDto, new Shito0901Dto(),
                CreateTestPrivilegeDtoUtil.pracitce());

        assertEquals(2L, offeringPartyUsage0901Report2022Repository.count(), "追加で1件");
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2024/offering_party_usage_0901_report_2024.sql")
    void testPractice2024() {

        assertEquals(1L, offeringPartyUsage0901Report2024Repository.count(), "初期入力1件");
        ...
        assertEquals(2L, offeringPartyUsage0901Report2024Repository.count(), "追加で1件");
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2023/offering_party_usage_0901_report_2023.sql")
    void testPractice2023() {

        assertEquals(1L, offeringPartyUsage0901Report2023Repository.count(), "初期入力1件");
        ...
        assertEquals(2L, offeringPartyUsage0901Report2023Repository.count(), "追加で1件");
