...
@Transactional
@Sql("party_jougen.sql")
class SearchPartyJougenServiceTest {
    // CHECKSTYLE:OFF
    ...
    void testByCode() {
        ...
        SearchKifuJougenMeisaiBalancesheetResultDto resultDto0 = searchPartyJougenService.practice(capsuleDto0);
    ...
    void testByName() {
        ...
        KifuJougenConditionCapsuleDto capsuleDto0 = new KifuJougenConditionCapsuleDto();
        CreateCommonCheckDtoTestOnlyUtil.practice(capsuleDto0);
        capsuleDto0.setIsNameSearch(true); // 原文書名検索
        capsuleDto0.setPoliOrgCode(100);
        capsuleDto0.setHoukokuNen(2022);
        final int pageNum0 = 0;
        final int offset0 = 2;
