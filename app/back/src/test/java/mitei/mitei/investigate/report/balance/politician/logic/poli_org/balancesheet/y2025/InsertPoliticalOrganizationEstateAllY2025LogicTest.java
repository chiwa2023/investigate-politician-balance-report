...
class InsertPoliticalOrganizationEstateAllY2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() { // NOPMD
        ...
        int size =insertPoliticalOrganizationEstateAllY2025Logic.practice(documentCode, documentPropertyDto, allSheet0718AssetsDto, allSheet0719RealEstateDto, CreateTestPrivilegeDtoUtil.pracitce());
