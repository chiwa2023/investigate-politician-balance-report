...
/**
 * ConvertFukisaiIOutcomeY2024Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class ConvertFukisaiOutcomeY2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("convert_outcome_fukisai_2024.sql")
    void testCode() {
        ...
        List<WkTblFukisaiBalancesheetEntity> listEntity = convertFukisaiOutcomeY2024Logic.practiceCode(poliOrgCode,
        ...
        assertEquals(2024, entity00.getHoukokuNen(), "報告年");
        ...
        assertEquals(LocalDate.of(2024, 12, 9), entity00.getAccrualDateValue(), "発生日実値");
    ...
    void testName() {
        ...
        List<WkTblFukisaiBalancesheetEntity> listEntity = convertFukisaiOutcomeY2024Logic.practiceName(dantaiName,
    ...
    void testZero() {
        ...
        List<WkTblFukisaiBalancesheetEntity> listEntity1 = convertFukisaiOutcomeY2024Logic.practiceCode(poliOrgCode,
                listRelation, privilegeDto);
        ...
        List<WkTblFukisaiBalancesheetEntity> listEntity2 = convertFukisaiOutcomeY2024Logic.practiceName(dantaiName,
                listPartner, privilegeDto);
