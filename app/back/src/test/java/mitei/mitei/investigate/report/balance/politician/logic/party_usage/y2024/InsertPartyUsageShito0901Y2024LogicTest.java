...
/**
 * InsertPartyUsageShito0901Y2024Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class InsertPartyUsageShito0901Y2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() {
        ...
        int size = insertPartyUsageShito0901Y2024Logic.practice(documentCode, documentPropertyDto,
                allShitoBook.getShito0901Dto(), CreateTestPrivilegeDtoUtil.pracitce());

        List<OfferingPartyUsage0901Report2024Entity> list0901 = offeringPartyUsage0901Report2024Repository
                .findByDocumentCodeOrderByPartyUsage0901ReportId(documentCode);

        assertThat(list0901.size()).isEqualTo(size);// 2行追加

        OfferingPartyUsage0901Report2024Entity entity090101 = list0901.get(0);
        OfferingPartyUsage0901Report2024Entity entity090102 = list0901.get(1);
