...
class InsertPoliticalOrganizationEstateAllLogicTest {
    ...
    void testPractice2025() { // NOPMD
        ...
        row13.setTekiyou("摘要");
        row13.setYouto("用途");
        row13.setKankeiShiyousha("使用者との関係1");
        row13.setShiyouYouto("使用の用途1");
        row13.setShiyouMenseki("123.44");
        ...
        row14.setTekiyou("摘要");
        row14.setYouto("用途");
        row14.setKankeiShiyousha("使用者との関係2");
        row14.setShiyouYouto("使用の用途2");
        row14.setShiyouMenseki("123.43");
        ...
        row15.setTekiyou("摘要");
        row15.setYouto("用途");
        row15.setKankeiShiyousha("使用者との関係3");
        row15.setShiyouYouto("使用の用途3");
        row15.setShiyouMenseki("123.42");
        ...
        int size = insertPoliticalOrganizationEstateAllLogic.practice(documentCode, documentPropertyDto,
                allSheet0718AssetsDto, allSheet0719RealEstateDto, CreateTestPrivilegeDtoUtil.pracitce());
    ...
    void testPractice2024() { // NOPMD
        ...
        List<OfferingBalancesheet0718Estate2024Entity> listAsset = offeringBalancesheet0718Estate2024Repository
                .findByDocumentCodeOrderByOfferingBalancesheet0718EstateId(documentCode);
