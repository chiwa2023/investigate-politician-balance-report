...
/**
 * PickupIdo4FinancialOrgTenpoConfiguration単体テスト
 */
@SpringJUnitConfig
...
class PickupIdo4FinancialOrgTenpoConfigurationTest {
    // CHECKSTYLE:OFF
    ...
    @Autowired
    private Job pickupIdo4FinancialOrgTenpo;

    @Test
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(PickupIdo4FinancialOrgTenpoConfiguration.JOB_NAME, pickupIdo4FinancialOrgTenpo.getName(),
                "Job名が一致");
    }
    ...
    void test() throws Exception {
        ...
        jobLauncherTestUtils.setJob(pickupIdo4FinancialOrgTenpo);
