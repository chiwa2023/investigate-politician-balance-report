...
/**
 * CallTaskPlanByCodeUserY2024Logic単体テスト
 */
@SpringJUnitConfig
...
class CallTaskPlanByCodeUserY2024LogicTest {
    ...
    void test() {
        ...
        assertEquals(true, callTaskPlanByCodeUserY2024Logic.practice(taskPlanCode, privilegeDto.getLoginUserCode(),
                taskName, year), "正常処理");
    }
