...
/**
 * UpdatePoliticalOrganizationIncomeAllY2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePoliticalOrganizationIncomeAllY2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Transactional
    @Sql("offering_balancesheet_income_2022.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingBalancesheetIncome2022Entity> listPre = offeringBalancesheetIncome2022Repository
                .findByDocumentCodeOrderByOfferingBalancesheetIncomeId(oldDcoumentCode);

        OfferingBalancesheetIncome2022Entity preEntity = listPre.get(0);
        ...
        int size = updatePoliticalOrganizationIncomeAllY2022Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingBalancesheetIncome2022Entity> listPro = offeringBalancesheetIncome2022Repository
                .findByDocumentCodeOrderByOfferingBalancesheetIncomeId(oldDcoumentCode);
        ...
        OfferingBalancesheetIncome2022Entity proEntity;
