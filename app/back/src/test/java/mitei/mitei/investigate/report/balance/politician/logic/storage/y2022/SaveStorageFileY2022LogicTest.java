...
/**
 * SaveStorageFileY2022Logic単体テスト
 */
@SpringJUnitConfig
...
class SaveStorageFileY2022LogicTest {
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("truncate_save_file_storage_2022.sql")
    void testPractice() throws Exception {
        ...
        SaveStorageResultDto resultDto = saveStorageFileY2022Logic.practice(privilegeDto, unixTime, childDir, fileName);
        ...
        List<SaveFileStorage2022Entity> list = saveFileStorage2022Repository.findAll();
        assertEquals(1, list.size(),"");

        SaveFileStorage2022Entity entity00 = list.get(0);
