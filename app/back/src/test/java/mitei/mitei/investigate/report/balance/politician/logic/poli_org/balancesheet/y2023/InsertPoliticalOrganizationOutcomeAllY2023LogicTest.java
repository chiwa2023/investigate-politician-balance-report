...
class InsertPoliticalOrganizationOutcomeAllY2023LogicTest {
    ...
    void testPractice() { // NOPMD
        ...
        int size = insertPoliticalOrganizationOutcomeAllY2023Logic.practice(documentCode, documentPropertyDto, allBookDto,
        ...
        OfferingBalancesheetOutcome2023Entity entity1401 = list.get(0);
        ...
        /* その14区分2 */
        OfferingBalancesheetOutcome2023Entity entity1402 = list.get(1);
        // 様式区分
        ...
        /* その14区分3 */
        OfferingBalancesheetOutcome2023Entity entity1403 = list.get(2);
        // 様式区分
        ...
        /* その15区分1 */
        OfferingBalancesheetOutcome2023Entity entity1501 = list.get(3);
        // 様式区分
        ...
        /* その15区分2 */
        OfferingBalancesheetOutcome2023Entity entity1502 = list.get(4);
        // 様式区分
        ...
        /* その15区分3 */
        OfferingBalancesheetOutcome2023Entity entity1503 = list.get(5);
        // 様式区分
        ...
        /* その15区分4 */
        OfferingBalancesheetOutcome2023Entity entity1504 = list.get(6);
        // 様式区分
        ...
        /* その15区分5 */
        OfferingBalancesheetOutcome2023Entity entity1505 = list.get(7);
        // 様式区分
        ...
        /* その15区分6 */
        OfferingBalancesheetOutcome2023Entity entity1506 = list.get(8);
        // 様式区分
        ...
        /* その15区分7 */
        OfferingBalancesheetOutcome2023Entity entity1507 = list.get(9);
        // 様式区分
        ...
        /* その15区分8 */
        OfferingBalancesheetOutcome2023Entity entity1508 = list.get(10);
        // 様式区分
        ...
        /* その15区分9 */
        OfferingBalancesheetOutcome2023Entity entity1509 = list.get(11);
        // 様式区分
