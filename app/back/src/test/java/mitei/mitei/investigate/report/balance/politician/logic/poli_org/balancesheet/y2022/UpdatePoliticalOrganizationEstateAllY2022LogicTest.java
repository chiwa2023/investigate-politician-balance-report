...
/**
 * UpdatePoliticalOrganizationEstateAllY2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePoliticalOrganizationEstateAllY2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("offering_balancesheet_0718_estate_2022.sql")
    void testPractice0718() {

        Long oldDcoumentCode = 3232L;

        List<OfferingBalancesheet0718Estate2022Entity> listPre = offeringBalancesheet0718Estate2022Repository
                .findByDocumentCodeOrderByOfferingBalancesheet0718EstateId(oldDcoumentCode);

        OfferingBalancesheet0718Estate2022Entity preEntity = listPre.get(0);
        ...
        int size = updatePoliticalOrganizationEstateAllY2022Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingBalancesheet0718Estate2022Entity> listPro = offeringBalancesheet0718Estate2022Repository
                .findByDocumentCodeOrderByOfferingBalancesheet0718EstateId(oldDcoumentCode);
        ...
        OfferingBalancesheet0718Estate2022Entity proEntity;
    ...
    @Test
    @Transactional
    @Sql("offering_balancesheet_0719_real_estate_2022.sql")
    void testPractice0719() {

        Long oldDcoumentCode = 3232L;

        List<OfferingBalancesheet0719RealEstate2022Entity> listPre = offeringBalancesheet0719RealEstate2022Repository
                .findByDocumentCodeOrderByOfferingBalancesheet0719RealEstateId(oldDcoumentCode);

        OfferingBalancesheet0719RealEstate2022Entity preEntity = listPre.get(0);
        ...
        List<OfferingBalancesheet0719RealEstate2022Entity> listPro = offeringBalancesheet0719RealEstate2022Repository
                .findByDocumentCodeOrderByOfferingBalancesheet0719RealEstateId(oldDcoumentCode);
        ...
        OfferingBalancesheet0719RealEstate2022Entity proEntity;
        for (int index = 0; index < size; index++) {
            preEntity = listPre.get(index);
            proEntity = listPro.get(index);
