...
/**
 * NaturalAllSentenceSearchY2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class NaturalAllSentenceSearchY2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() {
        ...
        searchConditionDto.setSearchWords("+テストデータ検索2022"); // 検索語フォーマットはこのLogicの前段階で編集しているので、検索語そのものを入れる
        ...
        IncomeAndOutcomeNaturalSearchResultDto searchResultDto = naturalAllSentenceSearchY2022Logic
        ...
        assertThat(dtoIncome1.getItemId()).isEqualTo("2022-883-7-1-12");
        ...
        assertThat(dtoOutcome1.getItemId()).isEqualTo("2022-883-15-8-11");
