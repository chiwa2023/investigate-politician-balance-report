...
/**
 * InsertPartyUsageShito0901Y2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class InsertPartyUsageShito0901Y2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() {
        ...
        int size = insertPartyUsageShito0901Y2025Logic.practice(documentCode, documentPropertyDto,
