...
class InsertPoliticalOrganizationIncomeAllY2025LogicTest {
    ...
    void testPractice() { // NOPMD
        ...
        int size = insertPoliticalOrganizationIncomeAllY2025Logic.practice(documentCode, documentPropertyDto, allBookDto,
