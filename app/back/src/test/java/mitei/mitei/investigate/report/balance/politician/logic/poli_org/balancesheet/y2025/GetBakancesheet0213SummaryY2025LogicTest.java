...
class GetBakancesheet0213SummaryY2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("keinen_henka_balancesheet_0213_summary_2025.sql")
    void test() {

        final int myYear = 2025;
        // 両方取得できた場合
        KeinenHenkaSurfaceAndSummaryByYearDto byYearDto00 = getBakancesheet0213SummaryY2025Logic.practice(4340);
        ...
        KeinenHenkaSurfaceAndSummaryByYearDto byYearDto01 = getBakancesheet0213SummaryY2025Logic.practice(8180);
        ...
        // 取得できなかった場合
        KeinenHenkaSurfaceAndSummaryByYearDto byYearDto02 = getBakancesheet0213SummaryY2025Logic.practice(499);
