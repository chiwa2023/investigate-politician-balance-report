...
/**
 * CallTaskPlanByCodeUserY2025Logic単体テスト
 */
@SpringJUnitConfig
...
class CallTaskPlanByCodeUserY2025LogicTest {
    ...
    void test() {
        ...
        assertEquals(true, callTaskPlanByCodeUserY2025Logic.practice(taskPlanCode, privilegeDto.getLoginUserCode(),
                taskName, year), "正常処理");
    }
