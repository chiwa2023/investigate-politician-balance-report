...
/**
 * SearchPartyJougenY2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class SearchPartyJougenByCodeY2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        SearchKifuJougenMeisaiBalancesheetResultDto resultDto00 = searchPartyJougenByCodeY2025Logic.practice(capsuleDto);
        ...
        SearchKifuJougenMeisaiBalancesheetResultDto resultDto01 = searchPartyJougenByCodeY2025Logic.practice(capsuleDto1);
