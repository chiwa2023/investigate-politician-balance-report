...
/**
 * InsertPartyUsageShito0902Y2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class InsertPartyUsageShito0902Y2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() {
        ...
        int size = insertPartyUsageShito0902Y2023Logic.practice(documentCode, documentPropertyDto,
                allShitoBook.getShito0902Dto(), CreateTestPrivilegeDtoUtil.pracitce());

        List<OfferingPartyUsage0902Report2023Entity> listSearch = offeringPartyUsage0902Report2023Repository
        ...
        // 2件入力したので2件取れます
        OfferingPartyUsage0902Report2023Entity entity090201 = listSearch.get(0);
        OfferingPartyUsage0902Report2023Entity entity090202 = listSearch.get(1);
