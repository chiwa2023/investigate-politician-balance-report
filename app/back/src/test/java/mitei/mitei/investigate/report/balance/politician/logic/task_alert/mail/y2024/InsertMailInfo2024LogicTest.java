...
/**
 * InsertMailInfo2024Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class InsertMailInfo2024LogicTest {
    ...
    void testPractice() throws Exception { // NOPMD
        ...
        LocalDateTime shori = LocalDateTime.of(2024, 5, 22, 11, 22, 33);

        int size = insertMailInfo2024Logic.practice(privilegeDto, shori, userEntiy, listTask);

        assertThat(size).isEqualTo(2); // Taskを2件設定したので2行

        List<SendAlertMail2024Entity> listAlert = sendAlertMail2024Repository.findAll();
        ...
        SendAlertMail2024Entity result00 = listAlert.get(0);
        ...
        SendAlertMail2024Entity result01 = listAlert.get(1);
