...
/**
 * UpdatePoliticalOrganization08000Y2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePoliticalOrganization08000Y2023LogicTest {
    // CHECKSTYLE:OFF
    
    /** テスト対象 */
    @Autowired
    private UpdatePoliticalOrganization08000Y2023Logic updatePoliticalOrganization08000Y2023Logic;
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("offering_balancesheet_difficalt_0800_recipt_2023.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingBalancesheetDifficalt0800Recipt2023Entity> listPre = offeringBalancesheetDifficalt0800Recipt2023Repository
                .findByDocumentCodeOrderByOfferingBalancesheetDifficalt0800ReciptId(oldDcoumentCode);

        OfferingBalancesheetDifficalt0800Recipt2023Entity preEntity = listPre.get(0);
        ...
        int size = updatePoliticalOrganization08000Y2023Logic.practice(oldDcoumentCode, checkPrivilegeDto);
        
        List<OfferingBalancesheetDifficalt0800Recipt2023Entity> listPro = offeringBalancesheetDifficalt0800Recipt2023Repository
                .findByDocumentCodeOrderByOfferingBalancesheetDifficalt0800ReciptId(oldDcoumentCode);
        ...
        OfferingBalancesheetDifficalt0800Recipt2023Entity proEntity;
