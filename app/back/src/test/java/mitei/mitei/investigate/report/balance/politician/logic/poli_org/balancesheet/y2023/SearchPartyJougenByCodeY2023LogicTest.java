...
/**
 * SearchPartyJougenY2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class SearchPartyJougenByCodeY2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        SearchKifuJougenMeisaiBalancesheetResultDto resultDto00 = searchPartyJougenByCodeY2023Logic.practice(capsuleDto);
        ...
        SearchKifuJougenMeisaiBalancesheetResultDto resultDto01 = searchPartyJougenByCodeY2023Logic.practice(capsuleDto1);
