...
/**
 * CheckDonationKobetsuKiseiUpperLimitController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
@Sql("../../service/kifu_jogen/kobetsu_kisei_2022.sql")
class CheckDonationKobetsuKiseiUpperLimitControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test()throws Exception {
        ...
        capsuleDto.setPoliOrgCode(101);
        capsuleDto.setIsNameSearch(false);
        
        ObjectMapper objectMapper = GetObjectMapperWithTimeModuleUtil.practice();

        String path = "/kifu-jougen/kobetsu-search";
