...
/**
 * CopyFinancialOrgWkTbl4BatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
class CopyFinancialOrgWkTbl4BatchConfigurationTest {
    // CHECKSTYLE:OFF
    ...
    @Autowired
    private Job copyFinancialOrgWkTbl4;

    @Test
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(CopyFinancialOrgWkTbl4BatchConfiguration.JOB_NAME, copyFinancialOrgWkTbl4.getName(), "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(copyFinancialOrgWkTbl4);
