...
/**
 * ConvertFukisaiIOutcomeY2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class ConvertFukisaiOutcomeY2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("convert_outcome_fukisai_2023.sql")
    void testCode() {
        ...
        List<WkTblFukisaiBalancesheetEntity> listEntity = convertFukisaiOutcomeY2023Logic.practiceCode(poliOrgCode,
        ...
        assertEquals(2023, entity00.getHoukokuNen(), "報告年");
        ...
        assertEquals(LocalDate.of(2023, 12, 9), entity00.getAccrualDateValue(), "発生日実値");
    ...
    void testName() {
        ...
        List<WkTblFukisaiBalancesheetEntity> listEntity = convertFukisaiOutcomeY2023Logic.practiceName(dantaiName,
    ...
    void testZero() {
        ...
        List<WkTblFukisaiBalancesheetEntity> listEntity1 = convertFukisaiOutcomeY2023Logic.practiceCode(poliOrgCode,
                listRelation, privilegeDto);
        ...
        List<WkTblFukisaiBalancesheetEntity> listEntity2 = convertFukisaiOutcomeY2023Logic.practiceName(dantaiName,
                listPartner, privilegeDto);
