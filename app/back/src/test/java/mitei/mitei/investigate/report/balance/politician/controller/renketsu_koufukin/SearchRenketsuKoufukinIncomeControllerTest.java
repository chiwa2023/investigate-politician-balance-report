...
/**
 * SearchRenketsuKoufukinIncomeController単体テスト
 */
@SpringJUnitConfig
...
class SearchRenketsuKoufukinIncomeControllerTest {
    // CHECKSTYLE:OFF
    ...
    @Sql({ "../../service/renketsu_koufukin/wktbl_renketsu_koufukin.sql",
            "../../service/renketsu_koufukin/wktbl_usage_income.sql" })
    void test() throws Exception {
        ...
        String url = "/renketsu-koufukin/income";
