...
/**
 * UkaiKenkinRouteByStage03BatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
class UkaiKenkinRouteByStage03BatchConfigurationTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(UkaiKenkinRouteByStage03BatchConfiguration.JOB_NAME, ukaiKenkinRouteByStage03.getName(),
                "Job名が一致");
    }
    ...
    void test() throws Exception { // NOPMD
        ...
        jobLauncherTestUtils.setJob(ukaiKenkinRouteByStage03);
        ...
        assertEquals(38, listOption.size(), "37経路取得できた");
        ...
        /* 個人迂回階層 */
        // 経路22(個人迂回1階層)
        SelectOptionDto dto22 = listOption.get(10);
        ...
        // 経路23(個人迂回2階層)
        SelectOptionDto dto23 = listOption.get(11);
        ...
        // 経路24(個人迂回3階層)
        SelectOptionDto dto24 = listOption.get(12);
        ...
        /* 企業迂回階層 */
        // 経路31(企業迂回1階層)
        SelectOptionDto dto31 = listOption.get(13);
        ...
        // 経路32(企業迂回2階層)
        SelectOptionDto dto32 = listOption.get(14);
        ...
        // 経路33(企業迂回3階層)
        SelectOptionDto dto33 = listOption.get(15);
        ...
        /* 政治団体迂回階層 */
        // 経路40(政治団体迂回1階層)
        SelectOptionDto dto40 = listOption.get(16);
        ...
        // 経路41(政治団体迂回2階層)
        SelectOptionDto dto41 = listOption.get(17);
        ...
        // 経路42(政治団体迂回3階層)
        SelectOptionDto dto42 = listOption.get(18);
        ...
        SelectOptionDto dto49 = listOption.get(19);
        ...
        /* 個人迂回階層 */
        // 経路50(個人迂回1階層)
        SelectOptionDto dto50 = listOption.get(20);
        ...
        // 経路51(個人迂回1階層)
        SelectOptionDto dto51 = listOption.get(21);
        ...
        // 経路52(2階層個人から企業代表者)
        SelectOptionDto dto52 = listOption.get(22);
        ...
        // 経路7(2階層個人から政治団体関連者)
        SelectOptionDto dto53 = listOption.get(23);
        ...
        // 経路8(3階層個人から企業代表者)
        SelectOptionDto dto54 = listOption.get(24);
        ...
        // 経路55(3階層個人から政治団体関連者)
        SelectOptionDto dto55 = listOption.get(25);
        ...
        /* 企業代表者迂回階層 */
        // 経路68(個人迂回1階層)
        SelectOptionDto dto68 = listOption.get(26);
        ...
        // 経路69(個人迂回1階層)
        SelectOptionDto dto69 = listOption.get(27);
        ...
        // 経路70(個人迂回1階層)
        SelectOptionDto dto70 = listOption.get(28);
        ...
        // 経路71(2階層個人から企業代表者)
        SelectOptionDto dto71 = listOption.get(29);
        ...
        // 経路7(2階層個人から政治団体関連者)
        SelectOptionDto dto72 = listOption.get(30);
        ...
        // 経路8(3階層個人から企業代表者)
        SelectOptionDto dto73 = listOption.get(31);
        ...
        // 経路74(3階層個人から政治団体関連者)
        SelectOptionDto dto74 = listOption.get(32);
        ...
        // 経路87(企業代表者と企業代表者
        SelectOptionDto dto97 = listOption.get(33);
        ...
        // 経路87(政治団体迂回1階層)
        SelectOptionDto dto87 = listOption.get(34);
        ...
        // 経路88(政治団体迂回1階層)
        SelectOptionDto dto88 = listOption.get(35);
        ...
        // 経路89(政治団体迂回2階層)
        SelectOptionDto dto89 = listOption.get(36);
        ...
        // 経路90(政治団体迂回3階層)
        SelectOptionDto dto90 = listOption.get(37);
