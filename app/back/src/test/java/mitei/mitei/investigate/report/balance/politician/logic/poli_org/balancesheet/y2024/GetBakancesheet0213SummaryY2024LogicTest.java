...
class GetBakancesheet0213SummaryY2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("keinen_henka_balancesheet_0213_summary_2024.sql")
    void test() {

        final int myYear = 2024;
        // 両方取得できた場合
        KeinenHenkaSurfaceAndSummaryByYearDto byYearDto00 = getBakancesheet0213SummaryY2024Logic.practice(4340);
        ...
        KeinenHenkaSurfaceAndSummaryByYearDto byYearDto01 = getBakancesheet0213SummaryY2024Logic.practice(8180);
        ...
        // 取得できなかった場合
        KeinenHenkaSurfaceAndSummaryByYearDto byYearDto02 = getBakancesheet0213SummaryY2024Logic.practice(499);
