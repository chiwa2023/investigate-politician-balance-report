...
class InsertPoliticalOrganization08000LogicTest {
    ...
    void testPractice2024() {
        ...
        documentPropertyDto
                .setOfferingDate(dateConvertUtil.practiceWarekiToLocalDate("R4/12/8")); // 実際には宣誓書からコピー
        ...
        int size = insertPoliticalOrganization08000Logic.practice(documentCode, documentPropertyDto, allSheet0800DifficultCollectReceiptDto, CreateTestPrivilegeDtoUtil.pracitce());
        List<OfferingBalancesheetDifficalt0800Recipt2024Entity> list = offeringBalancesheetDifficalt0800Recipt2024Repository.findByDocumentCodeOrderByOfferingBalancesheetDifficalt0800ReciptId(documentCode);
    ...
    void testPractice2025() {
        ...
        int size = insertPoliticalOrganization08000Logic.practice(documentCode, documentPropertyDto, allSheet0800DifficultCollectReceiptDto, CreateTestPrivilegeDtoUtil.pracitce());
        List<OfferingBalancesheetDifficalt0800Recipt2025Entity> list = offeringBalancesheetDifficalt0800Recipt2025Repository.findByDocumentCodeOrderByOfferingBalancesheetDifficalt0800ReciptId(documentCode);
        
        // 取得データは1件
        assertThat(size).isEqualTo(1);
        assertThat(list.size()).isEqualTo(size);

        OfferingBalancesheetDifficalt0800Recipt2025Entity entity = list.get(0);
