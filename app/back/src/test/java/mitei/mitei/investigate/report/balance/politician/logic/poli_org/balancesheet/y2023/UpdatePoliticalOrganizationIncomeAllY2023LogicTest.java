...
/**
 * UpdatePoliticalOrganizationIncomeAllY2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePoliticalOrganizationIncomeAllY2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("offering_balancesheet_income_2023.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingBalancesheetIncome2023Entity> listPre = offeringBalancesheetIncome2023Repository
                .findByDocumentCodeOrderByOfferingBalancesheetIncomeId(oldDcoumentCode);

        OfferingBalancesheetIncome2023Entity preEntity = listPre.get(0);
        ...
        int size = updatePoliticalOrganizationIncomeAllY2023Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingBalancesheetIncome2023Entity> listPro = offeringBalancesheetIncome2023Repository
                .findByDocumentCodeOrderByOfferingBalancesheetIncomeId(oldDcoumentCode);
        ...
        OfferingBalancesheetIncome2023Entity proEntity;
