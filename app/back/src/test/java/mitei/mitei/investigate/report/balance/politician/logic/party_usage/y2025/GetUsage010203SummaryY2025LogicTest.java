...
/**
 * GetUsage010203SummaryY2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class GetUsage010203SummaryY2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Transactional
    @Tag("TableTruncate")
    @Sql({"usage_0107_surface_2025.sql","usage_0203_summary_2025.sql"})
    void test() {

        // データが表紙・集計とも存在しない
        Integer poliOrgCode0 = 999;
        final int year = 2025;
        KeinenUsageSurface02103SummaryByYearDto dto0 = getUsage010203SummaryY2025Logic.practice(poliOrgCode0);
        assertNotNull(dto0);
        ...
        KeinenUsageSurface02103SummaryByYearDto dto1 = getUsage010203SummaryY2025Logic.practice(poliOrgCode1);
        assertNotNull(dto1);
        ...
        KeinenUsageSurface02103SummaryByYearDto dto2 = getUsage010203SummaryY2025Logic.practice(poliOrgCode2);
        assertNotNull(dto2);
        ...
        KeinenUsageSurface02103SummaryByYearDto dto3 = getUsage010203SummaryY2025Logic.practice(poliOrgCode3);
        assertNotNull(dto3);
