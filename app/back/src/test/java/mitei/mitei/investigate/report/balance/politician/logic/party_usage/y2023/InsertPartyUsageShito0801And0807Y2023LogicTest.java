...
/**
 * InsertPartyUsageShito0801And0807Y2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class InsertPartyUsageShito0801And0807Y2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() { // NOPMD
        ...
        createTestDataPartyUsageShito0801And0807Logic.practice(2023, allShitoBook);

        // 政治団体基礎情報
        PartyUsageDocumentPoliticalPropertyDto documentPropertyDto = new PartyUsageDocumentPoliticalPropertyDto();
        documentPropertyDto.setNendo(2023); // 実際には表紙からコピー
        ...
        Long code = insertPartyUsageShito0801And0807Y2023Logic.practice(documentPropertyDto, allShitoBook,
                CreateTestPrivilegeDtoUtil.pracitce());

        List<OfferingPartyUsage0801And0807Report2023Entity> list = offeringPartyUsage0801And0807Report2023Repository
        ...
        OfferingPartyUsage0801And0807Report2023Entity entityRecord = list.get(0);
