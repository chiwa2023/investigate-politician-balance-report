...
/**
 * UpdatePartyUsageShito0902Y2024Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0902Y2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Transactional
    @Tag("TableTruncate")
    @Sql("offering_party_usage_0902_report_2024.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0902Report2024Entity> listPre = offeringPartyUsage0902Report2024Repository
                .findByDocumentCodeOrderByPartyUsage0902ReportId(oldDcoumentCode);

        OfferingPartyUsage0902Report2024Entity preEntity = listPre.get(0);
        ...
        List<OfferingPartyUsage0902Report2024Entity> listPro = offeringPartyUsage0902Report2024Repository
                .findByDocumentCodeOrderByPartyUsage0902ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0902Report2024Entity proEntity;
