...
/**
 * UpdatePartyUsageShito0806Y2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0806Y2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Transactional
    @Sql("offering_party_usage_0806_report_2022.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0806Report2022Entity> listPre = offeringPartyUsage0806Report2022Repository
                .findByDocumentCodeOrderByPartyUsage0806ReportId(oldDcoumentCode);

        OfferingPartyUsage0806Report2022Entity preEntity = listPre.get(0);
        ...
        int size = updatePartyUsageShito0806Y2022Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingPartyUsage0806Report2022Entity> listPro = offeringPartyUsage0806Report2022Repository
                .findByDocumentCodeOrderByPartyUsage0806ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0806Report2022Entity proEntity;
