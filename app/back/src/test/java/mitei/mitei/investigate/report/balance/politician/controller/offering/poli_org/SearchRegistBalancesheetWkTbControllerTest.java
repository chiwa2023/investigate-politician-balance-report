...
/**
 * SearchRegistBalancesheetWkTbController単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class SearchRegistBalancesheetWkTbControllerTest {
    ...
    void testPractice() throws Exception {
        ...
        String path = "http://localhost:9080/listup-balancesheet-poli-org/normal";
