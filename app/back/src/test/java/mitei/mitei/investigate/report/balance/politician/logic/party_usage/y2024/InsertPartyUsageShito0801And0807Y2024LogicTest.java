...
class InsertPartyUsageShito0801And0807Y2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() { // NOPMD
        ...
        createTestDataPartyUsageShito0801And0807Logic.practice(2024, allShitoBook);

        // 政治団体基礎情報
        PartyUsageDocumentPoliticalPropertyDto documentPropertyDto = new PartyUsageDocumentPoliticalPropertyDto();
        documentPropertyDto.setNendo(2024); // 実際には表紙からコピー
        ...
        Long code = insertPartyUsageShito0801And0807Y2024Logic.practice(documentPropertyDto, allShitoBook,
                CreateTestPrivilegeDtoUtil.pracitce());

        List<OfferingPartyUsage0801And0807Report2024Entity> list = offeringPartyUsage0801And0807Report2024Repository
        ...
        OfferingPartyUsage0801And0807Report2024Entity entityRecord = list.get(0);
