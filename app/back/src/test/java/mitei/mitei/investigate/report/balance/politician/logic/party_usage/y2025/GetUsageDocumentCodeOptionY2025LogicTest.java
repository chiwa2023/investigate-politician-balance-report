...
/**
 * GetUsageDocumentCodeOptionY2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class GetUsageDocumentCodeOptionY2025LogicTest {
    // CHECKSTYLE:OFF

    /** テスト対象 */
    @Autowired
    private GetUsageDocumentCodeOptionY2025Logic getUsageDocumentCodeOptionY2025Logic;
    
    @Test
    @Tag("TableTruncate")
    @Transactional
    @Sql("usage_option_2025.sql")
    void test() {

        final int poliOrgCode = 9890;

        List<SelectOptionDto> listOption = getUsageDocumentCodeOptionY2025Logic.practice(poliOrgCode);
