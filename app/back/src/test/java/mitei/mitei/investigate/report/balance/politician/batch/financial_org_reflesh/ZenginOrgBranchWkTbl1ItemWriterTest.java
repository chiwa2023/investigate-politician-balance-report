...
/**
 * ZenginOrgBranchWkTbl1ItemWriter単体テスト
 */
@SpringJUnitConfig
...
class ZenginOrgBranchWkTbl1ItemWriterTest {
    ...
    void test() throws Exception { // NOPMD
        ...
        ZenginOrgBranchWk1Entity entity02 = new ZenginOrgBranchWk1Entity();
        ...
        List<ZenginOrgBranchWk1Entity> list = new ArrayList<>();
        list.add(entity01);
        list.add(entity02);

        // Chunkを作成してセット
        Chunk<? extends ZenginOrgBranchWk1Entity> items = new Chunk<>(list);
        zenginOrgBranchWkTbl1ItemWriter.write(items);

        List<ZenginOrgBranchWk1Entity> listAnswer = zenginOrgBranchWk1Repository.findAll();
        assertEquals(2, listAnswer.size(), "2件登録して件取得");
        listAnswer.sort((e1, e2) -> e1.getZenginOrgBranchWk1Code() - e2.getZenginOrgBranchWk1Code());

        ZenginOrgBranchWk1Entity answerEntity00 = listAnswer.get(0);
        ...
        ZenginOrgBranchWk1Entity answerEntity01 = listAnswer.get(1);
