...
/**
 * UpdatePartyUsageShito0901Y2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0901Y2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("offering_party_usage_0901_report_2025.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0901Report2025Entity> listPre = offeringPartyUsage0901Report2025Repository
                .findByDocumentCodeOrderByPartyUsage0901ReportId(oldDcoumentCode);

        OfferingPartyUsage0901Report2025Entity preEntity = listPre.get(0);
        ...
        int size = updatePartyUsageShito0901Y2025Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingPartyUsage0901Report2025Entity> listPro = offeringPartyUsage0901Report2025Repository
                .findByDocumentCodeOrderByPartyUsage0901ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0901Report2025Entity proEntity;
