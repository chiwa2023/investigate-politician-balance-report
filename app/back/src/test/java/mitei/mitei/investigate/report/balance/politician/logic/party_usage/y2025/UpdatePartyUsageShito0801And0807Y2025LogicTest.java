...
/**
 * UpdatePartyUsageShito0801And0807Y2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0801And0807Y2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("offering_party_usage_0801_and_0807_report_2025.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0801And0807Report2025Entity> listPre = offeringPartyUsage0801And0807Report2025Repository
                .findByPartyUsage0801And0807ReportCodeOrderByPartyUsage0801And0807ReportId(oldDcoumentCode);

        OfferingPartyUsage0801And0807Report2025Entity preEntity = listPre.get(0);
        ...
        int size = updatePartyUsageShito0801And0807Y2025Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingPartyUsage0801And0807Report2025Entity> listPro = offeringPartyUsage0801And0807Report2025Repository
                .findByPartyUsage0801And0807ReportCodeOrderByPartyUsage0801And0807ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0801And0807Report2025Entity proEntity;
