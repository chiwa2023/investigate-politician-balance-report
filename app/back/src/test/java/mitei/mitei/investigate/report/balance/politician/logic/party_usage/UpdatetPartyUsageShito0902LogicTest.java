...
class UpdatetPartyUsageShito0902LogicTest {
    ...
    void testPractice2022() {
        ...
        updatetPartyUsageShito0902Logic.practice(houkokuNen, documentCode, CreateTestPrivilegeDtoUtil.pracitce());

        assertEquals(1L, offeringPartyUsage0902Report2022Repository.count(), "最新データの積み上げは別ロジックでしているので1件のまま");
    ...
    void testPractice2024() {
        ...
        assertEquals(1L, offeringPartyUsage0902Report2024Repository.count(), "最新データの積み上げは別ロジックでしているので1件のまま");
    ...
    void testPractice2023() {
        ...
        assertEquals(1L, offeringPartyUsage0902Report2023Repository.count(), "最新データの積み上げは別ロジックでしているので1件のまま");
