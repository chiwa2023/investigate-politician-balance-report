...
/**
 * UpdatePartyUsageShito0806Y2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0806Y2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Transactional
    @Sql("offering_party_usage_0806_report_2023.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0806Report2023Entity> listPre = offeringPartyUsage0806Report2023Repository
                .findByDocumentCodeOrderByPartyUsage0806ReportId(oldDcoumentCode);

        OfferingPartyUsage0806Report2023Entity preEntity = listPre.get(0);
        ...
        int size = updatePartyUsageShito0806Y2023Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingPartyUsage0806Report2023Entity> listPro = offeringPartyUsage0806Report2023Repository
                .findByDocumentCodeOrderByPartyUsage0806ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0806Report2023Entity proEntity;
