...
/**
 * GetSameRelationPersonPoliOrgByCodeY2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class GetRelationPersonPoliOrgByCodeY2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Tag("TableTruncate")
    @Sql({ "offering_balancesheet_0701_and_0720_surface_ukai_2022.sql",
            "../ukai_kenkin/political_organization_property.sql" })
    void test() throws Exception {

        assertThrows(EmptyResultDataAccessException.class,
                () -> getRelationPersonPoliOrgByCodeY2022Logic.practice(9999), "表紙からidが取得できない");

        assertThrows(EmptyResultDataAccessException.class,
                () -> getRelationPersonPoliOrgByCodeY2022Logic.practice(430), "団体属性から関連者が取得できない");

        PoliticalOrganizationPropertyEntity entity = getRelationPersonPoliOrgByCodeY2022Logic.practice(100);
