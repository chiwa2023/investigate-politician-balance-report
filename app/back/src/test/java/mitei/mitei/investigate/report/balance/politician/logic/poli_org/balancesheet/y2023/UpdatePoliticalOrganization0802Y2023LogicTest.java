...
/**
 * UpdatePoliticalOrganization0802Y2023Logic単体テスト
 * 
 */
@SpringJUnitConfig
...
class UpdatePoliticalOrganization0802Y2023LogicTest {
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("offering_balancesheet_withdrawal_0802_transfer_2023.sql")
    void testPractice() {
        Long oldDcoumentCode = 3232L;

        List<OfferingBalancesheetWithdrawal0802Transfer2023Entity> listPre = offeringBalancesheetWithdrawal0802Transfer2023Repository
                .findByDocumentCodeOrderByOfferingBalancesheetWithdrawal0802TransferId(oldDcoumentCode);

        OfferingBalancesheetWithdrawal0802Transfer2023Entity preEntity = listPre.get(0);
        ...
        int size = updatePoliticalOrganization0802Y2023Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingBalancesheetWithdrawal0802Transfer2023Entity> listPro = offeringBalancesheetWithdrawal0802Transfer2023Repository
                .findByDocumentCodeOrderByOfferingBalancesheetWithdrawal0802TransferId(oldDcoumentCode);
        ...
        OfferingBalancesheetWithdrawal0802Transfer2023Entity proEntity;
