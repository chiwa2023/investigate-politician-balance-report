...
/**
 * GetBothDocumentCodeOptionController単体テスト
 */
@SpringJUnitConfig
...
class GetBothDocumentCodeOptionControllerTest {
    // CHECKSTYLE:OFF
    ...
    @Transactional
    @Tag("TableTruncate")
    @Sql({ "../../service/renketsu_koufukin/balance_option_2022.sql",
            "../../service/renketsu_koufukin/usage_option_2022.sql" })
    void test() throws Exception {
        ...
        String url = "/renketsu-koufukin/get-document-code";
