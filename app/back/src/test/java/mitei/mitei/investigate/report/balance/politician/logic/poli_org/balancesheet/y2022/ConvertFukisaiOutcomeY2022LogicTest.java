...
/**
 * ConvertFukisaiIOutcomeY2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class ConvertFukisaiOutcomeY2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("convert_outcome_fukisai_2022.sql")
    void testCode() {
        ...
        List<WkTblFukisaiBalancesheetEntity> listEntity = convertFukisaiOutcomeY2022Logic.practiceCode(poliOrgCode,
    ...
    void testName() {
        ...
        List<WkTblFukisaiBalancesheetEntity> listEntity = convertFukisaiOutcomeY2022Logic.practiceName(dantaiName,
    ...
    void testZero() {
        ...
        List<WkTblFukisaiBalancesheetEntity> listEntity1 = convertFukisaiOutcomeY2022Logic.practiceCode(poliOrgCode,
                listRelation, privilegeDto);
        ...
        List<WkTblFukisaiBalancesheetEntity> listEntity2 = convertFukisaiOutcomeY2022Logic.practiceName(dantaiName,
                listPartner, privilegeDto);
