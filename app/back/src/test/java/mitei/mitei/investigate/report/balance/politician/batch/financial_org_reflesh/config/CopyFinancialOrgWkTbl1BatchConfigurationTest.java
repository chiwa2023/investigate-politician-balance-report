...
/**
 * CopyFinancialOrgWkTbl1BatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
class CopyFinancialOrgWkTbl1BatchConfigurationTest {
    // CHECKSTYLE:OFF
    ...
    @Autowired
    private Job copyFinancialOrgWkTbl1;

    @Test
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(CopyFinancialOrgWkTbl1BatchConfiguration.JOB_NAME, copyFinancialOrgWkTbl1.getName(), "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(copyFinancialOrgWkTbl1);
