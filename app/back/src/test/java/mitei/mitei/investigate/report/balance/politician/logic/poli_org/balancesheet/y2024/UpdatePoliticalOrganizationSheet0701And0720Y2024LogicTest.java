...
/**
 * UpdatetPoliticalOrganizationSheet0701And0720Y2024Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePoliticalOrganizationSheet0701And0720Y2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Transactional
    @Sql("offering_balancesheet_0701_and_0720_surface_2024.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingBalancesheet0701And0720Surface2024Entity> listPre = offeringBalancesheet0701And0720Surface2024Repository
                .findByOfferingBalancesheet0701And0720SurfaceCodeOrderByOfferingBalancesheet0701And0720SurfaceId(
                        oldDcoumentCode);

        OfferingBalancesheet0701And0720Surface2024Entity preEntity = listPre.get(0);
        ...
        int size = updatetPoliticalOrganizationSheet0701And0720Y2024Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingBalancesheet0701And0720Surface2024Entity> listPro = offeringBalancesheet0701And0720Surface2024Repository
                .findByOfferingBalancesheet0701And0720SurfaceCodeOrderByOfferingBalancesheet0701And0720SurfaceId(
                        oldDcoumentCode);
        ...
        OfferingBalancesheet0701And0720Surface2024Entity proEntity;
