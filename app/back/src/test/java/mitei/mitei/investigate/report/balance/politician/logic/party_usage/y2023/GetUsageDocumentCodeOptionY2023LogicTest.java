...
/**
 * GetUsageDocumentCodeOptionY2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class GetUsageDocumentCodeOptionY2023LogicTest {
    // CHECKSTYLE:OFF

    /** テスト対象 */
    @Autowired
    private GetUsageDocumentCodeOptionY2023Logic getUsageDocumentCodeOptionY2023Logic;
    
    @Test
    @Tag("TableTruncate")
    @Transactional
    @Sql("usage_option_2023.sql")
    void test() {

        final int poliOrgCode = 9890;

        List<SelectOptionDto> listOption = getUsageDocumentCodeOptionY2023Logic.practice(poliOrgCode);
