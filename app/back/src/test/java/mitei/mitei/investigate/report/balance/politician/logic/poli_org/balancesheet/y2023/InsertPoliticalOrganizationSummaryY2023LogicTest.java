...
class InsertPoliticalOrganizationSummaryY2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() { // NOPMD
        ...
        // 登録作業
        int size = insertPoliticalOrganizationSummaryY2023Logic.practice(documentCode, documentPropertyDto,
        ...
        List<OfferingBalancesheet0702And0713And0717Summary2023Entity> list = offeringBalancesheet0702And0713And0717Summary2023Repository
        ...
        OfferingBalancesheet0702And0713And0717Summary2023Entity entitySummary = list.get(0);
