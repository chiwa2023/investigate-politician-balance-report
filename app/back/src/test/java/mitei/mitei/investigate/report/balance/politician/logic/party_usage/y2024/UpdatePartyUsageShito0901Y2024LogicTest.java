...
/**
 * UpdatePartyUsageShito0901Y2024Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0901Y2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Transactional
    @Sql("offering_party_usage_0901_report_2024.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0901Report2024Entity> listPre = offeringPartyUsage0901Report2024Repository
                .findByDocumentCodeOrderByPartyUsage0901ReportId(oldDcoumentCode);

        OfferingPartyUsage0901Report2024Entity preEntity = listPre.get(0);
        ...
        int size = updatePartyUsageShito0901Y2024Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingPartyUsage0901Report2024Entity> listPro = offeringPartyUsage0901Report2024Repository
                .findByDocumentCodeOrderByPartyUsage0901ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0901Report2024Entity proEntity;
