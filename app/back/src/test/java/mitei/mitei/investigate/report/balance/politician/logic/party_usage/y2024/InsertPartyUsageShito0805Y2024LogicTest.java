...
/**
 * InsertPartyUsageShito0805Y2024Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class InsertPartyUsageShito0805Y2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() {
        ...
        int size = insertPartyUsageShito0805Y2024Logic.practice(documentCode, documentPropertyDto, allShitoBook.getShito0805Dto(), CreateTestPrivilegeDtoUtil.pracitce());
        
        List<OfferingPartyUsage0805Report2024Entity> list0805 = offeringPartyUsage0805Report2024Repository
                .findByDocumentCodeOrderByPartyUsage0805ReportId(documentCode);

        assertThat(list0805.size()).isEqualTo(size);// 取得と設定が同一

        OfferingPartyUsage0805Report2024Entity entity0805 = list0805.get(0);
