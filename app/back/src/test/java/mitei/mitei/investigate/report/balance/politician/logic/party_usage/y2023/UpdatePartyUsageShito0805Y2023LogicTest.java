...
/**
 * UpdatePartyUsageShito0805Y2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0805Y2023LogicTest {
    // CHECKSTYLE:OFF

    /** テスト対象 */
    @Autowired
    private UpdatePartyUsageShito0805Y2023Logic updatePartyUsageShito0805Y2023Logic;
    ...
    @Test
    @Transactional
    @Sql("offering_party_usage_0805_report_2023.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0805Report2023Entity> listPre = offeringPartyUsage0805Report2023Repository
                .findByDocumentCodeOrderByPartyUsage0805ReportId(oldDcoumentCode);

        OfferingPartyUsage0805Report2023Entity preEntity = listPre.get(0);
        ...
        int size = updatePartyUsageShito0805Y2023Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingPartyUsage0805Report2023Entity> listPro = offeringPartyUsage0805Report2023Repository
                .findByDocumentCodeOrderByPartyUsage0805ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0805Report2023Entity proEntity;
