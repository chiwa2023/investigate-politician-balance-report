...
/**
 * ZenginOrgBranchWkTbl4ItemWriter単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class ZenginOrgBranchWkTbl4ItemWriterTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("truncate_zengin_org_branch_wk4.sql")
    void test()throws Exception { // NOPMD
        
        StepExecution execution = this.getStepExecution();
        zenginOrgBranchWkTbl4ItemWriter.beforeStep(execution);
        ...
        ZenginOrgBranchWk4Entity entity02 = new ZenginOrgBranchWk4Entity();
        ...
        List<ZenginOrgBranchWk4Entity> list = new ArrayList<>();
        list.add(entity01);
        list.add(entity02);

        // Chunkを作成してセット
        Chunk<? extends ZenginOrgBranchWk4Entity> items = new Chunk<>(list);
        zenginOrgBranchWkTbl4ItemWriter.write(items);

        List<ZenginOrgBranchWk4Entity> listAnswer = zenginOrgBranchWk4Repository.findAll();
        assertEquals(2, listAnswer.size(), "2件登録して件取得");
        listAnswer.sort((e1, e2) -> e1.getZenginOrgBranchWk4Code() - e2.getZenginOrgBranchWk4Code());

        ZenginOrgBranchWk4Entity answerEntity00 = listAnswer.get(0);
        ...
        ZenginOrgBranchWk4Entity answerEntity01 = listAnswer.get(1);
