...
class InsertPoliticalOrganizationEstateAllY2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() { // NOPMD
        ...
        int size =insertPoliticalOrganizationEstateAllY2023Logic.practice(documentCode, documentPropertyDto, allSheet0718AssetsDto, allSheet0719RealEstateDto, CreateTestPrivilegeDtoUtil.pracitce());
        
        List<OfferingBalancesheet0718Estate2023Entity> listAsset = offeringBalancesheet0718Estate2023Repository.findByDocumentCodeOrderByOfferingBalancesheet0718EstateId(documentCode);
        List<OfferingBalancesheet0719RealEstate2023Entity> listRealEstate = offeringBalancesheet0719RealEstate2023Repository.findByDocumentCodeOrderByOfferingBalancesheet0719RealEstateId(documentCode);
        ...
        OfferingBalancesheet0718Estate2023Entity entityAsset01 = listAsset.get(0);
        OfferingBalancesheet0719RealEstate2023Entity entityRealEstate1 = listRealEstate.get(0);
        ...
        OfferingBalancesheet0718Estate2023Entity entityAsset02 = listAsset.get(1);
        assertThat(entityAsset02.getKingaku()).isEqualTo(row2.getKingaku());
        
        /* 区分3 */
        OfferingBalancesheet0718Estate2023Entity entityAsset03 = listAsset.get(2);
        assertThat(entityAsset03.getKingaku()).isEqualTo(row3.getKingaku());

        /* 区分4 */
        OfferingBalancesheet0718Estate2023Entity entityAsset04 = listAsset.get(3);
        assertThat(entityAsset04.getKingaku()).isEqualTo(row4.getKingaku());
        
        /* 区分5 */
        OfferingBalancesheet0718Estate2023Entity entityAsset05 = listAsset.get(4);
        assertThat(entityAsset05.getKingaku()).isEqualTo(row5.getKingaku());
        
        /* 区分6 */
        OfferingBalancesheet0718Estate2023Entity entityAsset06 = listAsset.get(5);
        assertThat(entityAsset06.getKingaku()).isEqualTo(row6.getKingaku());
        
        /* 区分7 */
        OfferingBalancesheet0718Estate2023Entity entityAsset07 = listAsset.get(6);
        assertThat(entityAsset07.getKingaku()).isEqualTo(row7.getKingaku());
        
        /* 区分8 */
        OfferingBalancesheet0718Estate2023Entity entityAsset08 = listAsset.get(7);
        assertThat(entityAsset08.getKingaku()).isEqualTo(row8.getKingaku());

        /* 区分9 */
        OfferingBalancesheet0718Estate2023Entity entityAsset09 = listAsset.get(8);
        assertThat(entityAsset09.getKingaku()).isEqualTo(row9.getKingaku());
        
        /* 区分10 */
        OfferingBalancesheet0718Estate2023Entity entityAsset10 = listAsset.get(9);
        assertThat(entityAsset10.getKingaku()).isEqualTo(row10.getKingaku());

        /* 区分11 */
        OfferingBalancesheet0718Estate2023Entity entityAsset11 = listAsset.get(10);
        assertThat(entityAsset11.getKingaku()).isEqualTo(row11.getKingaku());
        
        /* 区分12 */
        OfferingBalancesheet0718Estate2023Entity entityAsset12 = listAsset.get(11);
        ...
        /* 建物 */
        OfferingBalancesheet0719RealEstate2023Entity entityRealEstate2 = listRealEstate.get(1);
        ...
        /* 地上権 */
        OfferingBalancesheet0719RealEstate2023Entity entityRealEstate3 = listRealEstate.get(2);
