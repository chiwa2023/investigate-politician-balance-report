...
class ConvertSheetDtoToEntity0705RelatedToGrantsY2023LogicTest {
    ...
    void testPractice() {
        ...
        List<OfferingBalancesheetIncome2023Entity> list = convertSheetDtoToEntity0705RelatedToGrantsY2023Logic
        ...
        // 1件取得
        OfferingBalancesheetIncome2023Entity entity = list.get(0);
