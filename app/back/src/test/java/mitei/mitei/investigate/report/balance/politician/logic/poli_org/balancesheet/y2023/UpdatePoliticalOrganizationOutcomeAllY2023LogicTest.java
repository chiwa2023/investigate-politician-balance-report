...
/**
 * UpdatePoliticalOrganizationOutcomeAllY2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePoliticalOrganizationOutcomeAllY2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("offering_balancesheet_outcome_2023.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingBalancesheetOutcome2023Entity> listPre = offeringBalancesheetOutcome2023Repository
                .findByDocumentCodeOrderByOfferingBalancesheetOutcomeId(oldDcoumentCode);

        OfferingBalancesheetOutcome2023Entity preEntity = listPre.get(0);
        ...
        int size = updatePoliticalOrganizationOutcomeAllY2023Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingBalancesheetOutcome2023Entity> listPro = offeringBalancesheetOutcome2023Repository
                .findByDocumentCodeOrderByOfferingBalancesheetOutcomeId(oldDcoumentCode);
        ...
        OfferingBalancesheetOutcome2023Entity proEntity;
