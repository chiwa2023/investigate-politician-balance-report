...
/**
 * SearchRegistBalancesheetWkTbService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class SearchRegistBalancesheetWkTbServiceTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() {
        ...
        List<WkTblPoliOrgBalancesheetReportEntity> list = searchRegistBalancesheetWkTbService.practice();
        assertThat(list.size()).isEqualTo(1);// 4件登録したがヒットするのは1件

        WkTblPoliOrgBalancesheetReportEntity entity = list.get(0);
        assertThat(entity.getWkTblPoliOrgBalancesheetReportId()).isEqualTo(102L);
