...
/**
 * UpdatePartyUsageShito0802And0803Y2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0802And0803Y2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Transactional
    @Sql("offering_party_usage_0802_and_0803_report_2025.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0802And0803Report2025Entity> listPre = offeringPartyUsage0802And0803Report2025Repository
                .findByDocumentCodeOrderByPartyUsage0802And0803ReportId(oldDcoumentCode);

        OfferingPartyUsage0802And0803Report2025Entity preEntity = listPre.get(0);
        ...
        int size = updatePartyUsageShito0802And0803Y2025Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingPartyUsage0802And0803Report2025Entity> listPro = offeringPartyUsage0802And0803Report2025Repository
                .findByDocumentCodeOrderByPartyUsage0802And0803ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0802And0803Report2025Entity proEntity;
