...
/**
 * GetKifuKobetsuSouryouJogenMeisaiController単体テスト
 */
@SpringJUnitConfig
...
class GetKifuKobetsuSouryouJogenMeisaiControllerTest {
    // CHECKSTYLE:OFF
    ...
    void test() throws Exception {
        ...
        capsuleDto.setOffset(100);
        capsuleDto.setIsNameSearch(true);
        capsuleDto.setPoliOrgCode(100);
        capsuleDto.setSeachKifuKbn(GetDantaiKbnListLogic.SEARCH_PARTY);
        capsuleDto.setYoushikiEdaKbn(YoushikiEdaKbn.KOJIN);

        ObjectMapper objectMapper = GetObjectMapperWithTimeModuleUtil.practice();

        String path = "/kifu-jougen/get-jouegn-meisai";
