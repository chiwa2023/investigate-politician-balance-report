...
/**
 * UpdatePartyUsageShito0805Y2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0805Y2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Transactional
    @Sql("offering_party_usage_0805_report_2025.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0805Report2025Entity> listPre = offeringPartyUsage0805Report2025Repository
                .findByDocumentCodeOrderByPartyUsage0805ReportId(oldDcoumentCode);

        OfferingPartyUsage0805Report2025Entity preEntity = listPre.get(0);
        ...
        int size = updatePartyUsageShito0805Y2025Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingPartyUsage0805Report2025Entity> listPro = offeringPartyUsage0805Report2025Repository
                .findByDocumentCodeOrderByPartyUsage0805ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0805Report2025Entity proEntity;
