...
/**
 * CheckKifuSouryouKiseiByPersonCodeY2024Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class CheckKifuSouryouKiseiByPersonCodeY2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql({ "souryou_kisei_2024.sql", "../kifu_souryou_kisei/relation_person.sql" })
    void test() throws Exception {

        // 政治団体区分が政党のリスト(通称A枠用)
        List<SouryouKiseiRelationCodeDto> list = checkKifuSouryouKiseiByPersonCodeY2024Logic.practice(100,
