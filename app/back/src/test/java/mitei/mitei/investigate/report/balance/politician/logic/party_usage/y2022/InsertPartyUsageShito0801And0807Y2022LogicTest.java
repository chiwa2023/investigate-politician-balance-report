...
/**
 * InsertPartyUsageShito0801And0807Y2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class InsertPartyUsageShito0801And0807Y2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() { // NOPMD
        ...
        createTestDataPartyUsageShito0801And0807Logic.practice(2022, allShitoBook);
        ...
        Long code = insertPartyUsageShito0801And0807Y2022Logic.practice(documentPropertyDto, allShitoBook,
