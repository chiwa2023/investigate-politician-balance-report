...
/**
 * UpdatetPoliticalOrganizationSheet0701And0720Y2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePoliticalOrganizationSheet0701And0720Y2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("offering_balancesheet_0701_and_0720_surface_2025.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingBalancesheet0701And0720Surface2025Entity> listPre = offeringBalancesheet0701And0720Surface2025Repository
                .findByOfferingBalancesheet0701And0720SurfaceCodeOrderByOfferingBalancesheet0701And0720SurfaceId(
                        oldDcoumentCode);

        OfferingBalancesheet0701And0720Surface2025Entity preEntity = listPre.get(0);
        ...
        int size = updatetPoliticalOrganizationSheet0701And0720Y2025Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingBalancesheet0701And0720Surface2025Entity> listPro = offeringBalancesheet0701And0720Surface2025Repository
                .findByOfferingBalancesheet0701And0720SurfaceCodeOrderByOfferingBalancesheet0701And0720SurfaceId(
                        oldDcoumentCode);
        ...
        OfferingBalancesheet0701And0720Surface2025Entity proEntity;
