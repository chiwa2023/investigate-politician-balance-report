...
class ConvertSheetDtoToEntity0712PartyMediationLogicTest {
    ...
    /** テスト対象 */
    @Autowired
    private ConvertSheetDtoToEntity0712PartyMediationY2025Logic convertSheetDtoToEntity0712PartyMediationY2025Logic;
    ...
    void testPractice() { // NOPMD
        ...
        List<OfferingBalancesheetIncome2025Entity> list = convertSheetDtoToEntity0712PartyMediationY2025Logic.practice(
