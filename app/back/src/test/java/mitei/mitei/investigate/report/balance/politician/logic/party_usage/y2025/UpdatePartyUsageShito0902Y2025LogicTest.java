...
/**
 * UpdatePartyUsageShito0902Y2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0902Y2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() {
        ...
        List<OfferingPartyUsage0902Report2025Entity> listPre = offeringPartyUsage0902Report2025Repository
                .findByDocumentCodeOrderByPartyUsage0902ReportId(oldDcoumentCode);

        OfferingPartyUsage0902Report2025Entity preEntity = listPre.get(0);
        ...
        List<OfferingPartyUsage0902Report2025Entity> listPro = offeringPartyUsage0902Report2025Repository
                .findByDocumentCodeOrderByPartyUsage0902ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0902Report2025Entity proEntity;
