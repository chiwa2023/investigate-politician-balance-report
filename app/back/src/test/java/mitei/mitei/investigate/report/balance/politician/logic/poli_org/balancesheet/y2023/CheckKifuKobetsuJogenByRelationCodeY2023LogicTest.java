...
/**
 * CheckKifuKobetsuJogenByRelationCodeY2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class CheckKifuKobetsuJogenByRelationCodeY2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql({ "kobetsu_kisei_2023.sql", "../kifu_souryou_kisei/political_organization.sql" })
    void testPoliOrg() {
        ...
        SearchKifuJougenMeisaiBalancesheetResultDto resultDto = checkKifuKobetsuJogenByRelationCodeY2023Logic
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql({ "kobetsu_kisei_2023.sql", "../kifu_souryou_kisei/relation_person.sql" })
    void testPersonal() {
