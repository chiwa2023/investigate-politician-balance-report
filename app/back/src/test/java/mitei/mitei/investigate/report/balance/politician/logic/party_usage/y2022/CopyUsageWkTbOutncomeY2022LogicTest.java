...
/**
 * CopyUsageWkTbOutncomeY2022Logic単体テスト
 */
@SpringJUnitConfig
...
@Transactional
@Sql("wktbl_usage_outcome_2022.sql")
class CopyUsageWkTbOutncomeY2022LogicTest {
    ...
    @Test
    void testSize() {
        assertEquals(203, copyUsageWkTbOutncomeY2022Logic.practiceSize(documentCode));
    }
    ...
    void test() {
        ...
        List<WkTblUsageOutcomeEntity> list = copyUsageWkTbOutncomeY2022Logic.practice(documentCode, 0, 10,
                privilegeDto);
