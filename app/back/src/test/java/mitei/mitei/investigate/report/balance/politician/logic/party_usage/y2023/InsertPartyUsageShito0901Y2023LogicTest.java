...
/**
 * InsertPartyUsageShito0901Y2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class InsertPartyUsageShito0901Y2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() {
        ...
        int size = insertPartyUsageShito0901Y2023Logic.practice(documentCode, documentPropertyDto,
                allShitoBook.getShito0901Dto(), CreateTestPrivilegeDtoUtil.pracitce());

        List<OfferingPartyUsage0901Report2023Entity> list0901 = offeringPartyUsage0901Report2023Repository
                .findByDocumentCodeOrderByPartyUsage0901ReportId(documentCode);

        assertThat(list0901.size()).isEqualTo(size);// 2行追加

        OfferingPartyUsage0901Report2023Entity entity090101 = list0901.get(0);
        OfferingPartyUsage0901Report2023Entity entity090102 = list0901.get(1);
