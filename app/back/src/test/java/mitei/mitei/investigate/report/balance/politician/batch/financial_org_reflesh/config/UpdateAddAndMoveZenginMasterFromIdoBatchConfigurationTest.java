...
/**
 * UpdateAddAndMoveZenginMasterFromIdoBatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
class UpdateAddAndMoveZenginMasterFromIdoBatchConfigurationTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(UpdateAddAndMoveZenginMasterFromIdoBatchConfiguration.JOB_NAME,
                updateAddAndMoveZenginMasterFromIdo.getName(), "Job名が一致");
    }
