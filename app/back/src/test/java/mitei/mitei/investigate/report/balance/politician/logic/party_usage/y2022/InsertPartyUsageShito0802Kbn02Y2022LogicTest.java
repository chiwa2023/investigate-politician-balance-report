...
/**
 * InsertPartyUsageShito0802Kbn02Y2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class InsertPartyUsageShito0802Kbn02Y2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() {
        ...
        int size = insertPartyUsageShito0802Kbn02Y2022Logic.practice(documentCode, documentPropertyDto,
                allShitoBook.getShito0802Dto().getSheet0802Dto().getKbn080202Dto(),
                CreateTestPrivilegeDtoUtil.pracitce());

        List<OfferingPartyUsage0802Kbn02Report2022Entity> list080202 = offeringPartyUsage0802Kbn02Report2022Repository
                .findByDocumentCodeOrderByPartyUsage0802Kbn02ReportId(documentCode);

        assertThat(list080202.size()).isEqualTo(size);// 1行しか登録していません

        OfferingPartyUsage0802Kbn02Report2022Entity entity080202 = list080202.get(0);
