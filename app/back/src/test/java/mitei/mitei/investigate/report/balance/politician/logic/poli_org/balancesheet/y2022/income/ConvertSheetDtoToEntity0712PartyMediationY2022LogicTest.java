...
class ConvertSheetDtoToEntity0712PartyMediationLogicTest {
    ...
    /** テスト対象 */
    @Autowired
    private ConvertSheetDtoToEntity0712PartyMediationY2022Logic convertSheetDtoToEntity0712PartyMediationY2022Logic;
    ...
    void testPractice() { // NOPMD
        ...
        List<OfferingBalancesheetIncome2022Entity> list = convertSheetDtoToEntity0712PartyMediationY2022Logic.practice(
        ...
        // 1件取得
        OfferingBalancesheetIncome2022Entity entity1 = list.get(0);
        ...
        /* 枝区分項目2 */
        OfferingBalancesheetIncome2022Entity entity2 = list.get(1);
        ...
        /* 枝区分項目3 */
        OfferingBalancesheetIncome2022Entity entity3 = list.get(2);
