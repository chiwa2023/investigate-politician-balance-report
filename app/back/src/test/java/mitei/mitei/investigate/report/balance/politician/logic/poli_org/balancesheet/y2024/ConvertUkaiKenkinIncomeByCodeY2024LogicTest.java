...
/**
 * ConvertUkaiKenkinIncomeY2024Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class ConvertUkaiKenkinIncomeByCodeY2024LogicTest {
    // CHECKSTYLE:OFF

    /** テスト対象 */
    @Autowired
    private ConvertUkaiKenkinIncomeByCodeY2024Logic convertUkaiKenkinIncomeByCodeY2024Logic;
    ...
    @Test
    @Tag("TableTruncate")
    @Sql({ "convert_ukai_kenkin_income_2024.sql", "../ukai_kenkin/political_organization_property.sql" })
    void test() throws Exception { // NOPMD
        ...
        List<WkTblUkaiKenkinEntity> list = convertUkaiKenkinIncomeByCodeY2024Logic.practice(listCode, propertyEntity,
        ...
        assertEquals(2024, entity00.getHoukokuNen(), "報告年データ1");
        ...
        assertEquals(LocalDate.of(2024, 9, 30), entity00.getAccrualDateValue(), "発生日実値データ1");
        ...
        assertEquals(LocalDate.of(2024, 8, 30), entity03.getAccrualDateValue(), "発生日実値データ4");
