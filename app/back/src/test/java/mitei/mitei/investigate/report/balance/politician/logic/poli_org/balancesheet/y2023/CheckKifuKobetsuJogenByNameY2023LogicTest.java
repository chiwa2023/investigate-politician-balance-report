...
/**
 * CheckKifuKobetsuJogenY2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class CheckKifuKobetsuJogenByNameY2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPoliOrg() throws Exception {
        ...
        SearchKifuJougenMeisaiBalancesheetResultDto resultDto = checkKifuKobetsuJogenByNameY2023Logic
