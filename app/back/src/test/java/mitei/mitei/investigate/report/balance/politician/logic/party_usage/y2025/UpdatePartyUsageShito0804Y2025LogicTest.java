...
/**
 * UpdatePartyUsageShito0804Y2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0804Y2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Test
    @Transactional
    @Sql("offering_party_usage_0804_report_2025.sql")
    void testPractice() {

        Long oldDcoumentCode = 3232L;

        List<OfferingPartyUsage0804Report2025Entity> listPre = offeringPartyUsage0804Report2025Repository
                .findByDocumentCodeOrderByPartyUsage0804ReportId(oldDcoumentCode);

        OfferingPartyUsage0804Report2025Entity preEntity = listPre.get(0);
        ...
        int size = updatePartyUsageShito0804Y2025Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingPartyUsage0804Report2025Entity> listPro = offeringPartyUsage0804Report2025Repository
                .findByDocumentCodeOrderByPartyUsage0804ReportId(oldDcoumentCode);
        ...
        OfferingPartyUsage0804Report2025Entity proEntity;
