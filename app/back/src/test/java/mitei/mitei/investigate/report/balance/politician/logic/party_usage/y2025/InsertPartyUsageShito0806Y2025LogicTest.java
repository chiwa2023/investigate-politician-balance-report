...
/**
 * InsertPartyUsageShito0806Y2025Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class InsertPartyUsageShito0806Y2025LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() { // NOPMD
        ...
        int size = insertPartyUsageShito0806Y2025Logic.practice(documentCode, documentPropertyDto, allShitoBook.getShito0806Dto(), CreateTestPrivilegeDtoUtil.pracitce());
