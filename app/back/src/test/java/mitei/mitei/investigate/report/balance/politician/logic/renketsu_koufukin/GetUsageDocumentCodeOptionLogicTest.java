...
/**
 * GetUsageDocumentCodeOptionLogic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class GetUsageDocumentCodeOptionLogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("../party_usage/y2022/usage_option_2022.sql")
    void test() {
        ...
        List<SelectOptionDto> listOption = getUsageDocumentCodeOptionLogic.practice(capsuleDto);
