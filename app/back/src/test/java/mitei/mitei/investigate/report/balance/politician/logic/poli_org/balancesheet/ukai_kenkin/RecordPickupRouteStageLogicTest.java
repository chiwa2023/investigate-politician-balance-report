...
class RecordPickupRouteStageLogicTest { // NOPMD
    // CHECKSTYLE:OFF
    ...
    void testProperty1() {
        ...
        assertEquals("ABCD団体", entity00.getPoliticalOrgName(), "記載政治団体が一致0"); // NOPMD
        assertEquals("中間団体11", entity00.getTradingPartnerName(), "取り引き相手が一致0"); // NOPMD
        assertEquals(0, entity00.getPickupStage(), "階層が一致0"); // NOPMD

        WkTblUkaiKenkinPickupRouteEntity entity01 = list.get(1);
        assertEquals("中間団体11", entity01.getPoliticalOrgName(), "記載政治団体が一致1"); // NOPMD
        assertEquals("関連団体A", entity01.getTradingPartnerName(), "取り引き相手が一致1"); // NOPMD
        assertEquals(1, entity01.getPickupStage(), "階層が一致1"); // NOPMD
    }
    ...
    void testYakuwari1() {
        ...
        personWithYakuwariDto.setName("ABCD太郎"); // NOPMD
    ...
    void testProperty2() {
        ...
        assertEquals("迂回団体12", entity02.getPoliticalOrgName(), "記載政治団体が一致2"); // NOPMD
        assertEquals("関連団体B", entity02.getTradingPartnerName(), "取り引き相手が一致2"); // NOPMD
        assertEquals(2, entity02.getPickupStage(), "階層が一致2"); // NOPMD
    ...
    void testProperty3() {
        ...
        assertEquals("迂回団体23", entity03.getPoliticalOrgName(), "記載政治団体が一致3"); // NOPMD
        assertEquals("関連団体C", entity03.getTradingPartnerName(), "取り引き相手が一致3"); // NOPMD
        assertEquals(3, entity03.getPickupStage(), "階層が一致3"); // NOPMD
    ...
    void testProperty4() {
        ...
        assertEquals("迂回団体34", entity04.getPoliticalOrgName(), "記載政治団体が一致4"); // NOPMD
        assertEquals("関連団体D", entity04.getTradingPartnerName(), "取り引き相手が一致4"); // NOPMD
        assertEquals(4, entity04.getPickupStage(), "階層が一致4"); // NOPMD
    ...
    void testProperty5() {
        ...
        assertEquals("迂回団体45", entity05.getPoliticalOrgName(), "記載政治団体が一致5"); // NOPMD
        assertEquals("関連団体E", entity05.getTradingPartnerName(), "取り引き相手が一致5"); // NOPMD
        assertEquals(5, entity05.getPickupStage(), "階層が一致5"); // NOPMD
    }
    ...
    void testProperty6() {
        ...
        assertEquals("迂回団体56", entity06.getPoliticalOrgName(), "記載政治団体が一致6"); // NOPMD
        assertEquals("関連団体F", entity06.getTradingPartnerName(), "取り引き相手が一致6"); // NOPMD
        assertEquals(6, entity06.getPickupStage(), "階層が一致6"); // NOPMD
    ...
    void testProperty7() {
        ...
        assertEquals("迂回団体67", entity07.getPoliticalOrgName(), "記載政治団体が一致7"); // NOPMD
        assertEquals("関連団体G", entity07.getTradingPartnerName(), "取り引き相手が一致7"); // NOPMD
        assertEquals(7, entity07.getPickupStage(), "階層が一致7"); // NOPMD
    ...
    void testProperty8() {
        ...
        assertEquals("迂回団体78", entity08.getPoliticalOrgName(), "記載政治団体が一致8"); // NOPMD
        assertEquals("関連団体H", entity08.getTradingPartnerName(), "取り引き相手が一致8"); // NOPMD
        assertEquals(8, entity08.getPickupStage(), "階層が一致8"); // NOPMD
