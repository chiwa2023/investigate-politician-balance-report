...
class InsertPoliticalOrganization08000Y2023LogicTest {
    ...
    void testPractice() {
        ...
        int size = insertPoliticalOrganization08000Y2023Logic.practice(documentCode, documentPropertyDto,
        ...
        OfferingBalancesheetDifficalt0800Recipt2023Entity entity = list.get(0);
