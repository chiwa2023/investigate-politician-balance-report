...
/**
 * PoliOrgUkaiKenkinDetailY2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class PoliOrgUkaiKenkinDetailY2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql({ "wk_tbl_ukai_kenkin_times00.sql", "tasklet_stage0_income_2023.sql" })
    void test() {
        ...
        List<OfferingBalancesheetIncomeEntity> list = poliOrgUkaiKenkinDetailY2023Logic.practice(userCode, 1, 100,
                pageable);
    ...
    void testCount() {
        ...
        assertEquals(7, poliOrgUkaiKenkinDetailY2023Logic.practiceCount(userCode, 1, 100), "0階層、交付金データを含まない場合は取得件数は7件");
