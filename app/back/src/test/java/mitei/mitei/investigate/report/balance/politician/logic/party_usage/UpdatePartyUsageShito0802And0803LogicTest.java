...
class UpdatePartyUsageShito0802And0803LogicTest {
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2022/offering_party_usage_0802_and_0803_report.sql")
    void testPractice2022() {

        assertEquals(1L, offeringPartyUsage0802And0803Report2022Repository.count(), "初期入力1件");
        ...
        updatePartyUsageShito0802And0803Logic.practice(houkokuNen, documentCode, CreateTestPrivilegeDtoUtil.pracitce());

        assertEquals(1L, offeringPartyUsage0802And0803Report2022Repository.count(), "最新データの積み上げは別ロジックでしているので1件のまま");
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2024/offering_party_usage_0802_and_0803_report.sql")
    void testPractice2024() {

        assertEquals(1L, offeringPartyUsage0802And0803Report2024Repository.count(), "初期入力1件");
        ...
        assertEquals(1L, offeringPartyUsage0802And0803Report2024Repository.count(), "最新データの積み上げは別ロジックでしているので1件のまま");
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2023/offering_party_usage_0802_and_0803_report.sql")
    void testPractice2023() {

        assertEquals(1L, offeringPartyUsage0802And0803Report2023Repository.count(), "初期入力1件");
        ...
        assertEquals(1L, offeringPartyUsage0802And0803Report2023Repository.count(), "最新データの積み上げは別ロジックでしているので1件のまま");
