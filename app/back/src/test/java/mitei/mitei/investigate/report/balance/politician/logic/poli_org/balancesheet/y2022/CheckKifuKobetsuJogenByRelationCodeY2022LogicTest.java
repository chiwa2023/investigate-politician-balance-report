...
/**
 * CheckKifuKobetsuJogenByRelationCodeY2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class CheckKifuKobetsuJogenByRelationCodeY2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql({ "kobetsu_kisei_2022.sql", "../kifu_souryou_kisei/political_organization.sql" })
    void testPoliOrg() {
        ...
        SearchKifuJougenMeisaiBalancesheetResultDto resultDto = checkKifuKobetsuJogenByRelationCodeY2022Logic
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql({ "kobetsu_kisei_2022.sql", "../kifu_souryou_kisei/relation_person.sql" })
    void testPersonal() {
