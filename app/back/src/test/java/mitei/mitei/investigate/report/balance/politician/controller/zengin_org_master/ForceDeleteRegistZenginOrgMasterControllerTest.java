...
/**
 * ForceDeleteRegistZenginOrgMasterController単体テスト
 */
@SpringJUnitConfig
...
class ForceDeleteRegistZenginOrgMasterControllerTest {
    ...
    void test() throws Exception {
        ...
        assertEquals(HttpStatus.OK.value(), mockMvc. // NOPMD
                perform(post("/zengin-org-master/force-copy-master-delete") // 以下引数指定
