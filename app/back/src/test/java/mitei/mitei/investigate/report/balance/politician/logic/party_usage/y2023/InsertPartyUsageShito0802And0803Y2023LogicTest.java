...
/**
 * InsertPartyUsageShito0802And0803Y2023Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class InsertPartyUsageShito0802And0803Y2023LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPractice() { // NOPMD
        ...
        insertPartyUsageShito0802And0803Y2023Logic.practice(documentCode, documentPropertyDto,
                allShitoBook.getShito0802Dto(), allShitoBook.getShito0803Dto(), CreateTestPrivilegeDtoUtil.pracitce());

        List<OfferingPartyUsage0802And0803Report2023Entity> listSummary = offeringPartyUsage0802And0803Report2023Repository
                .findByDocumentCodeOrderByPartyUsage0802And0803ReportId(documentCode);

        assertThat(listSummary.size()).isEqualTo(1); // 1件だけ登録

        OfferingPartyUsage0802And0803Report2023Entity entity08021 = listSummary.get(0);
