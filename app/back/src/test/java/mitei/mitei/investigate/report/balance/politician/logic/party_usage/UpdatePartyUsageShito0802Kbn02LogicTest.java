...
/**
 * UpdatePartyUsageShito0802Kbn02Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePartyUsageShito0802Kbn02LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("offering_party_usage_0802_kbn_02_report.sql")
    void testPractice() {
        ...
        // 2022年、2025年とも最新状態です
        OfferingPartyUsage0802Kbn02Report2022Entity entity2022Pre = offeringPartyUsage0802Kbn02Report2022Repository
                .findByDocumentCodeOrderByPartyUsage0802Kbn02ReportId(documentCode).get(0);
        assertThat(entity2022Pre.getSaishinKbn()).isEqualTo(DataHistoryStatusConstants.INSERT.value());

        OfferingPartyUsage0802Kbn02Report2025Entity entity2025Pre = offeringPartyUsage0802Kbn02Report2025Repository
                .findByDocumentCodeOrderByPartyUsage0802Kbn02ReportId(documentCode).get(0);
        ...
        updatePartyUsageShito0802Kbn02Logic.practice(nendo, documentCode, checkPrivilegeDto);

        // 2022年のテーブルデータは変更されました
        OfferingPartyUsage0802Kbn02Report2022Entity entity2022Pro = offeringPartyUsage0802Kbn02Report2022Repository
                .findByDocumentCodeOrderByPartyUsage0802Kbn02ReportId(documentCode).get(0);

        assertThat(entity2022Pro.getSaishinKbn()).isEqualTo(DataHistoryStatusConstants.UPDATE.value());

        // 2025年のテーブルデータは変更されませんでした
        OfferingPartyUsage0802Kbn02Report2025Entity entity2025Pro = offeringPartyUsage0802Kbn02Report2025Repository
                .findByDocumentCodeOrderByPartyUsage0802Kbn02ReportId(documentCode).get(0);
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2022/offering_party_usage_0802_kbn_02_report.sql")
    void testPractice2022() {
        ...
        updatePartyUsageShito0802Kbn02Logic.practice(houkokuNen, documentCode, CreateTestPrivilegeDtoUtil.pracitce());

        assertEquals(1L, offeringPartyUsage0802Kbn02Report2022Repository.count(), "最新データの積み上げは別ロジックでしているので1件のまま");
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2024/offering_party_usage_0802_kbn_02_report.sql")
    void testPractice2024() {
        ...
        assertEquals(1L, offeringPartyUsage0802Kbn02Report2024Repository.count(), "最新データの積み上げは別ロジックでしているので1件のまま");
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2023/offering_party_usage_0802_kbn_02_report.sql")
    void testPractice2023() {
        ...
        assertEquals(1L, offeringPartyUsage0802Kbn02Report2023Repository.count(), "最新データの積み上げは別ロジックでしているので1件のまま");
