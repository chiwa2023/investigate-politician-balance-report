...
/**
 * UpdateFinishedByTaskNameUserY2024Logic単体テスト
 */
@SpringJUnitConfig
...
class UpdateFinishedByTaskNameUserY2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    void test() {
        ...
        assertEquals(1, updateFinishedByTaskNameUserY2024Logic.practice(taskPlanCode, privilegeDto, taskName, year),
                "正常処理");
    ...
    void testSuspended() {
        ...
        assertEquals(0, updateFinishedByTaskNameUserY2024Logic.practice(taskPlanCode, privilegeDto, taskName, year),
                "更新する元データが不正");
