...
/**
 * CopyFinancialOrgWkTbl2BatchConfiguration単体テスト
 */
@SpringJUnitConfig
...
class CopyFinancialOrgWkTbl2BatchConfigurationTest {
    // CHECKSTYLE:OFF
    ...
    @Autowired
    private Job copyFinancialOrgWkTbl2;

    @Test
    @Tag("TableTruncate")
    void testJob() {
        assertEquals(CopyFinancialOrgWkTbl2BatchConfiguration.JOB_NAME, copyFinancialOrgWkTbl2.getName(), "Job名が一致");
    }
    ...
    void testExecute() throws Exception {
        ...
        jobLauncherTestUtils.setJob(copyFinancialOrgWkTbl2);

        JobParameters jobParameters = new JobParametersBuilder(
                copyFinancialOrgWkTbl2.getJobParametersIncrementer().getNext(new JobParameters())) // NOPMD
