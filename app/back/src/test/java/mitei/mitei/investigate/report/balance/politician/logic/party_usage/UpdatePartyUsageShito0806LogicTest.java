...
class UpdatePartyUsageShito0806LogicTest {
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2022/offering_party_usage_0806_report.sql")
    void testPractice2022() {
        ...
        updatePartyUsageShito0806Logic.practice(houkokuNen, documentCode, CreateTestPrivilegeDtoUtil.pracitce());

        assertEquals(1L, offeringPartyUsage0806Report2022Repository.count(), "最新データの積み上げは別ロジックでしているので1件のまま");
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2024/offering_party_usage_0806_report.sql")
    void testPractice2024() {
        ...
        assertEquals(1L, offeringPartyUsage0806Report2024Repository.count(), "最新データの積み上げは別ロジックでしているので1件のまま");
    ...
    @Transactional
    @Tag(TEST_TAG)
    @Sql("y2023/offering_party_usage_0806_report.sql")
    void testPractice2023() {
        ...
        assertEquals(1L, offeringPartyUsage0806Report2023Repository.count(), "最新データの積み上げは別ロジックでしているので1件のまま");
