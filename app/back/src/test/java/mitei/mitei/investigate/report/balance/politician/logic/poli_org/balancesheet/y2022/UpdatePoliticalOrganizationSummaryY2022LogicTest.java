...
/**
 * UpdatePoliticalOrganizationSummaryY2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class UpdatePoliticalOrganizationSummaryY2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("offering_balancesheet_0702_and_0713_and_0717_summary_2022.sql")
    void testPractice() throws Exception {

        Long oldDcoumentCode = 3232L;

        List<OfferingBalancesheet0702And0713And0717Summary2022Entity> listPre = offeringBalancesheet0702And0713And0717Summary2022Repository
                .findByDocumentCodeOrderByOfferingBalancesheet0702And0713And0717SummaryId(oldDcoumentCode);

        OfferingBalancesheet0702And0713And0717Summary2022Entity preEntity = listPre.get(0);
        ...
        int size = updatePoliticalOrganizationSummaryY2022Logic.practice(oldDcoumentCode, checkPrivilegeDto);

        List<OfferingBalancesheet0702And0713And0717Summary2022Entity> listPro = offeringBalancesheet0702And0713And0717Summary2022Repository
                .findByDocumentCodeOrderByOfferingBalancesheet0702And0713And0717SummaryId(oldDcoumentCode);
        ...
        OfferingBalancesheet0702And0713And0717Summary2022Entity proEntity;
