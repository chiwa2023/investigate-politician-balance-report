...
/**
 * ShowBalancesheetReportByKanrenshaService単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class ShowBalancesheetReportByKanrenshaServiceTest {
    // CHECKSTYLE:OFF

    /** テスト対象 */
    @Autowired
    private ShowBalancesheetReportByKanrenshaService showBalancesheetReportByKanrenshaService;
    ...
    void test() { // NOPMD
        ...
        IncomeAndOutcomeNaturalSearchResultDto resultDto = showBalancesheetReportByKanrenshaService
                .practice(capsuleDto);
