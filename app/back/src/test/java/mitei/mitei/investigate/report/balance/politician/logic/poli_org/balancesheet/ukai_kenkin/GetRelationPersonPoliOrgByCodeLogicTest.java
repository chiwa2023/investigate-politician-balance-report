...
/**
 * GetRelationPersonPoliOrgByCodeLogic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class GetRelationPersonPoliOrgByCodeLogicTest {
    // CHECKSTYLE:OFF

    /** テスト対象 */
    @Autowired
    private GetRelationPersonPoliOrgByCodeLogic getRelationPersonPoliOrgByCodeLogic;

    @Test
    @Tag("TableTruncate")
    @Sql({ "../y2022/offering_balancesheet_0701_and_0720_surface_ukai_2022.sql",
            "political_organization_property.sql" })
