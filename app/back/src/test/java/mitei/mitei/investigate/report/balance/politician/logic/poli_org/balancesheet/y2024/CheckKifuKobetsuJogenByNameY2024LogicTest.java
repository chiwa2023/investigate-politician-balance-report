...
/**
 * CheckKifuKobetsuJogenY2024Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class CheckKifuKobetsuJogenByNameY2024LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPoliOrg() throws Exception {
        ...
        SearchKifuJougenMeisaiBalancesheetResultDto resultDto = checkKifuKobetsuJogenByNameY2024Logic
