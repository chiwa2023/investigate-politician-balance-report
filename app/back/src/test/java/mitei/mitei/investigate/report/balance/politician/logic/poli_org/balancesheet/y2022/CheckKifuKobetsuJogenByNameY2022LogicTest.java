...
/**
 * CheckKifuKobetsuJogenY2022Logic単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class CheckKifuKobetsuJogenByNameY2022LogicTest {
    // CHECKSTYLE:OFF
    ...
    void testPoliOrg() throws Exception {
        ...
        SearchKifuJougenMeisaiBalancesheetResultDto resultDto = checkKifuKobetsuJogenByNameY2022Logic
