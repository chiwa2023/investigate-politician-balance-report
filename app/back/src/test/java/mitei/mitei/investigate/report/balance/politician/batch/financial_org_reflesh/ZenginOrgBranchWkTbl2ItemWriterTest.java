...
/**
 * ZenginOrgBranchWkTbl2ItemWriter単体テスト
 */
@SpringJUnitConfig
@AutoConfigureMockMvc
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = ClassMode.BEFORE_CLASS)
class ZenginOrgBranchWkTbl2ItemWriterTest {
    // CHECKSTYLE:OFF
    ...
    @Tag("TableTruncate")
    @Transactional
    @Sql("truncate_zengin_org_branch_wk2.sql")
    void test() throws Exception { // NOPMD

        StepExecution execution = this.getStepExecution();
        zenginOrgBranchWkTbl2ItemWriter.beforeStep(execution);
        ...
        ZenginOrgBranchWk2Entity entity02 = new ZenginOrgBranchWk2Entity();
        ...
        List<ZenginOrgBranchWk2Entity> list = new ArrayList<>();
        list.add(entity01);
        list.add(entity02);

        // Chunkを作成してセット
        Chunk<? extends ZenginOrgBranchWk2Entity> items = new Chunk<>(list);
        zenginOrgBranchWkTbl2ItemWriter.write(items);

        List<ZenginOrgBranchWk2Entity> listAnswer = zenginOrgBranchWk2Repository.findAll();
        assertEquals(2, listAnswer.size(), "2件登録して件取得");
        listAnswer.sort((e1, e2) -> e1.getZenginOrgBranchWk2Code() - e2.getZenginOrgBranchWk2Code());

        ZenginOrgBranchWk2Entity answerEntity00 = listAnswer.get(0);
        ...
        ZenginOrgBranchWk2Entity answerEntity01 = listAnswer.get(1);
